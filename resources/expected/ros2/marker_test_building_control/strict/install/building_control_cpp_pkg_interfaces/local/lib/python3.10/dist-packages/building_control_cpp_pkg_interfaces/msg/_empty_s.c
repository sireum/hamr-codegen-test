...
bool building_control_cpp_pkg_interfaces__msg__empty__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("building_control_cpp_pkg_interfaces.msg._empty.Empty", full_classname_dest, 52) == 0);
  }
  building_control_cpp_pkg_interfaces__msg__Empty * ros_message = _ros_message;
...
PyObject * building_control_cpp_pkg_interfaces__msg__empty__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("building_control_cpp_pkg_interfaces.msg._empty");
