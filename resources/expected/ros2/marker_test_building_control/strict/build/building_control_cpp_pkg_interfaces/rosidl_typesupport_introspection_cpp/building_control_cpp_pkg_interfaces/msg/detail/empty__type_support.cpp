...
{
  new (message_memory) building_control_cpp_pkg_interfaces::msg::Empty(_init);
}

void Empty_fini_function(void * message_memory)
{
  auto typed_message = static_cast<building_control_cpp_pkg_interfaces::msg::Empty *>(message_memory);
  typed_message->~Empty();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Empty_message_member_array[1] = {
  {
    ...
    offsetof(building_control_cpp_pkg_interfaces::msg::Empty, structure_needs_at_least_one_member),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Empty_message_members = {
  ...
  "Empty",  // message name
  1,  // number of fields
  sizeof(building_control_cpp_pkg_interfaces::msg::Empty),
...
{
  return &::building_control_cpp_pkg_interfaces::msg::rosidl_typesupport_introspection_cpp::Empty_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, building_control_cpp_pkg_interfaces, msg, Empty)() {
  return &::building_control_cpp_pkg_interfaces::msg::rosidl_typesupport_introspection_cpp::Empty_message_type_support_handle;
}
