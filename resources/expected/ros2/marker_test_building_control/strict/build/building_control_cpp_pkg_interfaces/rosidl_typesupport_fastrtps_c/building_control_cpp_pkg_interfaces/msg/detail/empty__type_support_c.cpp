...
#include "building_control_cpp_pkg_interfaces/msg/detail/empty__rosidl_typesupport_fastrtps_c.h"
...
using _Empty__ros_msg_type = building_control_cpp_pkg_interfaces__msg__Empty;
...
size_t get_serialized_size_building_control_cpp_pkg_interfaces__msg__Empty(
  const void * untyped_ros_message,
...
static uint32_t _Empty__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_building_control_cpp_pkg_interfaces__msg__Empty(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_building_control_cpp_pkg_interfaces
size_t max_serialized_size_building_control_cpp_pkg_interfaces__msg__Empty(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = building_control_cpp_pkg_interfaces__msg__Empty;
    is_plain =
      (
...
static size_t _Empty__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_building_control_cpp_pkg_interfaces__msg__Empty(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, building_control_cpp_pkg_interfaces, msg, Empty)() {
