...
#include "building_control_cpp_pkg_interfaces/msg/detail/float32__rosidl_typesupport_fastrtps_c.h"
...
using _Float32__ros_msg_type = building_control_cpp_pkg_interfaces__msg__Float32;
...
static uint32_t _Float32__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_building_control_cpp_pkg_interfaces__msg__Float32(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = building_control_cpp_pkg_interfaces__msg__Float32;
    is_plain =
      (
...
static size_t _Float32__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_building_control_cpp_pkg_interfaces__msg__Float32(
