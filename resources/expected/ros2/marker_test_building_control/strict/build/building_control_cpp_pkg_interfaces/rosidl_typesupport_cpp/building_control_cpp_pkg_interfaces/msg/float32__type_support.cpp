...
static const _Float32_type_support_symbol_names_t _Float32_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, building_control_cpp_pkg_interfaces, msg, Float32)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, building_control_cpp_pkg_interfaces, msg, Float32)),
  }
};
...
get_message_type_support_handle<building_control_cpp_pkg_interfaces::msg::Float32>()
{
  return &::building_control_cpp_pkg_interfaces::msg::rosidl_typesupport_cpp::Float32_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, building_control_cpp_pkg_interfaces, msg, Float32)() {
  return get_message_type_support_handle<building_control_cpp_pkg_interfaces::msg::Float32>();
}
