...
static const _Empty_type_support_symbol_names_t _Empty_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, building_control_cpp_pkg_interfaces, msg, Empty)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, building_control_cpp_pkg_interfaces, msg, Empty)),
  }
};
...
get_message_type_support_handle<building_control_cpp_pkg_interfaces::msg::Empty>()
{
  return &::building_control_cpp_pkg_interfaces::msg::rosidl_typesupport_cpp::Empty_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, building_control_cpp_pkg_interfaces, msg, Empty)() {
  return get_message_type_support_handle<building_control_cpp_pkg_interfaces::msg::Empty>();
}
