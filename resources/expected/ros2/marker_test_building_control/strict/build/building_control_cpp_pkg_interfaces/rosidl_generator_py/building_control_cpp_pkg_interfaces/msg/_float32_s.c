...
bool building_control_cpp_pkg_interfaces__msg__float32__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("building_control_cpp_pkg_interfaces.msg._float32.Float32", full_classname_dest, 56) == 0);
  }
  building_control_cpp_pkg_interfaces__msg__Float32 * ros_message = _ros_message;
  {  // data
...
PyObject * building_control_cpp_pkg_interfaces__msg__float32__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("building_control_cpp_pkg_interfaces.msg._float32");
