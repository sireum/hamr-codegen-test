...
#include "building_control_cpp_pkg_interfaces/msg/detail/empty__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const building_control_cpp_pkg_interfaces::msg::Empty & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  building_control_cpp_pkg_interfaces::msg::Empty & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = building_control_cpp_pkg_interfaces::msg::Empty;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const building_control_cpp_pkg_interfaces::msg::Empty *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<building_control_cpp_pkg_interfaces::msg::Empty *>(
    untyped_ros_message);
...
{
  return &building_control_cpp_pkg_interfaces::msg::typesupport_fastrtps_cpp::_Empty__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, building_control_cpp_pkg_interfaces, msg, Empty)() {
  return &building_control_cpp_pkg_interfaces::msg::typesupport_fastrtps_cpp::_Empty__handle;
}
