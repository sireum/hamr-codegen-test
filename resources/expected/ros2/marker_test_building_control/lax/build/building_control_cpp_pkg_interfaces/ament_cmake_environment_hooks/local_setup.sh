...
: ${AMENT_CURRENT_PREFIX:="/home/clint/Applications/Sireum/hamr/codegen/jvm/src/test/results/ros2/marker_test_building_control/results/lax/install/building_control_cpp_pkg_interfaces"}
