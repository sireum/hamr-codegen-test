...
static const _Float32_type_support_symbol_names_t _Float32_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, building_control_cpp_pkg_interfaces, msg, Float32)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, building_control_cpp_pkg_interfaces, msg, Float32)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, building_control_cpp_pkg_interfaces, msg, Float32)() {
  return &::building_control_cpp_pkg_interfaces::msg::rosidl_typesupport_c::Float32_message_type_support_handle;
}
