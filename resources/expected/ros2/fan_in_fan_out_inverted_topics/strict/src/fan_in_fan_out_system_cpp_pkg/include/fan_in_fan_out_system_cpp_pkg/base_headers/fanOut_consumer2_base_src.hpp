...
private:
    ...
    void eventSubscriptionHandler(MsgType msg, std::queue<MsgType>& infrastructureQueue, std::queue<MsgType>& applicationQueue, void (fanOut_consumer2_base::*handleMsg)(MsgType));
    ...
    //  C o m m u n i c a t i o n
    //=================================================
    rclcpp::Subscription<fan_in_fan_out_system_cpp_pkg_interfaces::msg::Integer64>::SharedPtr fanOut_consumer2_myInteger_subscription_;
    ...
    // Used by sendOutputs
    std::vector<std::tuple<std::queue<MsgType>*, std::queue<MsgType>*, void (fanOut_consumer2_base::*)(MsgType)>> outPortTupleVector;
};
