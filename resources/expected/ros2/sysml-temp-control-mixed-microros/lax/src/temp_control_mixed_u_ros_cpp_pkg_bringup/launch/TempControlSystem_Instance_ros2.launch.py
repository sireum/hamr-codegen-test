...
def generate_launch_description():
    ...
    tcp_fan_node = Node(
        package="temp_control_mixed_u_ros_cpp_pkg",
    ...
    tcp_opInterface_node = Node(
        package="temp_control_mixed_u_ros_cpp_pkg",
        executable="tcp_opInterface_exe",
        # LAUNCH CONFIG tcp_opInterface - additions within these tags will be preserved when re-running Codegen
        # LAUNCH CONFIG tcp_opInterface - additions within these tags will be preserved when re-running Codegen
    )
    # LAUNCH OVERRIDE tcp_opInterface - additions within these tags will be preserved when re-running Codegen
    # Rebind tcp_opInterface_node here to replace the declaration above, e.g.
    #     tcp_opInterface_node = Node(package="...", executable="...")
    # LAUNCH OVERRIDE tcp_opInterface - additions within these tags will be preserved when re-running Codegen
    ld.add_action(tcp_opInterface_node)
