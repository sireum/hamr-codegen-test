...
private:
    ...
    void handle_fanAck(const temp_control_mixed_u_ros_cpp_pkg_interfaces::msg::FanAck::SharedPtr msg);
    void handle_setPoint(const temp_control_mixed_u_ros_cpp_pkg_interfaces::msg::SetPoint::SharedPtr msg);
