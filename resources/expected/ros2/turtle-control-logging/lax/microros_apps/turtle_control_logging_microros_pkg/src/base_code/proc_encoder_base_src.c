#include "turtle_control_logging_microros_pkg/base_headers/proc_encoder_base_src.h"
...
static void proc_encoder_sendOutputs(proc_encoder_base_t * self)
{
    ...
    if (self->proc_encoder_overspeed_out_hasValue) {
        turtle_control_logging_cpp_pkg_interfaces__msg__Empty msg;
        turtle_control_logging_cpp_pkg_interfaces__msg__Empty__init(&msg);
...
rcl_ret_t proc_encoder_base_init(proc_encoder_base_t * self)
{
    ...
    RCL_CHECK(rclc_publisher_init_default(
        ...
        &self->node,
        ROSIDL_GET_MSG_TYPE_SUPPORT(turtle_control_logging_cpp_pkg_interfaces, msg, WheelSpeed),
        "speed"));

    RCL_CHECK(rclc_publisher_init_default(
        &self->proc_encoder_overspeed_publisher,
        &self->node,
        ROSIDL_GET_MSG_TYPE_SUPPORT(turtle_control_logging_cpp_pkg_interfaces, msg, Empty),
    ...
    RCL_CHECK(rclc_subscription_init_default(
        ...
        &self->node,
        ROSIDL_GET_MSG_TYPE_SUPPORT(turtle_control_logging_cpp_pkg_interfaces, msg, OperatingMode),
        "proc_encoder_mode"));

    RCL_CHECK(rclc_subscription_init_default(
        &self->proc_encoder_trim_subscription,
        &self->node,
        ROSIDL_GET_MSG_TYPE_SUPPORT(turtle_control_logging_cpp_pkg_interfaces, msg, TrimCommand),
        "proc_encoder_trim"));
...
void put_speed(proc_encoder_base_t * self, turtle_control_logging_cpp_pkg_interfaces__msg__WheelSpeed * msg)
{
...
turtle_control_logging_cpp_pkg_interfaces__msg__OperatingMode * get_mode(proc_encoder_base_t * self)
{
...
turtle_control_logging_cpp_pkg_interfaces__msg__TrimCommand * get_trim(proc_encoder_base_t * self)
{
