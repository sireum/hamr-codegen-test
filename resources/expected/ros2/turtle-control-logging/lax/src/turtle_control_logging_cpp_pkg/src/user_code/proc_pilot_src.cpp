#include "turtle_control_logging_cpp_pkg/user_headers/proc_pilot_src.hpp"
#include "turtle_control_logging_cpp_pkg/base_headers/enum_converter.hpp"
...
//=================================================
void proc_pilot::handle_speed(const turtle_control_logging_cpp_pkg_interfaces::msg::WheelSpeed::SharedPtr msg)
{
    // Handle speed msg
