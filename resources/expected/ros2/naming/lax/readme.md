...
# uros_demo_naming — Mixed ROS2 / microROS Workspace
...
cp -r src/uros_demo_naming_cpp_pkg_interfaces $MICROROS_WS/src/
cp -r microros_apps/uros_demo_naming_microros_pkg $MICROROS_WS/src/
cd $MICROROS_WS && colcon build --packages-select uros_demo_naming_cpp_pkg_interfaces uros_demo_naming_microros_pkg
