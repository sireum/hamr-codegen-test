#include "BuildingControlDemo_i_Instance_cpp_pkg/user_headers/BuildingControlDemo_i_Instance_tcp_tempControl_src.hpp"
...
//=================================================
void BuildingControlDemo_i_Instance_tcp_tempControl::handle_currentTemp(const example_interfaces::msg::Int32::SharedPtr msg)
{
    // Handle currentTemp msg
}
