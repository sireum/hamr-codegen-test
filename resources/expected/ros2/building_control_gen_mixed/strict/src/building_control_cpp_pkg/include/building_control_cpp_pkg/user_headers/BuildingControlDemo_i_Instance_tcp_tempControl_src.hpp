...
private:
    ...
    //=================================================
    void handle_fanAck(const example_interfaces::msg::Int32 msg);
    void handle_setPoint(const example_interfaces::msg::Int32 msg);
    void handle_tempChanged(const example_interfaces::msg::Int32 msg);
