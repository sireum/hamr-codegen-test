...
private:
    ...
    //  C o m m u n i c a t i o n
    //=================================================
    rclcpp::Publisher<fan_in_fan_out_system_cpp_pkg_interfaces::msg::Integer64>::SharedPtr fanOut_producer_myInteger_publisher_1;
    rclcpp::Publisher<fan_in_fan_out_system_cpp_pkg_interfaces::msg::Integer64>::SharedPtr fanOut_producer_myInteger_publisher_2;
    ...
    // Used by sendOutputs
    std::vector<std::tuple<std::queue<MsgType>*, std::queue<MsgType>*, void (fanOut_producer_base::*)(MsgType)>> outPortTupleVector;
};
