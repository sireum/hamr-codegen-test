...
static inline std::string _messageToString(const isolette_cpp_pkg_interfaces::msg::Tempimpl& msg) {
    std::ostringstream oss;
    oss << "Tempimpl{value: " << msg.value.data << "}";
    return oss.str();
}

static inline std::string _messageToString(const isolette_cpp_pkg_interfaces::msg::Status& msg) {
    std::ostringstream oss;
    oss << enumToString(msg);
    return oss.str();
}
