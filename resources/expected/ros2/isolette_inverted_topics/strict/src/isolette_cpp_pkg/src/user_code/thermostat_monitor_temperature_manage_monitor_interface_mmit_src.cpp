...
void thermostat_monitor_temperature_manage_monitor_interface_mmit::timeTriggered()
{
    ...
    isolette_cpp_pkg_interfaces::msg::TempWstatusimpl upper_alarm_tempWstatus = get_upper_alarm_tempWstatus();
    PRINT_INFO("Received upper_alarm_tempWstatus: %s", MESSAGE_TO_STRING(upper_alarm_tempWstatus));
    isolette_cpp_pkg_interfaces::msg::TempWstatusimpl lower_alarm_tempWstatus = get_lower_alarm_tempWstatus();
