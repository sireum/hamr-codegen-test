...
def generate_launch_description():
    ...
    heat_source_cpi_heat_controller_node = Node(
        ...
        # LAUNCH CONFIG heat_source_cpi_heat_controller - additions within these tags will be preserved when re-running Codegen
        # LAUNCH CONFIG heat_source_cpi_heat_controller - additions within these tags will be preserved when re-running Codegen
    )
    # LAUNCH OVERRIDE heat_source_cpi_heat_controller - additions within these tags will be preserved when re-running Codegen
    # Rebind heat_source_cpi_heat_controller_node here to replace the declaration above, e.g.
    #     heat_source_cpi_heat_controller_node = Node(package="...", executable="...")
    # LAUNCH OVERRIDE heat_source_cpi_heat_controller - additions within these tags will be preserved when re-running Codegen
