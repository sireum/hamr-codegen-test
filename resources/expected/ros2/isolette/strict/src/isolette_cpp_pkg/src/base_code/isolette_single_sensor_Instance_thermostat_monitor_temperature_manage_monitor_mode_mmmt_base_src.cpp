...
isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_monitor_mode_mmmt_base::isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_monitor_mode_mmmt_base() : Node("isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_monitor_mode_mmmt")
{
    ...
    periodTimer_ = this->create_wall_timer(std::chrono::milliseconds(1000),
        std::bind(&isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_monitor_mode_mmmt_base::timeTriggeredCaller, this), cb_group_);
    ...
    // Used by sendOutputs
    outPortTupleVector = {
        {&applicationOut_monitor_mode, &infrastructureOut_monitor_mode, &isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_monitor_mode_mmmt_base::sendOut_monitor_mode}
    };
...
isolette_cpp_pkg_interfaces::msg::TempWstatusimpl isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_monitor_mode_mmmt_base::get_current_tempWstatus() {
    MsgType msg = applicationIn_current_tempWstatus.front();
    return std::get<isolette_cpp_pkg_interfaces::msg::TempWstatusimpl>(msg);
}
isolette_cpp_pkg_interfaces::msg::FailureFlagimpl isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_monitor_mode_mmmt_base::get_interface_failure() {
    MsgType msg = applicationIn_interface_failure.front();
    return std::get<isolette_cpp_pkg_interfaces::msg::FailureFlagimpl>(msg);
}
isolette_cpp_pkg_interfaces::msg::FailureFlagimpl isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_monitor_mode_mmmt_base::get_internal_failure() {
    MsgType msg = applicationIn_internal_failure.front();
    return std::get<isolette_cpp_pkg_interfaces::msg::FailureFlagimpl>(msg);
}
void isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_monitor_mode_mmmt_base::sendOut_monitor_mode(MsgType msg)
{
...
void isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_monitor_mode_mmmt_base::put_monitor_mode(isolette_cpp_pkg_interfaces::msg::MonitorMode msg)
{
    enqueue(applicationOut_monitor_mode, msg);
}

void isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_monitor_mode_mmmt_base::timeTriggeredCaller() {
    receiveInputs();
    timeTriggered();
    sendOutputs();
}

void isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_monitor_mode_mmmt_base::receiveInputs() {
...
void isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_monitor_mode_mmmt_base::enqueue(std::queue<MsgType>& queue, MsgType val) {
    if (queue.size() >= 1) {
        queue.pop();
    }
    queue.push(val);
...
void isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_monitor_mode_mmmt_base::sendOutputs() {
    for (std::tuple<std::queue<MsgType>*, std::queue<MsgType>*, void (isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_monitor_mode_mmmt_base::*)(MsgType)> port : outPortTupleVector) {
