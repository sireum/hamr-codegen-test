...
example_interfaces::msg::Int32 isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_monitor_mode_mmmt_base::get_current_tempWstatus() {
    MsgType msg = applicationIn_current_tempWstatus.front();
    return std::get<example_interfaces::msg::Int32>(msg);
}
example_interfaces::msg::Int32 isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_monitor_mode_mmmt_base::get_interface_failure() {
    MsgType msg = applicationIn_interface_failure.front();
    return std::get<example_interfaces::msg::Int32>(msg);
}
example_interfaces::msg::Int32 isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_monitor_mode_mmmt_base::get_internal_failure() {
