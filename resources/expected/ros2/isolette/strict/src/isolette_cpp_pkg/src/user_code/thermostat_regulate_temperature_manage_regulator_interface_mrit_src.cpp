...
void thermostat_regulate_temperature_manage_regulator_interface_mrit::timeTriggered()
{
    ...
    isolette_cpp_pkg_interfaces::msg::TempWstatusimpl lower_desired_tempWstatus = get_lower_desired_tempWstatus();
    LOG_INFO("Received lower_desired_tempWstatus: %s", MESSAGE_TO_STRING(lower_desired_tempWstatus));
    isolette_cpp_pkg_interfaces::msg::TempWstatusimpl upper_desired_tempWstatus = get_upper_desired_tempWstatus();
    LOG_INFO("Received upper_desired_tempWstatus: %s", MESSAGE_TO_STRING(upper_desired_tempWstatus));
    isolette_cpp_pkg_interfaces::msg::RegulatorMode regulator_mode = get_regulator_mode();
