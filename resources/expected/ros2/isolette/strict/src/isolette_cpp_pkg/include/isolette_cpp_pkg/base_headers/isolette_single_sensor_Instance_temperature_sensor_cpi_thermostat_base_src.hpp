...
protected:
    ...
    example_interfaces::msg::Int32 get_air();
...
private:
    ...
    // Used by sendOutputs
    std::vector<std::tuple<std::queue<MsgType>*, std::queue<MsgType>*, void (isolette_single_sensor_Instance_temperature_sensor_cpi_thermostat_base::*)(MsgType)>> outPortTupleVector;
};
