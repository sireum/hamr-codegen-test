...
protected:
    ...
    void init_lower_desired_tempWstatus(isolette_cpp_pkg_interfaces::msg::TempWstatusimpl val);
    void init_upper_desired_tempWstatus(isolette_cpp_pkg_interfaces::msg::TempWstatusimpl val);
...
private:
    ...
    void accept_lower_desired_tempWstatus(isolette_cpp_pkg_interfaces::msg::TempWstatusimpl msg);
    void accept_upper_desired_tempWstatus(isolette_cpp_pkg_interfaces::msg::TempWstatusimpl msg);
