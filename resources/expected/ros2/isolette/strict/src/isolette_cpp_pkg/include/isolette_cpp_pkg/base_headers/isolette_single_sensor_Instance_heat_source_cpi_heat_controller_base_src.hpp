...
private:
    ...
    // Used by sendOutputs
    std::vector<std::tuple<std::queue<MsgType>*, std::queue<MsgType>*, void (isolette_single_sensor_Instance_heat_source_cpi_heat_controller_base::*)(MsgType)>> outPortTupleVector;
};
