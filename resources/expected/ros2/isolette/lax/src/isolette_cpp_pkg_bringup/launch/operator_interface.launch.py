...
def generate_launch_description():
    ...
    operator_interface_oip_oit_node = Node(
        ...
        # LAUNCH CONFIG operator_interface_oip_oit - additions within these tags will be preserved when re-running Codegen
        # LAUNCH CONFIG operator_interface_oip_oit - additions within these tags will be preserved when re-running Codegen
    )
    # LAUNCH OVERRIDE operator_interface_oip_oit - additions within these tags will be preserved when re-running Codegen
    # Rebind operator_interface_oip_oit_node here to replace the declaration above, e.g.
    #     operator_interface_oip_oit_node = Node(package="...", executable="...")
    # LAUNCH OVERRIDE operator_interface_oip_oit - additions within these tags will be preserved when re-running Codegen
