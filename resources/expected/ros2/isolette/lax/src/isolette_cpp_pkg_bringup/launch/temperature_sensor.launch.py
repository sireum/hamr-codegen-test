...
def generate_launch_description():
    ...
    temperature_sensor_cpi_thermostat_node = Node(
        ...
        # LAUNCH CONFIG temperature_sensor_cpi_thermostat - additions within these tags will be preserved when re-running Codegen
        # LAUNCH CONFIG temperature_sensor_cpi_thermostat - additions within these tags will be preserved when re-running Codegen
    )
    # LAUNCH OVERRIDE temperature_sensor_cpi_thermostat - additions within these tags will be preserved when re-running Codegen
    # Rebind temperature_sensor_cpi_thermostat_node here to replace the declaration above, e.g.
    #     temperature_sensor_cpi_thermostat_node = Node(package="...", executable="...")
    # LAUNCH OVERRIDE temperature_sensor_cpi_thermostat - additions within these tags will be preserved when re-running Codegen
