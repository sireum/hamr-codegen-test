...
void isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_monitor_interface_mmit_base::handle_upper_alarm_tempWstatus(const isolette_cpp_pkg_interfaces::msg::TempWstatusimpl::SharedPtr msg)
{
    upper_alarm_tempWstatus_msg_holder = msg;
}

void isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_monitor_interface_mmit_base::handle_lower_alarm_tempWstatus(const isolette_cpp_pkg_interfaces::msg::TempWstatusimpl::SharedPtr msg)
{
    lower_alarm_tempWstatus_msg_holder = msg;
}

void isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_monitor_interface_mmit_base::handle_current_tempWstatus(const isolette_cpp_pkg_interfaces::msg::TempWstatusimpl::SharedPtr msg)
{
    current_tempWstatus_msg_holder = msg;
}

void isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_monitor_interface_mmit_base::handle_monitor_mode(const isolette_cpp_pkg_interfaces::msg::MonitorMode::SharedPtr msg)
{
    monitor_mode_msg_holder = msg;
}

isolette_cpp_pkg_interfaces::msg::TempWstatusimpl::SharedPtr isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_monitor_interface_mmit_base::get_upper_alarm_tempWstatus() {
    return upper_alarm_tempWstatus_msg_holder;
}

isolette_cpp_pkg_interfaces::msg::TempWstatusimpl::SharedPtr isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_monitor_interface_mmit_base::get_lower_alarm_tempWstatus() {
    return lower_alarm_tempWstatus_msg_holder;
}

isolette_cpp_pkg_interfaces::msg::TempWstatusimpl::SharedPtr isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_monitor_interface_mmit_base::get_current_tempWstatus() {
    return current_tempWstatus_msg_holder;
}

isolette_cpp_pkg_interfaces::msg::MonitorMode::SharedPtr isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_monitor_interface_mmit_base::get_monitor_mode() {
