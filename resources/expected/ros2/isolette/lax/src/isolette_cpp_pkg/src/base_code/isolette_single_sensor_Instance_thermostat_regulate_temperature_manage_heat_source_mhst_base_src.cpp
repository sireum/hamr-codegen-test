...
void isolette_single_sensor_Instance_thermostat_regulate_temperature_manage_heat_source_mhst_base::handle_current_tempWstatus(const isolette_cpp_pkg_interfaces::msg::TempWstatusimpl::SharedPtr msg)
{
    current_tempWstatus_msg_holder = msg;
}

void isolette_single_sensor_Instance_thermostat_regulate_temperature_manage_heat_source_mhst_base::handle_lower_desired_temp(const isolette_cpp_pkg_interfaces::msg::Tempimpl::SharedPtr msg)
{
    lower_desired_temp_msg_holder = msg;
}

void isolette_single_sensor_Instance_thermostat_regulate_temperature_manage_heat_source_mhst_base::handle_upper_desired_temp(const isolette_cpp_pkg_interfaces::msg::Tempimpl::SharedPtr msg)
{
    upper_desired_temp_msg_holder = msg;
}

void isolette_single_sensor_Instance_thermostat_regulate_temperature_manage_heat_source_mhst_base::handle_regulator_mode(const isolette_cpp_pkg_interfaces::msg::RegulatorMode::SharedPtr msg)
{
    regulator_mode_msg_holder = msg;
}

isolette_cpp_pkg_interfaces::msg::TempWstatusimpl::SharedPtr isolette_single_sensor_Instance_thermostat_regulate_temperature_manage_heat_source_mhst_base::get_current_tempWstatus() {
    return current_tempWstatus_msg_holder;
}

isolette_cpp_pkg_interfaces::msg::Tempimpl::SharedPtr isolette_single_sensor_Instance_thermostat_regulate_temperature_manage_heat_source_mhst_base::get_lower_desired_temp() {
    return lower_desired_temp_msg_holder;
}

isolette_cpp_pkg_interfaces::msg::Tempimpl::SharedPtr isolette_single_sensor_Instance_thermostat_regulate_temperature_manage_heat_source_mhst_base::get_upper_desired_temp() {
    return upper_desired_temp_msg_holder;
}

isolette_cpp_pkg_interfaces::msg::RegulatorMode::SharedPtr isolette_single_sensor_Instance_thermostat_regulate_temperature_manage_heat_source_mhst_base::get_regulator_mode() {
