...
void isolette_single_sensor_Instance_temperature_sensor_cpi_thermostat_base::handle_air(const isolette_cpp_pkg_interfaces::msg::PhysicalTempimpl::SharedPtr msg)
{
    air_msg_holder = msg;
}

isolette_cpp_pkg_interfaces::msg::PhysicalTempimpl::SharedPtr isolette_single_sensor_Instance_temperature_sensor_cpi_thermostat_base::get_air() {
