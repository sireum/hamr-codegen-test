...
void isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_monitor_mode_mmmt_base::handle_current_tempWstatus(const isolette_cpp_pkg_interfaces::msg::TempWstatusimpl::SharedPtr msg)
{
    current_tempWstatus_msg_holder = msg;
}

void isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_monitor_mode_mmmt_base::handle_interface_failure(const isolette_cpp_pkg_interfaces::msg::FailureFlagimpl::SharedPtr msg)
{
    interface_failure_msg_holder = msg;
}

void isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_monitor_mode_mmmt_base::handle_internal_failure(const isolette_cpp_pkg_interfaces::msg::FailureFlagimpl::SharedPtr msg)
{
    internal_failure_msg_holder = msg;
}

isolette_cpp_pkg_interfaces::msg::TempWstatusimpl::SharedPtr isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_monitor_mode_mmmt_base::get_current_tempWstatus() {
    return current_tempWstatus_msg_holder;
}

isolette_cpp_pkg_interfaces::msg::FailureFlagimpl::SharedPtr isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_monitor_mode_mmmt_base::get_interface_failure() {
    return interface_failure_msg_holder;
}

isolette_cpp_pkg_interfaces::msg::FailureFlagimpl::SharedPtr isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_monitor_mode_mmmt_base::get_internal_failure() {
