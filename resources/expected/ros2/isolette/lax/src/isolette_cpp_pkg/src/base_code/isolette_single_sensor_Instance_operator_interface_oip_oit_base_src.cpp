...
void isolette_single_sensor_Instance_operator_interface_oip_oit_base::handle_regulator_status(const isolette_cpp_pkg_interfaces::msg::Status::SharedPtr msg)
{
    regulator_status_msg_holder = msg;
}

void isolette_single_sensor_Instance_operator_interface_oip_oit_base::handle_monitor_status(const isolette_cpp_pkg_interfaces::msg::Status::SharedPtr msg)
{
    monitor_status_msg_holder = msg;
}

void isolette_single_sensor_Instance_operator_interface_oip_oit_base::handle_display_temperature(const isolette_cpp_pkg_interfaces::msg::Tempimpl::SharedPtr msg)
{
    display_temperature_msg_holder = msg;
}

void isolette_single_sensor_Instance_operator_interface_oip_oit_base::handle_alarm_control(const isolette_cpp_pkg_interfaces::msg::OnOff::SharedPtr msg)
{
    alarm_control_msg_holder = msg;
}

isolette_cpp_pkg_interfaces::msg::Status::SharedPtr isolette_single_sensor_Instance_operator_interface_oip_oit_base::get_regulator_status() {
    return regulator_status_msg_holder;
}

isolette_cpp_pkg_interfaces::msg::Status::SharedPtr isolette_single_sensor_Instance_operator_interface_oip_oit_base::get_monitor_status() {
    return monitor_status_msg_holder;
}

isolette_cpp_pkg_interfaces::msg::Tempimpl::SharedPtr isolette_single_sensor_Instance_operator_interface_oip_oit_base::get_display_temperature() {
    return display_temperature_msg_holder;
}

isolette_cpp_pkg_interfaces::msg::OnOff::SharedPtr isolette_single_sensor_Instance_operator_interface_oip_oit_base::get_alarm_control() {
