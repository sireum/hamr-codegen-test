...
# may run elsewhere; in that case launch UrosDemoSystem_Instance_ros2.launch.py alone.
#
...
def generate_launch_description():
    ...
    proc_ttj_node = Node(
        package="uros_demo_structure_microros_pkg",
        executable="proc_ttj_exe",
    ...
    # LAUNCH OVERRIDE proc_ttj - additions within these tags will be preserved when re-running Codegen
    # Rebind proc_ttj_node here to replace the declaration above, e.g.
    #     proc_ttj_node = Node(package="...", executable="...")
    # LAUNCH OVERRIDE proc_ttj - additions within these tags will be preserved when re-running Codegen
    ld.add_action(proc_ttj_node)
