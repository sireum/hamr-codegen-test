...
example_interfaces::msg::Int32 wrap_pca_imp_Instance_pump_operation_operation_process_operation_threads_ice_thread_base::get_status_AppConnected() {
    MsgType msg = applicationIn_status_AppConnected.front();
    return std::get<example_interfaces::msg::Int32>(msg);
}
example_interfaces::msg::Int32 wrap_pca_imp_Instance_pump_operation_operation_process_operation_threads_ice_thread_base::get_Infusion_Flow_Rate() {
    MsgType msg = applicationIn_Infusion_Flow_Rate.front();
    return std::get<example_interfaces::msg::Int32>(msg);
}
example_interfaces::msg::Int32 wrap_pca_imp_Instance_pump_operation_operation_process_operation_threads_ice_thread_base::get_Patient_Bolus_Rate() {
    MsgType msg = applicationIn_Patient_Bolus_Rate.front();
    return std::get<example_interfaces::msg::Int32>(msg);
}
example_interfaces::msg::Int32 wrap_pca_imp_Instance_pump_operation_operation_process_operation_threads_ice_thread_base::get_Square_Bolus_Rate() {
    MsgType msg = applicationIn_Square_Bolus_Rate.front();
    return std::get<example_interfaces::msg::Int32>(msg);
}
example_interfaces::msg::Int32 wrap_pca_imp_Instance_pump_operation_operation_process_operation_threads_ice_thread_base::get_Basal_Rate() {
    MsgType msg = applicationIn_Basal_Rate.front();
    return std::get<example_interfaces::msg::Int32>(msg);
}
example_interfaces::msg::Int32 wrap_pca_imp_Instance_pump_operation_operation_process_operation_threads_ice_thread_base::get_VTBI() {
    MsgType msg = applicationIn_VTBI.front();
    return std::get<example_interfaces::msg::Int32>(msg);
}
example_interfaces::msg::Int32 wrap_pca_imp_Instance_pump_operation_operation_process_operation_threads_ice_thread_base::get_Door_Open() {
    MsgType msg = applicationIn_Door_Open.front();
    return std::get<example_interfaces::msg::Int32>(msg);
}
example_interfaces::msg::Int32 wrap_pca_imp_Instance_pump_operation_operation_process_operation_threads_ice_thread_base::get_Alarm_Inactivation() {
...
void wrap_pca_imp_Instance_pump_operation_operation_process_operation_threads_ice_thread_base::put_parameters_current_flow_rate(example_interfaces::msg::Int32 msg)
{
    enqueue(applicationOut_parameters_current_flow_rate, msg);
}

void wrap_pca_imp_Instance_pump_operation_operation_process_operation_threads_ice_thread_base::put_parameters_basal_flow_rate(example_interfaces::msg::Int32 msg)
{
    enqueue(applicationOut_parameters_basal_flow_rate, msg);
}

void wrap_pca_imp_Instance_pump_operation_operation_process_operation_threads_ice_thread_base::put_parameters_bolus_flow_rate(example_interfaces::msg::Int32 msg)
{
    enqueue(applicationOut_parameters_bolus_flow_rate, msg);
}

void wrap_pca_imp_Instance_pump_operation_operation_process_operation_threads_ice_thread_base::put_parameters_KVO_Flow_Rate(example_interfaces::msg::Int32 msg)
{
    enqueue(applicationOut_parameters_KVO_Flow_Rate, msg);
}

void wrap_pca_imp_Instance_pump_operation_operation_process_operation_threads_ice_thread_base::put_parameters_volume_to_be_infused(example_interfaces::msg::Int32 msg)
{
    enqueue(applicationOut_parameters_volume_to_be_infused, msg);
}

void wrap_pca_imp_Instance_pump_operation_operation_process_operation_threads_ice_thread_base::put_parameters_clinican_requested_bolus_duration(example_interfaces::msg::Int32 msg)
{
    enqueue(applicationOut_parameters_clinican_requested_bolus_duration, msg);
}

void wrap_pca_imp_Instance_pump_operation_operation_process_operation_threads_ice_thread_base::put_parameters_square_flow_rate(example_interfaces::msg::Int32 msg)
{
    enqueue(applicationOut_parameters_square_flow_rate, msg);
}

void wrap_pca_imp_Instance_pump_operation_operation_process_operation_threads_ice_thread_base::put_status_On(example_interfaces::msg::Int32 msg)
{
    enqueue(applicationOut_status_On, msg);
}

void wrap_pca_imp_Instance_pump_operation_operation_process_operation_threads_ice_thread_base::put_status_Okay(example_interfaces::msg::Int32 msg)
{
    enqueue(applicationOut_status_Okay, msg);
}

void wrap_pca_imp_Instance_pump_operation_operation_process_operation_threads_ice_thread_base::put_status_status(example_interfaces::msg::Int32 msg)
{
