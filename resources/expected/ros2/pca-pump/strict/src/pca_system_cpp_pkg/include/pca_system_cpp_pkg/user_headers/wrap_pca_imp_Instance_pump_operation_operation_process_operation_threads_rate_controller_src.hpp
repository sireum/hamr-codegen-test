...
private:
    ...
    void handle_Begin_Priming(const example_interfaces::msg::Int32 msg);
    void handle_End_Priming(const example_interfaces::msg::Int32 msg);
    ...
    void handle_Pause_Infusion(const example_interfaces::msg::Int32 msg);
    void handle_Resume_Infusion(const example_interfaces::msg::Int32 msg);
    ...
    void handle_ICE_Stop_Pump(const example_interfaces::msg::Int32 msg);
