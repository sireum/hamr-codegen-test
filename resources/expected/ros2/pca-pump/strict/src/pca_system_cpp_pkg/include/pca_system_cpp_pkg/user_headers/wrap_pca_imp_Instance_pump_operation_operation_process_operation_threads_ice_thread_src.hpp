...
private:
    ...
    //=================================================
    void handle_command_Start(const pca_system_cpp_pkg_interfaces::msg::Empty msg);
    void handle_command_Suspend(const pca_system_cpp_pkg_interfaces::msg::Empty msg);
    void handle_command_load_drug_library(const pca_system_cpp_pkg_interfaces::msg::DrugLibrary msg);
    void handle_command_set_clinican_requested_bolus_duration(const pca_system_cpp_pkg_interfaces::msg::Minuteimp msg);
    void handle_command_request_bolus(const pca_system_cpp_pkg_interfaces::msg::Empty msg);
    void handle_command_pause_infusion(const pca_system_cpp_pkg_interfaces::msg::Empty msg);
    void handle_command_resume_infusion(const pca_system_cpp_pkg_interfaces::msg::Empty msg);
