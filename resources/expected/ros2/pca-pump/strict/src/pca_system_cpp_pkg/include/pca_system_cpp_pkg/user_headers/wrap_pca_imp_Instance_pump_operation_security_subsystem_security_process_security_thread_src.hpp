...
private:
    ...
    //=================================================
    void handle_Scan_Data(const example_interfaces::msg::Int32 msg);
    void handle_Authenticate_Clinician(const example_interfaces::msg::Int32 msg);
    void handle_Authenticate_Patient(const example_interfaces::msg::Int32 msg);
    void handle_Authenticate_Prescription(const example_interfaces::msg::Int32 msg);
