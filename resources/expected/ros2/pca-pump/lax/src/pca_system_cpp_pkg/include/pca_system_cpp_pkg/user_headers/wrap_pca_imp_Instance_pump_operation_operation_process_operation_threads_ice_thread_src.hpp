...
private:
    ...
    //=================================================
    void handle_command_Start(const example_interfaces::msg::Int32::SharedPtr msg);
    void handle_command_Suspend(const example_interfaces::msg::Int32::SharedPtr msg);
    void handle_command_load_drug_library(const example_interfaces::msg::Int32::SharedPtr msg);
    void handle_command_set_clinican_requested_bolus_duration(const example_interfaces::msg::Int32::SharedPtr msg);
    void handle_command_request_bolus(const example_interfaces::msg::Int32::SharedPtr msg);
    void handle_command_pause_infusion(const example_interfaces::msg::Int32::SharedPtr msg);
    void handle_command_resume_infusion(const example_interfaces::msg::Int32::SharedPtr msg);
