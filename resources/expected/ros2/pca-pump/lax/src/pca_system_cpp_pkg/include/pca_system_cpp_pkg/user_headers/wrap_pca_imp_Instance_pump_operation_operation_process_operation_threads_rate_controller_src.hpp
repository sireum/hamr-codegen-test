...
private:
    ...
    void handle_Begin_Priming(const pca_system_cpp_pkg_interfaces::msg::Empty::SharedPtr msg);
    void handle_End_Priming(const pca_system_cpp_pkg_interfaces::msg::Empty::SharedPtr msg);
    ...
    void handle_Pause_Infusion(const pca_system_cpp_pkg_interfaces::msg::Empty::SharedPtr msg);
    void handle_Resume_Infusion(const pca_system_cpp_pkg_interfaces::msg::Empty::SharedPtr msg);
    ...
    void handle_ICE_Stop_Pump(const pca_system_cpp_pkg_interfaces::msg::Empty::SharedPtr msg);
