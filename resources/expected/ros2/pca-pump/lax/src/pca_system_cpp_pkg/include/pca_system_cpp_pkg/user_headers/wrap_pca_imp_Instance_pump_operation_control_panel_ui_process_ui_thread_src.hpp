...
private:
    ...
    //=================================================
    void handle_Touch(const pca_system_cpp_pkg_interfaces::msg::Empty::SharedPtr msg);
    ...
    void handle_Display_Message(const pca_system_cpp_pkg_interfaces::msg::Message::SharedPtr msg);
    void handle_Sound_Type(const pca_system_cpp_pkg_interfaces::msg::Sound::SharedPtr msg);
    ...
    void handle_Soft_Limit_Warning(const pca_system_cpp_pkg_interfaces::msg::Empty::SharedPtr msg);
