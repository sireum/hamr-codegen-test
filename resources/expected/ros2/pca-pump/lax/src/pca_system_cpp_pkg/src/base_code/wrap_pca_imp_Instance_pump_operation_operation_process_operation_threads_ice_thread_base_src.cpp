...
void wrap_pca_imp_Instance_pump_operation_operation_process_operation_threads_ice_thread_base::handle_status_AppConnected(const pca_system_cpp_pkg_interfaces::msg::Boolean::SharedPtr msg)
{
    status_AppConnected_msg_holder = msg;
}

void wrap_pca_imp_Instance_pump_operation_operation_process_operation_threads_ice_thread_base::handle_Infusion_Flow_Rate(const pca_system_cpp_pkg_interfaces::msg::FlowRateimp::SharedPtr msg)
{
    Infusion_Flow_Rate_msg_holder = msg;
}

void wrap_pca_imp_Instance_pump_operation_operation_process_operation_threads_ice_thread_base::handle_Patient_Bolus_Rate(const pca_system_cpp_pkg_interfaces::msg::FlowRateimp::SharedPtr msg)
{
    Patient_Bolus_Rate_msg_holder = msg;
}

void wrap_pca_imp_Instance_pump_operation_operation_process_operation_threads_ice_thread_base::handle_Square_Bolus_Rate(const pca_system_cpp_pkg_interfaces::msg::FlowRateimp::SharedPtr msg)
{
    Square_Bolus_Rate_msg_holder = msg;
}

void wrap_pca_imp_Instance_pump_operation_operation_process_operation_threads_ice_thread_base::handle_Basal_Rate(const pca_system_cpp_pkg_interfaces::msg::FlowRateimp::SharedPtr msg)
{
    Basal_Rate_msg_holder = msg;
}

void wrap_pca_imp_Instance_pump_operation_operation_process_operation_threads_ice_thread_base::handle_VTBI(const pca_system_cpp_pkg_interfaces::msg::DrugVolumeimp::SharedPtr msg)
{
    VTBI_msg_holder = msg;
}

void wrap_pca_imp_Instance_pump_operation_operation_process_operation_threads_ice_thread_base::handle_Door_Open(const pca_system_cpp_pkg_interfaces::msg::Boolean::SharedPtr msg)
{
    Door_Open_msg_holder = msg;
}

void wrap_pca_imp_Instance_pump_operation_operation_process_operation_threads_ice_thread_base::handle_Alarm_Inactivation(const pca_system_cpp_pkg_interfaces::msg::AlarmSignal::SharedPtr msg)
{
    Alarm_Inactivation_msg_holder = msg;
}

pca_system_cpp_pkg_interfaces::msg::Boolean::SharedPtr wrap_pca_imp_Instance_pump_operation_operation_process_operation_threads_ice_thread_base::get_status_AppConnected() {
    return status_AppConnected_msg_holder;
}

pca_system_cpp_pkg_interfaces::msg::FlowRateimp::SharedPtr wrap_pca_imp_Instance_pump_operation_operation_process_operation_threads_ice_thread_base::get_Infusion_Flow_Rate() {
    return Infusion_Flow_Rate_msg_holder;
}

pca_system_cpp_pkg_interfaces::msg::FlowRateimp::SharedPtr wrap_pca_imp_Instance_pump_operation_operation_process_operation_threads_ice_thread_base::get_Patient_Bolus_Rate() {
    return Patient_Bolus_Rate_msg_holder;
}

pca_system_cpp_pkg_interfaces::msg::FlowRateimp::SharedPtr wrap_pca_imp_Instance_pump_operation_operation_process_operation_threads_ice_thread_base::get_Square_Bolus_Rate() {
    return Square_Bolus_Rate_msg_holder;
}

pca_system_cpp_pkg_interfaces::msg::FlowRateimp::SharedPtr wrap_pca_imp_Instance_pump_operation_operation_process_operation_threads_ice_thread_base::get_Basal_Rate() {
    return Basal_Rate_msg_holder;
}

pca_system_cpp_pkg_interfaces::msg::DrugVolumeimp::SharedPtr wrap_pca_imp_Instance_pump_operation_operation_process_operation_threads_ice_thread_base::get_VTBI() {
    return VTBI_msg_holder;
}

pca_system_cpp_pkg_interfaces::msg::Boolean::SharedPtr wrap_pca_imp_Instance_pump_operation_operation_process_operation_threads_ice_thread_base::get_Door_Open() {
    return Door_Open_msg_holder;
}

pca_system_cpp_pkg_interfaces::msg::AlarmSignal::SharedPtr wrap_pca_imp_Instance_pump_operation_operation_process_operation_threads_ice_thread_base::get_Alarm_Inactivation() {
