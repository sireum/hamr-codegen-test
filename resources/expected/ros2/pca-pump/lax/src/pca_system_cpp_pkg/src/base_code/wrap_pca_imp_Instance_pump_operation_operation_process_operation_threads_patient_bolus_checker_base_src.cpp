...
void wrap_pca_imp_Instance_pump_operation_operation_process_operation_threads_patient_bolus_checker_base::handle_Minimum_Time_Between_Bolus(const pca_system_cpp_pkg_interfaces::msg::Minuteimp::SharedPtr msg)
{
    Minimum_Time_Between_Bolus_msg_holder = msg;
}

pca_system_cpp_pkg_interfaces::msg::Minuteimp::SharedPtr wrap_pca_imp_Instance_pump_operation_operation_process_operation_threads_patient_bolus_checker_base::get_Minimum_Time_Between_Bolus() {
