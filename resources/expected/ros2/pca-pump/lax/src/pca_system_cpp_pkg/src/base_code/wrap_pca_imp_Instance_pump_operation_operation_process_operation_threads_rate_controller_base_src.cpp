...
void wrap_pca_imp_Instance_pump_operation_operation_process_operation_threads_rate_controller_base::handle_Square_Bolus_Rate(const example_interfaces::msg::Int32::SharedPtr msg)
{
    Square_Bolus_Rate_msg_holder = msg;
}

void wrap_pca_imp_Instance_pump_operation_operation_process_operation_threads_rate_controller_base::handle_Patient_Bolus_Rate(const example_interfaces::msg::Int32::SharedPtr msg)
{
    Patient_Bolus_Rate_msg_holder = msg;
}

void wrap_pca_imp_Instance_pump_operation_operation_process_operation_threads_rate_controller_base::handle_Basal_Rate(const example_interfaces::msg::Int32::SharedPtr msg)
{
    Basal_Rate_msg_holder = msg;
}

void wrap_pca_imp_Instance_pump_operation_operation_process_operation_threads_rate_controller_base::handle_VTBI(const example_interfaces::msg::Int32::SharedPtr msg)
{
    VTBI_msg_holder = msg;
}

void wrap_pca_imp_Instance_pump_operation_operation_process_operation_threads_rate_controller_base::handle_Door_Open(const example_interfaces::msg::Int32::SharedPtr msg)
{
    Door_Open_msg_holder = msg;
}

example_interfaces::msg::Int32::SharedPtr wrap_pca_imp_Instance_pump_operation_operation_process_operation_threads_rate_controller_base::get_Square_Bolus_Rate() {
    return Square_Bolus_Rate_msg_holder;
}

example_interfaces::msg::Int32::SharedPtr wrap_pca_imp_Instance_pump_operation_operation_process_operation_threads_rate_controller_base::get_Patient_Bolus_Rate() {
    return Patient_Bolus_Rate_msg_holder;
}

example_interfaces::msg::Int32::SharedPtr wrap_pca_imp_Instance_pump_operation_operation_process_operation_threads_rate_controller_base::get_Basal_Rate() {
    return Basal_Rate_msg_holder;
}

example_interfaces::msg::Int32::SharedPtr wrap_pca_imp_Instance_pump_operation_operation_process_operation_threads_rate_controller_base::get_VTBI() {
    return VTBI_msg_holder;
}

example_interfaces::msg::Int32::SharedPtr wrap_pca_imp_Instance_pump_operation_operation_process_operation_threads_rate_controller_base::get_Door_Open() {
