#include "wrap_pca_imp_Instance_cpp_pkg/base_headers/wrap_pca_imp_Instance_pump_operation_operation_process_operation_threads_max_drug_watcher_base_src.hpp"
...
void wrap_pca_imp_Instance_pump_operation_operation_process_operation_threads_max_drug_watcher_base::handle_Infusion_Flow_Rate(const example_interfaces::msg::Int32::SharedPtr msg)
{
    Infusion_Flow_Rate_msg_holder = msg;
}

void wrap_pca_imp_Instance_pump_operation_operation_process_operation_threads_max_drug_watcher_base::handle_Max_Drug_Per_Hour(const example_interfaces::msg::Int32::SharedPtr msg)
{
    Max_Drug_Per_Hour_msg_holder = msg;
}

example_interfaces::msg::Int32::SharedPtr wrap_pca_imp_Instance_pump_operation_operation_process_operation_threads_max_drug_watcher_base::get_Infusion_Flow_Rate() {
    return Infusion_Flow_Rate_msg_holder;
}

example_interfaces::msg::Int32::SharedPtr wrap_pca_imp_Instance_pump_operation_operation_process_operation_threads_max_drug_watcher_base::get_Max_Drug_Per_Hour() {
