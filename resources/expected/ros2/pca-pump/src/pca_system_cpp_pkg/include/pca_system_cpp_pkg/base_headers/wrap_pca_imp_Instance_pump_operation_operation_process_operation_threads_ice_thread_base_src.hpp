...
private:
    ...
    virtual void handle_status_AppConnected(const example_interfaces::msg::Int32::SharedPtr msg) = 0;
    ...
    virtual void handle_Alarm_Inactivation(const example_interfaces::msg::Int32::SharedPtr msg) = 0;
