...
private:
    ...
    //=================================================
    virtual void handle_Square_Bolus_Rate(const example_interfaces::msg::Int32::SharedPtr msg) = 0;
    virtual void handle_Patient_Bolus_Rate(const example_interfaces::msg::Int32::SharedPtr msg) = 0;
    virtual void handle_Basal_Rate(const example_interfaces::msg::Int32::SharedPtr msg) = 0;
    virtual void handle_VTBI(const example_interfaces::msg::Int32::SharedPtr msg) = 0;
    virtual void handle_Door_Open(const example_interfaces::msg::Int32::SharedPtr msg) = 0;
    ...
    virtual void handle_Begin_Priming(const example_interfaces::msg::Int32::SharedPtr msg) = 0;
    virtual void handle_End_Priming(const example_interfaces::msg::Int32::SharedPtr msg) = 0;
    ...
    virtual void handle_Pause_Infusion(const example_interfaces::msg::Int32::SharedPtr msg) = 0;
    virtual void handle_Resume_Infusion(const example_interfaces::msg::Int32::SharedPtr msg) = 0;
    ...
    virtual void handle_ICE_Stop_Pump(const example_interfaces::msg::Int32::SharedPtr msg) = 0;
