...
private:
    ...
    void eventSubscriptionHandler(MsgType msg, std::queue<MsgType>& infrastructureQueue, std::queue<MsgType>& applicationQueue, void (Sys_i_Instance_consumer_consumer_base::*handleMsg)(MsgType));
    ...
    // Used by sendOutputs
    std::vector<std::tuple<std::queue<MsgType>*, std::queue<MsgType>*, void (Sys_i_Instance_consumer_consumer_base::*)(MsgType)>> outPortTupleVector;
};
