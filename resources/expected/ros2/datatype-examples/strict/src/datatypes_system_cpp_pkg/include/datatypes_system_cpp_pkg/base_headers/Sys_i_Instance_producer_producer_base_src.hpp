...
class Sys_i_Instance_producer_producer_base : public rclcpp::Node
{
protected:
    ...
    Sys_i_Instance_producer_producer_base();
...
private:
    ...
    // Used by sendOutputs
    std::vector<std::tuple<std::queue<MsgType>*, std::queue<MsgType>*, void (Sys_i_Instance_producer_producer_base::*)(MsgType)>> outPortTupleVector;
};
