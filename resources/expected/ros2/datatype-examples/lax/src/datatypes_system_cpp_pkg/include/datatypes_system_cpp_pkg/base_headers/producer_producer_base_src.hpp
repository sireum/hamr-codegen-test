...
#include "datatypes_system_cpp_pkg/base_headers/example_types.hpp"

// Do not edit this file as it will be overwritten if HAMR codegen is rerun
// To prevent overwriting, add '//@  hamr:no-overwrite' to this file

static inline std::string _messageToString(const datatypes_system_cpp_pkg_interfaces::msg::Boolean& msg) {
    std::ostringstream oss;
    oss << msg.data;
    return oss.str();
}

static inline std::string _messageToString(const datatypes_system_cpp_pkg_interfaces::msg::Integer64& msg) {
    std::ostringstream oss;
    oss << msg.data;
    return oss.str();
}

static inline std::string _messageToString(const datatypes_system_cpp_pkg_interfaces::msg::Float64& msg) {
    std::ostringstream oss;
    oss << msg.data;
    return oss.str();
}

static inline std::string _messageToString(const datatypes_system_cpp_pkg_interfaces::msg::Character& msg) {
    std::ostringstream oss;
    oss << msg.data;
    return oss.str();
}

static inline std::string _messageToString(const datatypes_system_cpp_pkg_interfaces::msg::String& msg) {
    std::ostringstream oss;
    oss << msg.data;
    return oss.str();
}

static inline std::string _messageToString(const datatypes_system_cpp_pkg_interfaces::msg::Integer8& msg) {
    std::ostringstream oss;
    oss << msg.data;
    return oss.str();
}

static inline std::string _messageToString(const datatypes_system_cpp_pkg_interfaces::msg::Integer16& msg) {
    std::ostringstream oss;
    oss << msg.data;
    return oss.str();
}

static inline std::string _messageToString(const datatypes_system_cpp_pkg_interfaces::msg::Integer32& msg) {
    std::ostringstream oss;
    oss << msg.data;
    return oss.str();
}

static inline std::string _messageToString(const datatypes_system_cpp_pkg_interfaces::msg::Unsigned8& msg) {
    std::ostringstream oss;
    oss << msg.data;
    return oss.str();
}

static inline std::string _messageToString(const datatypes_system_cpp_pkg_interfaces::msg::Unsigned16& msg) {
    std::ostringstream oss;
    oss << msg.data;
    return oss.str();
}

static inline std::string _messageToString(const datatypes_system_cpp_pkg_interfaces::msg::Unsigned32& msg) {
    std::ostringstream oss;
    oss << msg.data;
    return oss.str();
}

static inline std::string _messageToString(const datatypes_system_cpp_pkg_interfaces::msg::Unsigned64& msg) {
    std::ostringstream oss;
    oss << msg.data;
    return oss.str();
}

static inline std::string _messageToString(const datatypes_system_cpp_pkg_interfaces::msg::Float32& msg) {
    std::ostringstream oss;
    oss << msg.data;
    return oss.str();
}

static inline std::string _messageToString(const datatypes_system_cpp_pkg_interfaces::msg::MyEnum& msg) {
    std::ostringstream oss;
    oss << enumToString(msg);
    return oss.str();
}

static inline std::string _messageToString(const datatypes_system_cpp_pkg_interfaces::msg::MyStructi& msg) {
    std::ostringstream oss;
    oss << "MyStructi{field_int64: " << msg.field_int64.data << ", field_str: " << msg.field_str.data << ", field_enum: " << enumToString(msg.field_enum) << ", field_rec: " << "MyStruct2i{field_float: " << msg.field_rec.field_float.data << ", field_s_char: " << msg.field_rec.field_s_char.data << "}" << ", field_array: " << "unknown" << ", field_array_unbounded: " << "unknown" << "}";
    return oss.str();
}

static inline std::string _messageToString(const datatypes_system_cpp_pkg_interfaces::msg::MyArrayOneDim& msg) {
    std::ostringstream oss;
    oss << "unknown";
    return oss.str();
}

static inline std::string _messageToString(const datatypes_system_cpp_pkg_interfaces::msg::MyArrayUnbounded& msg) {
    std::ostringstream oss;
    oss << "unknown";
    return oss.str();
}

static inline std::string _messageToString(const datatypes_system_cpp_pkg_interfaces::msg::MyArrayTwoDim& msg) {
    std::ostringstream oss;
    oss << "unknown";
    return oss.str();
}
