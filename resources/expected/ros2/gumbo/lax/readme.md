...
# uros_demo_gumbo — Mixed ROS2 / microROS Workspace
...
|---|---|---|---|
| `proc_joy_exe` | `uros_demo_gumbo_cpp_pkg` | ROS2 (rclcpp) | Periodic |
| `proc_logger_exe` | `uros_demo_gumbo_cpp_pkg` | ROS2 (rclcpp) | Sporadic |
| `proc_ttj_exe` | `uros_demo_gumbo_microros_pkg` | microROS (rclc + rmw_microxrcedds) | Sporadic |
...
cp -r src/uros_demo_gumbo_cpp_pkg_interfaces $MICROROS_WS/src/
cp -r microros_apps/uros_demo_gumbo_microros_pkg $MICROROS_WS/src/
cd $MICROROS_WS && colcon build --packages-select uros_demo_gumbo_cpp_pkg_interfaces uros_demo_gumbo_microros_pkg
...
RMW_IMPLEMENTATION=rmw_microxrcedds ros2 run uros_demo_gumbo_microros_pkg proc_ttj_exe

# proc_joy — ROS2 node
ros2 run uros_demo_gumbo_cpp_pkg proc_joy_exe

# proc_logger — ROS2 node
ros2 run uros_demo_gumbo_cpp_pkg proc_logger_exe
```
