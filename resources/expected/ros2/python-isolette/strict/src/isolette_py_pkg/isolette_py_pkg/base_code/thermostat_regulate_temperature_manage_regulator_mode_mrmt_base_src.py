...
class thermostat_regulate_temperature_manage_regulator_mode_mrmt_base(Node):
    ...
    def sendOut_regulator_mode(self, msg):
        if type(msg) is RegulatorMode:
            ...
            typedMsg.data = msg
            self.thermostat_regulate_temperature_manage_regulator_mode_mrmt_regulator_mode_publisher_1.publish(typedMsg)
            self.thermostat_regulate_temperature_manage_regulator_mode_mrmt_regulator_mode_publisher_2.publish(typedMsg)
        else:
