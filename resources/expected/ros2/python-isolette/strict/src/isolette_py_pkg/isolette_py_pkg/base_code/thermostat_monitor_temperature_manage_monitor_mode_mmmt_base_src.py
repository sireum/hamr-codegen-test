...
#=================================================
    ...
    def sendOut_monitor_mode(self, msg):
        if type(msg) is MonitorMode:
            ...
            typedMsg.data = msg
            self.thermostat_monitor_temperature_manage_monitor_mode_mmmt_monitor_mode_publisher_1.publish(typedMsg)
            self.thermostat_monitor_temperature_manage_monitor_mode_mmmt_monitor_mode_publisher_2.publish(typedMsg)
        else:
