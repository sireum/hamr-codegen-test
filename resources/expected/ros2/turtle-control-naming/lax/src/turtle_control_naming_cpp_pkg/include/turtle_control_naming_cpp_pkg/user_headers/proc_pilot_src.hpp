#include "turtle_control_naming_cpp_pkg/base_headers/proc_pilot_base_src.hpp"
...
private:
    ...
    //=================================================
    void handle_speed(const turtle_control_naming_cpp_pkg_interfaces::msg::WheelSpeed::SharedPtr msg);
