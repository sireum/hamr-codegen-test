...
object Arch {
  val BuildingControlDemo_i_Instance_tcp_tempSensor : slang.BuildingControl.TempSensor_i_tcp_tempSensor_Bridge = {
    ...
    slang.BuildingControl.TempSensor_i_tcp_tempSensor_Bridge(
      id = 0,
  ...
  val BuildingControlDemo_i_Instance_tcp_tempControl : slang.BuildingControl.TempControl_i_tcp_tempControl_Bridge = {
    ...
    slang.BuildingControl.TempControl_i_tcp_tempControl_Bridge(
      id = 1,
  ...
  val BuildingControlDemo_i_Instance_tcp_fan : slang.BuildingControl.Fan_i_tcp_fan_Bridge = {
    ...
    slang.BuildingControl.Fan_i_tcp_fan_Bridge(
      id = 2,
