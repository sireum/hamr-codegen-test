...
package slang.TempSensor

import org.sireum._
import art._
import slang._
import slang.TempSensor.{TempSensor_i_tcproc_tempSensor => component}

// This file was auto-generated.  Do not edit

@datatype class TempSensor_i_tcproc_tempSensor_Bridge(
  val id: Art.BridgeId,
  val name: String,
  ...
  val initialization_api : TempSensor_i_Initialization_Api = {
    ...
    TempSensor_i_tcproc_tempSensor_Bridge.c_initialization_api = Some(api)
    api
  }
  ...
  val operational_api : TempSensor_i_Operational_Api = {
    ...
    TempSensor_i_tcproc_tempSensor_Bridge.c_operational_api = Some(api)
    api
  }

  val entryPoints : Bridge.EntryPoints =
    TempSensor_i_tcproc_tempSensor_Bridge.EntryPoints(
      id,
...
object TempSensor_i_tcproc_tempSensor_Bridge {
  ...
  @datatype class EntryPoints(
    TempSensor_i_tcproc_tempSensor_BridgeId : Art.BridgeId,
