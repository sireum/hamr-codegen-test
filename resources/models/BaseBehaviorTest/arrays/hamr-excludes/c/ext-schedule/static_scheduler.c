...
__attribute__((weak)) art_scheduling_static_Schedule_DScheduleSpec a_Schedulers_defaultStaticSchedule(STACK_FRAME_ONLY);
...
void a_ScheduleProviderI_getStaticSchedule(STACK_FRAME art_scheduling_static_Schedule_DScheduleSpec result){
  ...
  if(a_Schedulers_defaultStaticSchedule) {
    ...
    art_scheduling_static_Schedule_DScheduleSpec schedule = a_Schedulers_defaultStaticSchedule(SF_LAST);
