...
@record class Gen_ArraysArray_of_Coordinates(param: RandomLibI) extends MJen[Arrays.Array_of_Coordinates] {
  override def generate(f: Arrays.Array_of_Coordinates => Jen.Action): Jen.Action = {
    ...
    while (T) {
      ...
      continue = f(param.nextArraysArray_of_Coordinates())
...
@record class Gen_ArraysArray_of_Coordinates_Payload(param: RandomLibI) extends MJen[Arrays.Array_of_Coordinates_Payload] {
  override def generate(f: Arrays.Array_of_Coordinates_Payload => Jen.Action): Jen.Action = {
    var continue = Jen.Continue
    while (T) {
...
@record class Gen_ArraysArray_of_Integers(param: RandomLibI) extends MJen[Arrays.Array_of_Integers] {
  override def generate(f: Arrays.Array_of_Integers => Jen.Action): Jen.Action = {
    var continue = Jen.Continue
    while (T) {

      continue = f(param.nextArraysArray_of_Integers())
...
@record class Gen_ArraysArray_of_Integers_Payload(param: RandomLibI) extends MJen[Arrays.Array_of_Integers_Payload] {
  override def generate(f: Arrays.Array_of_Integers_Payload => Jen.Action): Jen.Action = {
    var continue = Jen.Continue
    while (T) {

      continue = f(param.nextArraysArray_of_Integers_Payload())
...
@record class Gen_ArraysCoordinate_Impl(param: RandomLibI) extends MJen[Arrays.Coordinate_Impl] {
  override def generate(f: Arrays.Coordinate_Impl => Jen.Action): Jen.Action = {
    var continue = Jen.Continue
    while (T) {

      continue = f(param.nextArraysCoordinate_Impl())
...
@record class Gen_ArraysCoordinate_Impl_Payload(param: RandomLibI) extends MJen[Arrays.Coordinate_Impl_Payload] {
  override def generate(f: Arrays.Coordinate_Impl_Payload => Jen.Action): Jen.Action = {
    var continue = Jen.Continue
    while (T) {
...
@record class Gen_ArraysVector_of_Coordinates(param: RandomLibI) extends MJen[Arrays.Vector_of_Coordinates] {
  override def generate(f: Arrays.Vector_of_Coordinates => Jen.Action): Jen.Action = {
    var continue = Jen.Continue
    while (T) {

      continue = f(param.nextArraysVector_of_Coordinates())
...
@record class Gen_ArraysVector_of_Coordinates_Payload(param: RandomLibI) extends MJen[Arrays.Vector_of_Coordinates_Payload] {
  override def generate(f: Arrays.Vector_of_Coordinates_Payload => Jen.Action): Jen.Action = {
    var continue = Jen.Continue
    while (T) {

      continue = f(param.nextArraysVector_of_Coordinates_Payload())
