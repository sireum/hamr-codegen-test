...
@datatype class Config_ArraysArray_of_Integers_Payload(attempts: Z, verbose: B, filter: Arrays.Array_of_Integers_Payload => B) {}
...
@datatype class Config_ArraysVector_of_Coordinates_Payload(attempts: Z, verbose: B, filter: Arrays.Vector_of_Coordinates_Payload => B) {}
