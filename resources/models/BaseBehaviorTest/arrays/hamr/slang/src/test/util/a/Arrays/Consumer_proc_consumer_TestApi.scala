...
@msig trait Consumer_proc_consumer_TestApi {
  ...
  def put_coordinates(value : Arrays.Array_of_Coordinates): Unit = {
    Art.insertInInfrastructurePort(Arch.PC_Sys_Impl_Instance_proc_consumer.operational_api.coordinates_Id, Arrays.Array_of_Coordinates_Payload(value))
  }

  // setter for in EventDataPort
  def put_vector_of_coordinates(value : Arrays.Vector_of_Coordinates): Unit = {
    Art.insertInInfrastructurePort(Arch.PC_Sys_Impl_Instance_proc_consumer.operational_api.vector_of_coordinates_Id, Arrays.Vector_of_Coordinates_Payload(value))
  }

  // setter for in EventDataPort
  def put_integers(value : Arrays.Array_of_Integers): Unit = {
    Art.insertInInfrastructurePort(Arch.PC_Sys_Impl_Instance_proc_consumer.operational_api.integers_Id, Arrays.Array_of_Integers_Payload(value))
  }
