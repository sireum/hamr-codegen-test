...
@msig trait RandomLibI {
  ...
  def next_artDataContent(): art.DataContent = {
    var callEnum: ISZ[_artDataContent_DataTypeId.Type] = ISZ(_artDataContent_DataTypeId.ArraysArray_of_Coordinates_Payload_Id, _artDataContent_DataTypeId.ArraysArray_of_Integers_Payload_Id, _artDataContent_DataTypeId.ArraysCoordinate_Impl_Payload_Id, _artDataContent_DataTypeId.ArraysVector_of_Coordinates_Payload_Id, _artDataContent_DataTypeId.Base_TypesBits_Payload_Id, _artDataContent_DataTypeId.Base_TypesBoolean_Payload_Id, _artDataContent_DataTypeId.Base_TypesCharacter_Payload_Id, _artDataContent_DataTypeId.Base_TypesFloat_32_Payload_Id, _artDataContent_DataTypeId.Base_TypesFloat_64_Payload_Id, _artDataContent_DataTypeId.Base_TypesFloat_Payload_Id, _artDataContent_DataTypeId.Base_TypesInteger_16_Payload_Id, _artDataContent_DataTypeId.Base_TypesInteger_32_Payload_Id, _artDataContent_DataTypeId.Base_TypesInteger_64_Payload_Id, _artDataContent_DataTypeId.Base_TypesInteger_8_Payload_Id, _artDataContent_DataTypeId.Base_TypesInteger_Payload_Id, _artDataContent_DataTypeId.Base_TypesString_Payload_Id, _artDataContent_DataTypeId.Base_TypesUnsigned_16_Payload_Id, _artDataContent_DataTypeId.Base_TypesUnsigned_32_Payload_Id, _artDataContent_DataTypeId.Base_TypesUnsigned_64_Payload_Id, _artDataContent_DataTypeId.Base_TypesUnsigned_8_Payload_Id, _artDataContent_DataTypeId._artEmpty_Id)
    ...
    var v: art.DataContent = c match {
      case _artDataContent_DataTypeId.ArraysArray_of_Coordinates_Payload_Id => (nextArraysArray_of_Coordinates_Payload _).apply()
      case _artDataContent_DataTypeId.ArraysArray_of_Integers_Payload_Id => (nextArraysArray_of_Integers_Payload _).apply()
      case _artDataContent_DataTypeId.ArraysCoordinate_Impl_Payload_Id => (nextArraysCoordinate_Impl_Payload _).apply()
      case _artDataContent_DataTypeId.ArraysVector_of_Coordinates_Payload_Id => (nextArraysVector_of_Coordinates_Payload _).apply()
  ...
  def set_Config_ArraysArray_of_Coordinates(config: Config_ArraysArray_of_Coordinates): Unit

  def nextArraysArray_of_Coordinates(): Arrays.Array_of_Coordinates = {
    var value: IS[Arrays.Array_of_Coordinates.I, Arrays.Coordinate_Impl] = nextISArraysArray_of_CoordinatesIArraysCoordinate_Impl()

    var v: Arrays.Array_of_Coordinates = Arrays.Array_of_Coordinates(value)

    if(get_Config_ArraysArray_of_Coordinates.attempts >= 0) {
     for(i <- 0 to get_Config_ArraysArray_of_Coordinates.attempts) {
        if(get_Config_ArraysArray_of_Coordinates.filter(v)) {
          return v
        }
        if (get_Config_ArraysArray_of_Coordinates.verbose) {
          println(s"Retrying for failing value: $v")
        }
        value = nextISArraysArray_of_CoordinatesIArraysCoordinate_Impl()
        v = Arrays.Array_of_Coordinates(value)
     }
    } else {
     while(T) {
       if(get_Config_ArraysArray_of_Coordinates.filter(v)) {
  ...
  // ============= Arrays.Array_of_Coordinates_Payload ===================

  def get_Config_ArraysArray_of_Coordinates_Payload: Config_ArraysArray_of_Coordinates_Payload
  def set_Config_ArraysArray_of_Coordinates_Payload(config: Config_ArraysArray_of_Coordinates_Payload): Unit

  def nextArraysArray_of_Coordinates_Payload(): Arrays.Array_of_Coordinates_Payload = {
    var value: Arrays.Array_of_Coordinates = nextArraysArray_of_Coordinates()

    var v: Arrays.Array_of_Coordinates_Payload = Arrays.Array_of_Coordinates_Payload(value)

    if(get_Config_ArraysArray_of_Coordinates_Payload.attempts >= 0) {
     for(i <- 0 to get_Config_ArraysArray_of_Coordinates_Payload.attempts) {
        if(get_Config_ArraysArray_of_Coordinates_Payload.filter(v)) {
          return v
        }
        if (get_Config_ArraysArray_of_Coordinates_Payload.verbose) {
          println(s"Retrying for failing value: $v")
        }
  ...
  // ============= Arrays.Array_of_Integers ===================

  def get_Config_ArraysArray_of_Integers: Config_ArraysArray_of_Integers
  def set_Config_ArraysArray_of_Integers(config: Config_ArraysArray_of_Integers): Unit

  def nextArraysArray_of_Integers(): Arrays.Array_of_Integers = {
    var value: IS[Arrays.Array_of_Integers.I, Z] = nextISArraysArray_of_IntegersIZ()

    var v: Arrays.Array_of_Integers = Arrays.Array_of_Integers(value)

    if(get_Config_ArraysArray_of_Integers.attempts >= 0) {
     for(i <- 0 to get_Config_ArraysArray_of_Integers.attempts) {
        if(get_Config_ArraysArray_of_Integers.filter(v)) {
          return v
        }
        if (get_Config_ArraysArray_of_Integers.verbose) {
          println(s"Retrying for failing value: $v")
        }
        value = nextISArraysArray_of_IntegersIZ()
        v = Arrays.Array_of_Integers(value)
     }
    } else {
     while(T) {
       if(get_Config_ArraysArray_of_Integers.filter(v)) {
  ...
  def get_Config_ArraysArray_of_Integers_Payload: Config_ArraysArray_of_Integers_Payload
  def set_Config_ArraysArray_of_Integers_Payload(config: Config_ArraysArray_of_Integers_Payload): Unit

  def nextArraysArray_of_Integers_Payload(): Arrays.Array_of_Integers_Payload = {
    var value: Arrays.Array_of_Integers = nextArraysArray_of_Integers()

    var v: Arrays.Array_of_Integers_Payload = Arrays.Array_of_Integers_Payload(value)

    if(get_Config_ArraysArray_of_Integers_Payload.attempts >= 0) {
     for(i <- 0 to get_Config_ArraysArray_of_Integers_Payload.attempts) {
        if(get_Config_ArraysArray_of_Integers_Payload.filter(v)) {
          return v
        }
        if (get_Config_ArraysArray_of_Integers_Payload.verbose) {
          println(s"Retrying for failing value: $v")
        }
        value = nextArraysArray_of_Integers()
        v = Arrays.Array_of_Integers_Payload(value)
     }
    } else {
     while(T) {
       if(get_Config_ArraysArray_of_Integers_Payload.filter(v)) {
  ...
  // ============= Arrays.Coordinate_Impl ===================

  def get_Config_ArraysCoordinate_Impl: Config_ArraysCoordinate_Impl
  def set_Config_ArraysCoordinate_Impl(config: Config_ArraysCoordinate_Impl): Unit

  def nextArraysCoordinate_Impl(): Arrays.Coordinate_Impl = {
    var latitude: S32 = nextS32()
    var longitude: S32 = nextS32()
    var altitude: S32 = nextS32()

    var v: Arrays.Coordinate_Impl = Arrays.Coordinate_Impl(latitude, longitude, altitude)

    if(get_Config_ArraysCoordinate_Impl.attempts >= 0) {
     for(i <- 0 to get_Config_ArraysCoordinate_Impl.attempts) {
        if(get_Config_ArraysCoordinate_Impl.filter(v)) {
          return v
        }
        if (get_Config_ArraysCoordinate_Impl.verbose) {
          println(s"Retrying for failing value: $v")
        }
        latitude = nextS32()
        longitude = nextS32()
        altitude = nextS32()
        v = Arrays.Coordinate_Impl(latitude, longitude, altitude)
     }
    } else {
     while(T) {
       if(get_Config_ArraysCoordinate_Impl.filter(v)) {
  ...
  def get_Config_ArraysCoordinate_Impl_Payload: Config_ArraysCoordinate_Impl_Payload
  def set_Config_ArraysCoordinate_Impl_Payload(config: Config_ArraysCoordinate_Impl_Payload): Unit

  def nextArraysCoordinate_Impl_Payload(): Arrays.Coordinate_Impl_Payload = {
    var value: Arrays.Coordinate_Impl = nextArraysCoordinate_Impl()

    var v: Arrays.Coordinate_Impl_Payload = Arrays.Coordinate_Impl_Payload(value)

    if(get_Config_ArraysCoordinate_Impl_Payload.attempts >= 0) {
     for(i <- 0 to get_Config_ArraysCoordinate_Impl_Payload.attempts) {
        if(get_Config_ArraysCoordinate_Impl_Payload.filter(v)) {
          return v
        }
        if (get_Config_ArraysCoordinate_Impl_Payload.verbose) {
          println(s"Retrying for failing value: $v")
        }
  ...
  // ============= Arrays.Vector_of_Coordinates ===================

  def get_Config_ArraysVector_of_Coordinates: Config_ArraysVector_of_Coordinates
  def set_Config_ArraysVector_of_Coordinates(config: Config_ArraysVector_of_Coordinates): Unit

  def nextArraysVector_of_Coordinates(): Arrays.Vector_of_Coordinates = {
    var value: ISZ[Z] = nextISZZ()

    var v: Arrays.Vector_of_Coordinates = Arrays.Vector_of_Coordinates(value)

    if(get_Config_ArraysVector_of_Coordinates.attempts >= 0) {
     for(i <- 0 to get_Config_ArraysVector_of_Coordinates.attempts) {
        if(get_Config_ArraysVector_of_Coordinates.filter(v)) {
          return v
        }
        if (get_Config_ArraysVector_of_Coordinates.verbose) {
          println(s"Retrying for failing value: $v")
        }
        value = nextISZZ()
        v = Arrays.Vector_of_Coordinates(value)
     }
    } else {
     while(T) {
       if(get_Config_ArraysVector_of_Coordinates.filter(v)) {
  ...
  // ============= Arrays.Vector_of_Coordinates_Payload ===================

  def get_Config_ArraysVector_of_Coordinates_Payload: Config_ArraysVector_of_Coordinates_Payload
  def set_Config_ArraysVector_of_Coordinates_Payload(config: Config_ArraysVector_of_Coordinates_Payload): Unit

  def nextArraysVector_of_Coordinates_Payload(): Arrays.Vector_of_Coordinates_Payload = {
    var value: Arrays.Vector_of_Coordinates = nextArraysVector_of_Coordinates()

    var v: Arrays.Vector_of_Coordinates_Payload = Arrays.Vector_of_Coordinates_Payload(value)

    if(get_Config_ArraysVector_of_Coordinates_Payload.attempts >= 0) {
     for(i <- 0 to get_Config_ArraysVector_of_Coordinates_Payload.attempts) {
        if(get_Config_ArraysVector_of_Coordinates_Payload.filter(v)) {
          return v
        }
        if (get_Config_ArraysVector_of_Coordinates_Payload.verbose) {
          println(s"Retrying for failing value: $v")
        }
        value = nextArraysVector_of_Coordinates()
        v = Arrays.Vector_of_Coordinates_Payload(value)
     }
    } else {
     while(T) {
       if(get_Config_ArraysVector_of_Coordinates_Payload.filter(v)) {
...
@record class RandomLib(val gen: org.sireum.Random.Gen) extends RandomLibI {
  ...
  var config_ArraysArray_of_Coordinates: Config_ArraysArray_of_Coordinates = Config_ArraysArray_of_Coordinates(100, _verbose, alwaysTrue_ArraysArray_of_Coordinates _)

  def get_Config_ArraysArray_of_Coordinates: Config_ArraysArray_of_Coordinates = {return config_ArraysArray_of_Coordinates}

  def set_Config_ArraysArray_of_Coordinates(config: Config_ArraysArray_of_Coordinates): Unit ={
    config_ArraysArray_of_Coordinates = config
  }

  // ============= Arrays.Array_of_Coordinates_Payload ===================
  def alwaysTrue_ArraysArray_of_Coordinates_Payload(v: Arrays.Array_of_Coordinates_Payload): B = {return T}

  var config_ArraysArray_of_Coordinates_Payload: Config_ArraysArray_of_Coordinates_Payload = Config_ArraysArray_of_Coordinates_Payload(100, _verbose, alwaysTrue_ArraysArray_of_Coordinates_Payload _)

  def get_Config_ArraysArray_of_Coordinates_Payload: Config_ArraysArray_of_Coordinates_Payload = {return config_ArraysArray_of_Coordinates_Payload}
  ...
  // ============= Arrays.Array_of_Integers ===================
  def alwaysTrue_ArraysArray_of_Integers(v: Arrays.Array_of_Integers): B = {return T}

  var config_ArraysArray_of_Integers: Config_ArraysArray_of_Integers = Config_ArraysArray_of_Integers(100, _verbose, alwaysTrue_ArraysArray_of_Integers _)

  def get_Config_ArraysArray_of_Integers: Config_ArraysArray_of_Integers = {return config_ArraysArray_of_Integers}

  def set_Config_ArraysArray_of_Integers(config: Config_ArraysArray_of_Integers): Unit ={
    config_ArraysArray_of_Integers = config
  }

  // ============= Arrays.Array_of_Integers_Payload ===================
  def alwaysTrue_ArraysArray_of_Integers_Payload(v: Arrays.Array_of_Integers_Payload): B = {return T}

  var config_ArraysArray_of_Integers_Payload: Config_ArraysArray_of_Integers_Payload = Config_ArraysArray_of_Integers_Payload(100, _verbose, alwaysTrue_ArraysArray_of_Integers_Payload _)

  def get_Config_ArraysArray_of_Integers_Payload: Config_ArraysArray_of_Integers_Payload = {return config_ArraysArray_of_Integers_Payload}

  def set_Config_ArraysArray_of_Integers_Payload(config: Config_ArraysArray_of_Integers_Payload): Unit ={
    config_ArraysArray_of_Integers_Payload = config
  }

  // ============= Arrays.Coordinate_Impl ===================
  def alwaysTrue_ArraysCoordinate_Impl(v: Arrays.Coordinate_Impl): B = {return T}

  var config_ArraysCoordinate_Impl: Config_ArraysCoordinate_Impl = Config_ArraysCoordinate_Impl(100, _verbose, alwaysTrue_ArraysCoordinate_Impl _)

  def get_Config_ArraysCoordinate_Impl: Config_ArraysCoordinate_Impl = {return config_ArraysCoordinate_Impl}

  def set_Config_ArraysCoordinate_Impl(config: Config_ArraysCoordinate_Impl): Unit ={
    config_ArraysCoordinate_Impl = config
  }

  // ============= Arrays.Coordinate_Impl_Payload ===================
  def alwaysTrue_ArraysCoordinate_Impl_Payload(v: Arrays.Coordinate_Impl_Payload): B = {return T}

  var config_ArraysCoordinate_Impl_Payload: Config_ArraysCoordinate_Impl_Payload = Config_ArraysCoordinate_Impl_Payload(100, _verbose, alwaysTrue_ArraysCoordinate_Impl_Payload _)

  def get_Config_ArraysCoordinate_Impl_Payload: Config_ArraysCoordinate_Impl_Payload = {return config_ArraysCoordinate_Impl_Payload}
  ...
  // ============= Arrays.Vector_of_Coordinates ===================
  def alwaysTrue_ArraysVector_of_Coordinates(v: Arrays.Vector_of_Coordinates): B = {return T}

  var config_ArraysVector_of_Coordinates: Config_ArraysVector_of_Coordinates = Config_ArraysVector_of_Coordinates(100, _verbose, alwaysTrue_ArraysVector_of_Coordinates _)

  def get_Config_ArraysVector_of_Coordinates: Config_ArraysVector_of_Coordinates = {return config_ArraysVector_of_Coordinates}

  def set_Config_ArraysVector_of_Coordinates(config: Config_ArraysVector_of_Coordinates): Unit ={
    config_ArraysVector_of_Coordinates = config
  }

  // ============= Arrays.Vector_of_Coordinates_Payload ===================
  def alwaysTrue_ArraysVector_of_Coordinates_Payload(v: Arrays.Vector_of_Coordinates_Payload): B = {return T}

  var config_ArraysVector_of_Coordinates_Payload: Config_ArraysVector_of_Coordinates_Payload = Config_ArraysVector_of_Coordinates_Payload(100, _verbose, alwaysTrue_ArraysVector_of_Coordinates_Payload _)

  def get_Config_ArraysVector_of_Coordinates_Payload: Config_ArraysVector_of_Coordinates_Payload = {return config_ArraysVector_of_Coordinates_Payload}

  def set_Config_ArraysVector_of_Coordinates_Payload(config: Config_ArraysVector_of_Coordinates_Payload): Unit ={
    config_ArraysVector_of_Coordinates_Payload = config
  }
