...
object Schedulers {
  ...
  val threadNickNames: Map[String, Art.BridgeId] = Map(
    ISZ(
      Arch.PC_Sys_Impl_Instance_proc_producer.name ~> Arch.PC_Sys_Impl_Instance_proc_producer.id,
      Arch.PC_Sys_Impl_Instance_proc_consumer.name ~> Arch.PC_Sys_Impl_Instance_proc_consumer.id)
  )
  ...
  val defaultDomainToBridgeIdMap: ISZ[Art.BridgeId] = ISZ(
    /* domain 0 */ Arch.PC_Sys_Impl_Instance_proc_producer.id,
    /* domain 1 */ Arch.PC_Sys_Impl_Instance_proc_consumer.id
  )
