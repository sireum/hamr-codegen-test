...
object Arch {
  val PC_Sys_Impl_Instance_proc_producer : a.Arrays.Producer_proc_producer_Bridge = {
    val coordinates = Port[Arrays.Array_of_Coordinates] (id = 0, name = "PC_Sys_Impl_Instance_proc_producer_coordinates", mode = EventOut)
    val vector_of_coordinates = Port[Arrays.Vector_of_Coordinates] (id = 1, name = "PC_Sys_Impl_Instance_proc_producer_vector_of_coordinates", mode = EventOut)
    val integers = Port[Arrays.Array_of_Integers] (id = 2, name = "PC_Sys_Impl_Instance_proc_producer_integers", mode = EventOut)
  ...
  val PC_Sys_Impl_Instance_proc_consumer : a.Arrays.Consumer_proc_consumer_Bridge = {
    val coordinates = Port[Arrays.Array_of_Coordinates] (id = 3, name = "PC_Sys_Impl_Instance_proc_consumer_coordinates", mode = EventIn)
    val vector_of_coordinates = Port[Arrays.Vector_of_Coordinates] (id = 4, name = "PC_Sys_Impl_Instance_proc_consumer_vector_of_coordinates", mode = EventIn)
    val integers = Port[Arrays.Array_of_Integers] (id = 5, name = "PC_Sys_Impl_Instance_proc_consumer_integers", mode = EventIn)
  ...
  val ad : ArchitectureDescription = {
    ...
    ArchitectureDescription(
      components = ISZ (PC_Sys_Impl_Instance_proc_producer, PC_Sys_Impl_Instance_proc_consumer),

      connections = ISZ (Connection(from = PC_Sys_Impl_Instance_proc_producer.coordinates, to = PC_Sys_Impl_Instance_proc_consumer.coordinates),
