...
@datatype class Config_BuildingControlFanAckType(attempts: Z, filter: BuildingControl.FanAck.Type => B) {}

@datatype class Config_BuildingControlFanAck_Payload(attempts: Z, filter: BuildingControl.FanAck_Payload => B) {}

@datatype class Config_BuildingControlFanCmdType(attempts: Z, filter: BuildingControl.FanCmd.Type => B) {}

@datatype class Config_BuildingControlFanCmd_Payload(attempts: Z, filter: BuildingControl.FanCmd_Payload => B) {}

@datatype class Config_BuildingControlSetPoint_impl(attempts: Z, filter: BuildingControl.SetPoint_impl => B) {}

@datatype class Config_BuildingControlSetPoint_impl_Payload(attempts: Z, filter: BuildingControl.SetPoint_impl_Payload => B) {}

@datatype class Config_BuildingControlTempUnitType(attempts: Z, filter: BuildingControl.TempUnit.Type => B) {}

@datatype class Config_BuildingControlTempUnit_Payload(attempts: Z, filter: BuildingControl.TempUnit_Payload => B) {}

@datatype class Config_BuildingControlTemperature_impl(attempts: Z, filter: BuildingControl.Temperature_impl => B) {}

@datatype class Config_BuildingControlTemperature_impl_Payload(attempts: Z, filter: BuildingControl.Temperature_impl_Payload => B) {}
