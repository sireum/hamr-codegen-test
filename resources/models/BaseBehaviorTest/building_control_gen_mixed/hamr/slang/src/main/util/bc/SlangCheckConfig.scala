...
@datatype class Config_BuildingControlSetPoint_impl(attempts: Z, verbose: B, filter: BuildingControl.SetPoint_impl => B) {}

@datatype class Config_BuildingControlSetPoint_impl_Payload(attempts: Z, verbose: B, filter: BuildingControl.SetPoint_impl_Payload => B) {}
...
@datatype class Config_BuildingControlTemperature_impl(attempts: Z, verbose: B, filter: BuildingControl.Temperature_impl => B) {}

@datatype class Config_BuildingControlTemperature_impl_Payload(attempts: Z, verbose: B, filter: BuildingControl.Temperature_impl_Payload => B) {}
