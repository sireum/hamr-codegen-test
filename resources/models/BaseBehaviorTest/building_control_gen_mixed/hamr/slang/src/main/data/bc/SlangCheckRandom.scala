...
@msig trait RandomLibI {
  ...
  def nextOptionBuildingControlFanAckType(): Option[BuildingControl.FanAck.Type] = {
    ...
    if(none == 0) {
      return Some(nextBuildingControlFanAckType())
    } else {
      return None()
    }
  }
  ...
  def nextISZBuildingControlFanAck_Payload(): ISZ[BuildingControl.FanAck_Payload] = {
     val length: Z = gen.nextZBetween(0, 256)
     var temp: ISZ[BuildingControl.FanAck_Payload] = ISZ()
     for (r <- 0 until length) {
       temp = temp :+ nextBuildingControlFanAck_Payload()
     }
  ...
  def nextOptionBuildingControlFanAck_Payload(): Option[BuildingControl.FanAck_Payload] = {
    val none: Z = gen.nextZBetween(0,1)

    if(none == 0) {
      return Some(nextBuildingControlFanAck_Payload())
    } else {
      return None()
    }
  }
  ...
  def nextOptionBuildingControlFanCmdType(): Option[BuildingControl.FanCmd.Type] = {
    ...
    if(none == 0) {
      return Some(nextBuildingControlFanCmdType())
    } else {
      return None()
    }
  }
  ...
  def nextISZBuildingControlFanCmd_Payload(): ISZ[BuildingControl.FanCmd_Payload] = {
     val length: Z = gen.nextZBetween(0, 256)
     var temp: ISZ[BuildingControl.FanCmd_Payload] = ISZ()
     for (r <- 0 until length) {
       temp = temp :+ nextBuildingControlFanCmd_Payload()
     }
  ...
  def nextOptionBuildingControlFanCmd_Payload(): Option[BuildingControl.FanCmd_Payload] = {
    val none: Z = gen.nextZBetween(0,1)

    if(none == 0) {
      return Some(nextBuildingControlFanCmd_Payload())
    } else {
      return None()
    }
  }
  ...
  def nextISZBuildingControlSetPoint_impl(): ISZ[BuildingControl.SetPoint_impl] = {
     val length: Z = gen.nextZBetween(0, 256)
     var temp: ISZ[BuildingControl.SetPoint_impl] = ISZ()
     for (r <- 0 until length) {
       temp = temp :+ nextBuildingControlSetPoint_impl()
     }
  ...
  def nextOptionBuildingControlSetPoint_impl(): Option[BuildingControl.SetPoint_impl] = {
    val none: Z = gen.nextZBetween(0,1)

    if(none == 0) {
      return Some(nextBuildingControlSetPoint_impl())
    } else {
      return None()
    }
  }
  ...
  def nextISZBuildingControlSetPoint_impl_Payload(): ISZ[BuildingControl.SetPoint_impl_Payload] = {
     val length: Z = gen.nextZBetween(0, 256)
     var temp: ISZ[BuildingControl.SetPoint_impl_Payload] = ISZ()
     for (r <- 0 until length) {
       temp = temp :+ nextBuildingControlSetPoint_impl_Payload()
     }
  ...
  def nextOptionBuildingControlSetPoint_impl_Payload(): Option[BuildingControl.SetPoint_impl_Payload] = {
    val none: Z = gen.nextZBetween(0,1)

    if(none == 0) {
      return Some(nextBuildingControlSetPoint_impl_Payload())
    } else {
      return None()
    }
  }
  ...
  def nextOptionBuildingControlTempUnitType(): Option[BuildingControl.TempUnit.Type] = {
    val none: Z = gen.nextZBetween(0,1)

    if(none == 0) {
      return Some(nextBuildingControlTempUnitType())
    } else {
      return None()
    }
  }
  ...
  def nextISZBuildingControlTempUnit_Payload(): ISZ[BuildingControl.TempUnit_Payload] = {
     val length: Z = gen.nextZBetween(0, 256)
     var temp: ISZ[BuildingControl.TempUnit_Payload] = ISZ()
     for (r <- 0 until length) {
       temp = temp :+ nextBuildingControlTempUnit_Payload()
     }
  ...
  def nextOptionBuildingControlTempUnit_Payload(): Option[BuildingControl.TempUnit_Payload] = {
    val none: Z = gen.nextZBetween(0,1)

    if(none == 0) {
      return Some(nextBuildingControlTempUnit_Payload())
    } else {
      return None()
    }
  }
  ...
  def nextISZBuildingControlTemperature_impl(): ISZ[BuildingControl.Temperature_impl] = {
     val length: Z = gen.nextZBetween(0, 256)
     var temp: ISZ[BuildingControl.Temperature_impl] = ISZ()
     for (r <- 0 until length) {
       temp = temp :+ nextBuildingControlTemperature_impl()
     }
  ...
  def nextOptionBuildingControlTemperature_impl(): Option[BuildingControl.Temperature_impl] = {
    val none: Z = gen.nextZBetween(0,1)

    if(none == 0) {
      return Some(nextBuildingControlTemperature_impl())
    } else {
      return None()
    }
  }
  ...
  def nextISZBuildingControlTemperature_impl_Payload(): ISZ[BuildingControl.Temperature_impl_Payload] = {
     val length: Z = gen.nextZBetween(0, 256)
     var temp: ISZ[BuildingControl.Temperature_impl_Payload] = ISZ()
     for (r <- 0 until length) {
       temp = temp :+ nextBuildingControlTemperature_impl_Payload()
     }
  ...
  def nextOptionBuildingControlTemperature_impl_Payload(): Option[BuildingControl.Temperature_impl_Payload] = {
    val none: Z = gen.nextZBetween(0,1)

    if(none == 0) {
      return Some(nextBuildingControlTemperature_impl_Payload())
    } else {
      return None()
    }
  }
...
@record class RandomLib(val gen: org.sireum.Random.Gen) extends RandomLibI {
  ...
  var config_BuildingControlFanAckType: Config_BuildingControlFanAckType = Config_BuildingControlFanAckType(100, alwaysTrue_BuildingControlFanAckType _)
  ...
  var config_BuildingControlFanAck_Payload: Config_BuildingControlFanAck_Payload = Config_BuildingControlFanAck_Payload(100, alwaysTrue_BuildingControlFanAck_Payload _)
  ...
  var config_BuildingControlFanCmdType: Config_BuildingControlFanCmdType = Config_BuildingControlFanCmdType(100, alwaysTrue_BuildingControlFanCmdType _)
  ...
  var config_BuildingControlFanCmd_Payload: Config_BuildingControlFanCmd_Payload = Config_BuildingControlFanCmd_Payload(100, alwaysTrue_BuildingControlFanCmd_Payload _)
  ...
  var config_BuildingControlSetPoint_impl: Config_BuildingControlSetPoint_impl = Config_BuildingControlSetPoint_impl(100, alwaysTrue_BuildingControlSetPoint_impl _)
  ...
  var config_BuildingControlSetPoint_impl_Payload: Config_BuildingControlSetPoint_impl_Payload = Config_BuildingControlSetPoint_impl_Payload(100, alwaysTrue_BuildingControlSetPoint_impl_Payload _)
  ...
  var config_BuildingControlTempUnitType: Config_BuildingControlTempUnitType = Config_BuildingControlTempUnitType(100, alwaysTrue_BuildingControlTempUnitType _)
  ...
  var config_BuildingControlTempUnit_Payload: Config_BuildingControlTempUnit_Payload = Config_BuildingControlTempUnit_Payload(100, alwaysTrue_BuildingControlTempUnit_Payload _)
  ...
  var config_BuildingControlTemperature_impl: Config_BuildingControlTemperature_impl = Config_BuildingControlTemperature_impl(100, alwaysTrue_BuildingControlTemperature_impl _)
  ...
  var config_BuildingControlTemperature_impl_Payload: Config_BuildingControlTemperature_impl_Payload = Config_BuildingControlTemperature_impl_Payload(100, alwaysTrue_BuildingControlTemperature_impl_Payload _)
