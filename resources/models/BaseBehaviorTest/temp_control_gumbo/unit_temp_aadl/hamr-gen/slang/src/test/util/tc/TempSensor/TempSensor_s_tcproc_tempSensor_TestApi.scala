...
abstract class TempSensor_s_tcproc_tempSensor_TestApi extends BridgeTestSuite[TempSensor_s_tcproc_tempSensor_Bridge](Arch.TempControlSoftwareSystem_s_Instance_tcproc_tempSensor) {
