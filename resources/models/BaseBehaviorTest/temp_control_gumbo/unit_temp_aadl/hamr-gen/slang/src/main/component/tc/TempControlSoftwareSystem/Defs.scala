...
object Defs {
  ...
  //==================================
  val initialTemp: Temperature_i = Temperature_i(85f, Unit.Fahrenheit)
  @spec def initialTemp_Inv = Invariant(
    initialTemp.degrees == 85.0F
  )

  val initialSetPoint: SetPoint_i = SetPoint_i(
    Temperature_i(55f, Unit.Fahrenheit),
    Temperature_i(100f, Unit.Fahrenheit))
  @spec def initialSetPoint_Inv = Invariant(
    // initialSetPoint == Temperature_i(55f) & initialSetPoint.high == Temperature_i(100f)
    initialSetPoint == SetPoint_i(Temperature_i(55f, Unit.Fahrenheit), Temperature_i(100f, Unit.Fahrenheit))
  )
