...
object OperatorInterface_s_tcproc_operatorInterface_DSC_UnitTests extends App {
  def main(args: ISZ[String]): Z = {
    val instance = new OperatorInterface_s_tcproc_operatorInterface_DSC_UnitTests()
    /*
    val c = instance.next()
...
class OperatorInterface_s_tcproc_operatorInterface_DSC_UnitTests extends OperatorInterface_s_tcproc_operatorInterface_GumboX_UnitTests
