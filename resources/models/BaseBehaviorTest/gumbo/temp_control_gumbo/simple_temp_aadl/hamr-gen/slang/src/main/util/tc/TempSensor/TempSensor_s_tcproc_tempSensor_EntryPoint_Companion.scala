...
object TempSensor_s_tcproc_tempSensor_EntryPoint_Companion {
  ...
  def post_initialise(): Unit = {
    ...
    tc.runtimemonitor.RuntimeMonitor.observeInitialisePostState(Arch.TempControlSoftwareSystem_s_Instance_tcproc_tempSensor.id, tc.runtimemonitor.ObservationKind.TempControlSoftwareSystem_s_Instance_tcproc_tempSensor_postInit, postStateContainer_wL)
  }
  ...
  def pre_compute(): Unit = {
    ...
    // the rest can now be performed via a different thread
    tc.runtimemonitor.RuntimeMonitor.observeComputePreState(Arch.TempControlSoftwareSystem_s_Instance_tcproc_tempSensor.id, tc.runtimemonitor.ObservationKind.TempControlSoftwareSystem_s_Instance_tcproc_tempSensor_preCompute, preStateContainer_wL.asInstanceOf[Option[art.DataContent]])
  }
  ...
  def post_compute(): Unit = {
    ...
    // the rest can now be performed via a different thread
    tc.runtimemonitor.RuntimeMonitor.observeComputePrePostState(Arch.TempControlSoftwareSystem_s_Instance_tcproc_tempSensor.id, tc.runtimemonitor.ObservationKind.TempControlSoftwareSystem_s_Instance_tcproc_tempSensor_postCompute, preStateContainer_wL.asInstanceOf[Option[art.DataContent]], postStateContainer_wL)
  }
}