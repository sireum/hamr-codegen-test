...
object TempControl_s_tcproc_tempControl_EntryPoint_Companion {
  ...
  def pre_compute(dispatchedEventPortId: Art.PortId): Unit = {
    ...
    // the rest can now be performed via a different thread
    tc.runtimemonitor.RuntimeMonitor.observeComputePreState(Arch.TempControlSoftwareSystem_s_Instance_tcproc_tempControl.id, tc.runtimemonitor.ObservationKind.TempControlSoftwareSystem_s_Instance_tcproc_tempControl_preCompute, preStateContainer_wL.asInstanceOf[Option[art.DataContent]])
  }
  ...
  def post_compute(): Unit = {
    ...
    // the rest can now be performed via a different thread
    tc.runtimemonitor.RuntimeMonitor.observeComputePrePostState(Arch.TempControlSoftwareSystem_s_Instance_tcproc_tempControl.id, tc.runtimemonitor.ObservationKind.TempControlSoftwareSystem_s_Instance_tcproc_tempControl_postCompute, preStateContainer_wL.asInstanceOf[Option[art.DataContent]], postStateContainer_wL)
  }
}