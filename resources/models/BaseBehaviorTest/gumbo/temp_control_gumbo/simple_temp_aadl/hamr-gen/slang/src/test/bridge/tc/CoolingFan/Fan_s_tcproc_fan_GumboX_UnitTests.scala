...
import tc.CoolingFan.Fan_s_tcproc_fan_UnitTestConfiguration_Util._

// This file will not be overwritten so is safe to edit

class Fan_s_tcproc_fan_GumboX_UnitTests extends Fan_s_tcproc_fan_GumboX_TestHarness_ScalaTest {
