...
object GumboXDispatcher {
  def checkContract(observationKind: ObservationKind.Type, preContainer: Option[art.DataContent], postContainer: Option[art.DataContent]): B = {
    observationKind match {
      case tc.runtimemonitor.ObservationKind.TempControlSoftwareSystem_s_Instance_tcproc_tempSensor_postInit =>
        ...
        return result
      case tc.runtimemonitor.ObservationKind.TempControlSoftwareSystem_s_Instance_tcproc_tempSensor_preCompute =>
        // checking the pre-state values of tempSensor's compute entrypoint is not required
        return T
      case tc.runtimemonitor.ObservationKind.TempControlSoftwareSystem_s_Instance_tcproc_tempSensor_postCompute =>
      ...
      case tc.runtimemonitor.ObservationKind.TempControlSoftwareSystem_s_Instance_tcproc_fan_postInit =>
        // checking the post-state values of fan's initialise entrypoint is not required
        return T
      case tc.runtimemonitor.ObservationKind.TempControlSoftwareSystem_s_Instance_tcproc_fan_preCompute =>
        // checking the pre-state values of fan's compute entrypoint is not required
        return T
      case tc.runtimemonitor.ObservationKind.TempControlSoftwareSystem_s_Instance_tcproc_fan_postCompute =>
        // checking the post-state values of fan's compute entrypoint is not required
        return T

      case tc.runtimemonitor.ObservationKind.TempControlSoftwareSystem_s_Instance_tcproc_tempControl_postInit =>
        ...
        return result
      case tc.runtimemonitor.ObservationKind.TempControlSoftwareSystem_s_Instance_tcproc_tempControl_preCompute =>
        ...
        return result
      case tc.runtimemonitor.ObservationKind.TempControlSoftwareSystem_s_Instance_tcproc_tempControl_postCompute =>
      ...
      case tc.runtimemonitor.ObservationKind.TempControlSoftwareSystem_s_Instance_tcproc_operatorInterface_postInit =>
        ...
        return result
      case tc.runtimemonitor.ObservationKind.TempControlSoftwareSystem_s_Instance_tcproc_operatorInterface_preCompute =>
        ...
        return result
      case tc.runtimemonitor.ObservationKind.TempControlSoftwareSystem_s_Instance_tcproc_operatorInterface_postCompute =>
  ...
  def genTestCase(observationKind: ObservationKind.Type, preContainer: Option[String], postContainer: Option[String], testNameSuffix: Option[String]): ST = {
    ...
    observationKind match {
      case tc.runtimemonitor.ObservationKind.TempControlSoftwareSystem_s_Instance_tcproc_tempSensor_postInit =>
        return (st"""// Begin test cases for TempControlSoftwareSystem_s_Instance_tcproc_tempSensor_postInit
                    |
                    |test(s"TempControlSoftwareSystem_s_Instance_tcproc_tempSensor_postInit: Check Post-condition$suffix") {
                    ...
                    |}
                    |// End test cases for TempControlSoftwareSystem_s_Instance_tcproc_tempSensor_postInit""")
      case tc.runtimemonitor.ObservationKind.TempControlSoftwareSystem_s_Instance_tcproc_tempSensor_postCompute =>
        return (st"""// Begin test cases for TempControlSoftwareSystem_s_Instance_tcproc_tempSensor_postCompute
                    |
                    |test(s"TempControlSoftwareSystem_s_Instance_tcproc_tempSensor_postCompute: Check Post-condition$suffix") {
                    ...
                    |}
                    |// End test cases for TempControlSoftwareSystem_s_Instance_tcproc_tempSensor_postCompute""")

      case tc.runtimemonitor.ObservationKind.TempControlSoftwareSystem_s_Instance_tcproc_tempControl_postInit =>
        return (st"""// Begin test cases for TempControlSoftwareSystem_s_Instance_tcproc_tempControl_postInit
                    |
                    |test(s"TempControlSoftwareSystem_s_Instance_tcproc_tempControl_postInit: Check Post-condition$suffix") {
                    |  val postJson: String = st${tq}${postContainer.get}${tq}.render
                    ...
                    |}
                    |// End test cases for TempControlSoftwareSystem_s_Instance_tcproc_tempControl_postInit""")
      case tc.runtimemonitor.ObservationKind.TempControlSoftwareSystem_s_Instance_tcproc_tempControl_preCompute =>
        return (st"""// Begin test cases for TempControlSoftwareSystem_s_Instance_tcproc_tempControl_preCompute
                    |
                    |test(s"TempControlSoftwareSystem_s_Instance_tcproc_tempControl_preCompute: Check Pre-condition$suffix") {
                    |  val preJson: String = st${tq}${preContainer.get}${tq}.render
                    ...
                    |}
                    |// End test cases for TempControlSoftwareSystem_s_Instance_tcproc_tempControl_preCompute""")
      case tc.runtimemonitor.ObservationKind.TempControlSoftwareSystem_s_Instance_tcproc_tempControl_postCompute =>
        return (st"""// Begin test cases for TempControlSoftwareSystem_s_Instance_tcproc_tempControl_postCompute
                    |
                    |test(s"TempControlSoftwareSystem_s_Instance_tcproc_tempControl_postCompute: Check Pre-condition$suffix") {
                    |  val preJson: String = st${tq}${preContainer.get}${tq}.render
                    |  val preContainer = tc.JSON.toTempControlSoftwareSystemTempControl_s_tcproc_tempControl_PreState_Container_PS(preJson).left
                    |  if (verbose) {
                    |    println("Pre-State Values:")
                    ...
                    |}
                    |
                    |test(s"TempControlSoftwareSystem_s_Instance_tcproc_tempControl_postCompute: Check Post-condition$suffix") {
                    |  val preJson: String = st${tq}${preContainer.get}${tq}.render
                    |  val postJson: String = st${tq}${postContainer.get}${tq}.render
                    |  val preContainer = tc.JSON.toTempControlSoftwareSystemTempControl_s_tcproc_tempControl_PreState_Container_PS(preJson).left
                    |  val postContainer = tc.JSON.toTempControlSoftwareSystemTempControl_s_tcproc_tempControl_PostState_Container_PS(postJson).left
                    ...
                    |}
                    |// End test cases for TempControlSoftwareSystem_s_Instance_tcproc_tempControl_postCompute""")
      case tc.runtimemonitor.ObservationKind.TempControlSoftwareSystem_s_Instance_tcproc_operatorInterface_postInit =>
        return (st"""// Begin test cases for TempControlSoftwareSystem_s_Instance_tcproc_operatorInterface_postInit
                    |
                    |test(s"TempControlSoftwareSystem_s_Instance_tcproc_operatorInterface_postInit: Check Post-condition$suffix") {
                    |  val postJson: String = st${tq}${postContainer.get}${tq}.render
                    ...
                    |}
                    |// End test cases for TempControlSoftwareSystem_s_Instance_tcproc_operatorInterface_postInit""")
      case tc.runtimemonitor.ObservationKind.TempControlSoftwareSystem_s_Instance_tcproc_operatorInterface_preCompute =>
        return (st"""// Begin test cases for TempControlSoftwareSystem_s_Instance_tcproc_operatorInterface_preCompute
                    |
                    |test(s"TempControlSoftwareSystem_s_Instance_tcproc_operatorInterface_preCompute: Check Pre-condition$suffix") {
                    |  val preJson: String = st${tq}${preContainer.get}${tq}.render
                    ...
                    |}
                    |// End test cases for TempControlSoftwareSystem_s_Instance_tcproc_operatorInterface_preCompute""")
      case tc.runtimemonitor.ObservationKind.TempControlSoftwareSystem_s_Instance_tcproc_operatorInterface_postCompute =>
        return (st"""// Begin test cases for TempControlSoftwareSystem_s_Instance_tcproc_operatorInterface_postCompute
                    |
                    |test(s"TempControlSoftwareSystem_s_Instance_tcproc_operatorInterface_postCompute: Check Pre-condition$suffix") {
                    |  val preJson: String = st${tq}${preContainer.get}${tq}.render
                    |  val preContainer = tc.JSON.toTempControlSoftwareSystemOperatorInterface_s_tcproc_operatorInterface_PreState_Container_PS(preJson).left
                    |  if (verbose) {
                    |    println("Pre-State Values:")
                    ...
                    |}
                    |
                    |test(s"TempControlSoftwareSystem_s_Instance_tcproc_operatorInterface_postCompute: Check Post-condition$suffix") {
                    |  val preJson: String = st${tq}${preContainer.get}${tq}.render
                    |  val postJson: String = st${tq}${postContainer.get}${tq}.render
                    |  val preContainer = tc.JSON.toTempControlSoftwareSystemOperatorInterface_s_tcproc_operatorInterface_PreState_Container_PS(preJson).left
                    |  val postContainer = tc.JSON.toTempControlSoftwareSystemOperatorInterface_s_tcproc_operatorInterface_PostState_Container_PS(postJson).left
                    ...
                    |}
                    |// End test cases for TempControlSoftwareSystem_s_Instance_tcproc_operatorInterface_postCompute""")
  ...
  def getUpdates(bridge_id: art.Art.BridgeId, observationKind: ObservationKind.Type, container: art.DataContent): Map[String, String] = {
    observationKind match {
      ...
      case tc.runtimemonitor.ObservationKind.TempControlSoftwareSystem_s_Instance_tcproc_fan_postInit =>
        var updates: Map[String, String] = Map.empty
        val postContainer = container.asInstanceOf[tc.CoolingFan.Fan_s_tcproc_fan_PostState_Container_PS]
      ...
      case tc.runtimemonitor.ObservationKind.TempControlSoftwareSystem_s_Instance_tcproc_operatorInterface_postInit =>
        ...
        if (postContainer.api_setPoint.nonEmpty) {
          updates = updates + s"${bridge_id}_Out_setPoint" ~> postContainer.api_setPoint.get.string
        }
        return updates
      case tc.runtimemonitor.ObservationKind.TempControlSoftwareSystem_s_Instance_tcproc_tempSensor_preCompute =>
        var updates: Map[String, String] = Map.empty
        val preContainer = container.asInstanceOf[tc.TempSensor.TempSensor_s_tcproc_tempSensor_PreState_Container_PS]
        return updates
      case tc.runtimemonitor.ObservationKind.TempControlSoftwareSystem_s_Instance_tcproc_fan_preCompute =>
        var updates: Map[String, String] = Map.empty
        val preContainer = container.asInstanceOf[tc.CoolingFan.Fan_s_tcproc_fan_PreState_Container_PS]
