...
@sig trait OperatorInterface_s_tcproc_operatorInterface_PreState_Container extends Container {
...
@sig trait OperatorInterface_s_tcproc_operatorInterface_PostState_Container extends Container {
