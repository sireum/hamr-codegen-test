...
@sig trait TempControlPeriodic_p_tcproc_tempControl_PreState_Container extends Container {
...
@sig trait TempControlPeriodic_p_tcproc_tempControl_PostState_Container extends Container {
