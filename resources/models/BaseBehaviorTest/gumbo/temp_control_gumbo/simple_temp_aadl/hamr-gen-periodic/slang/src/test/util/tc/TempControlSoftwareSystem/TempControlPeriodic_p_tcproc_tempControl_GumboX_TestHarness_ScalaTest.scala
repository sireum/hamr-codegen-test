...
abstract class TempControlPeriodic_p_tcproc_tempControl_GumboX_TestHarness_ScalaTest extends
  AnyFunSuite with OneInstancePerTest with BeforeAndAfterEach with
  TempControlPeriodic_p_tcproc_tempControl_GumboX_TestHarness {
