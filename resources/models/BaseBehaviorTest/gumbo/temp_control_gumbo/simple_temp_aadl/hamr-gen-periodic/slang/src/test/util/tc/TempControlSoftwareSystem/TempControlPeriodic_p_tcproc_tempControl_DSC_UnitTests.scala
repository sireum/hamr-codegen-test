...
object TempControlPeriodic_p_tcproc_tempControl_DSC_UnitTests extends App {
  def main(args: ISZ[String]): Z = {
    val instance = new TempControlPeriodic_p_tcproc_tempControl_DSC_UnitTests()
    /*
    val c = instance.next()
...
class TempControlPeriodic_p_tcproc_tempControl_DSC_UnitTests extends TempControlPeriodic_p_tcproc_tempControl_GumboX_UnitTests
