...
object JSON {
  ...
  object Printer {
    ...
    @pure def printruntimemonitorObservationKindType(o: runtimemonitor.ObservationKind.Type): ST = {
      val value: String = o match {
        case runtimemonitor.ObservationKind.TempControlSoftwareSystem_p_Instance_tcproc_tempSensor_postInit => "TempControlSoftwareSystem_p_Instance_tcproc_tempSensor_postInit"
        case runtimemonitor.ObservationKind.TempControlSoftwareSystem_p_Instance_tcproc_tempSensor_preCompute => "TempControlSoftwareSystem_p_Instance_tcproc_tempSensor_preCompute"
        case runtimemonitor.ObservationKind.TempControlSoftwareSystem_p_Instance_tcproc_tempSensor_postCompute => "TempControlSoftwareSystem_p_Instance_tcproc_tempSensor_postCompute"
        case runtimemonitor.ObservationKind.TempControlSoftwareSystem_p_Instance_tcproc_fan_postInit => "TempControlSoftwareSystem_p_Instance_tcproc_fan_postInit"
        case runtimemonitor.ObservationKind.TempControlSoftwareSystem_p_Instance_tcproc_fan_preCompute => "TempControlSoftwareSystem_p_Instance_tcproc_fan_preCompute"
        case runtimemonitor.ObservationKind.TempControlSoftwareSystem_p_Instance_tcproc_fan_postCompute => "TempControlSoftwareSystem_p_Instance_tcproc_fan_postCompute"
        case runtimemonitor.ObservationKind.TempControlSoftwareSystem_p_Instance_tcproc_tempControl_postInit => "TempControlSoftwareSystem_p_Instance_tcproc_tempControl_postInit"
        case runtimemonitor.ObservationKind.TempControlSoftwareSystem_p_Instance_tcproc_tempControl_preCompute => "TempControlSoftwareSystem_p_Instance_tcproc_tempControl_preCompute"
        case runtimemonitor.ObservationKind.TempControlSoftwareSystem_p_Instance_tcproc_tempControl_postCompute => "TempControlSoftwareSystem_p_Instance_tcproc_tempControl_postCompute"
        case runtimemonitor.ObservationKind.TempControlSoftwareSystem_p_Instance_tcproc_operatorInterface_postInit => "TempControlSoftwareSystem_p_Instance_tcproc_operatorInterface_postInit"
        case runtimemonitor.ObservationKind.TempControlSoftwareSystem_p_Instance_tcproc_operatorInterface_preCompute => "TempControlSoftwareSystem_p_Instance_tcproc_operatorInterface_preCompute"
        case runtimemonitor.ObservationKind.TempControlSoftwareSystem_p_Instance_tcproc_operatorInterface_postCompute => "TempControlSoftwareSystem_p_Instance_tcproc_operatorInterface_postCompute"
      }
      return printObject(ISZ(
