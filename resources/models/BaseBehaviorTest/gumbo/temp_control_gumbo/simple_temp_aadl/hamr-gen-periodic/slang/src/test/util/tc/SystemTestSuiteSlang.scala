...
import tc.SystemTestSuiteSlang._
import tc.runtimemonitor.{GumboXDispatcher, ObservationKind, RuntimeMonitor, RuntimeMonitorListener}
...
@msig trait SystemTestSuiteSlang extends RuntimeMonitorListener {
  ...
  override def init(modelInfo: tc.runtimemonitor.ModelInfo): Unit = {
  }
  ...
  override def observeComputePreState(bridgeId: art.Art.BridgeId, observationKind: tc.runtimemonitor.ObservationKind.Type, pre: Option[art.DataContent]): Unit = {
