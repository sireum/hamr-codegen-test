...
abstract class TempControlPeriodic_i_tcproc_tempControl_TestApi extends BridgeTestSuite[TempControlPeriodic_i_tcproc_tempControl_Bridge](Arch.TempControlSoftwareSystem_p_Instance_tcproc_tempControl) {
  ...
  /** helper function to check TempControlPeriodic_i_tcproc_tempControl's
