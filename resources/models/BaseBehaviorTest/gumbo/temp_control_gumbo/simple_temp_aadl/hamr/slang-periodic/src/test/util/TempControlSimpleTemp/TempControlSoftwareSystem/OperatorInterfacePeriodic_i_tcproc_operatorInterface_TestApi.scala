...
abstract class OperatorInterfacePeriodic_i_tcproc_operatorInterface_TestApi extends BridgeTestSuite[OperatorInterfacePeriodic_i_tcproc_operatorInterface_Bridge](Arch.TempControlSoftwareSystem_p_Instance_tcproc_operatorInterface) {
  ...
  /** helper function to check OperatorInterfacePeriodic_i_tcproc_operatorInterface's
