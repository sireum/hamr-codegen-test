...
@msig trait TempControl_s_tcproc_tempControl_TestApi {
  ...
  def put_fanAck(value : CoolingFan.FanAck.Type): Unit = {
    Art.insertInInfrastructurePort(Arch.TempControlSoftwareSystem_s_Instance_tcproc_tempControl.operational_api.fanAck_Id, CoolingFan.FanAck_Payload(value))
  }

  // setter for in EventDataPort
  def put_setPoint(value : TempControlSoftwareSystem.SetPoint_i): Unit = {
    Art.insertInInfrastructurePort(Arch.TempControlSoftwareSystem_s_Instance_tcproc_tempControl.operational_api.setPoint_Id, TempControlSoftwareSystem.SetPoint_i_Payload(value))
  }

  // setter for in EventPort
  def put_tempChanged(): Unit = {
    Art.insertInInfrastructurePort(Arch.TempControlSoftwareSystem_s_Instance_tcproc_tempControl.operational_api.tempChanged_Id, art.Empty())
  }
  ...
  def get_fanCmd_payload(): Option[CoolingFan.FanCmd_Payload] = {
    return Art.observeOutInfrastructurePort(Arch.TempControlSoftwareSystem_s_Instance_tcproc_tempControl.initialization_api.fanCmd_Id).asInstanceOf[Option[CoolingFan.FanCmd_Payload]]
  }
