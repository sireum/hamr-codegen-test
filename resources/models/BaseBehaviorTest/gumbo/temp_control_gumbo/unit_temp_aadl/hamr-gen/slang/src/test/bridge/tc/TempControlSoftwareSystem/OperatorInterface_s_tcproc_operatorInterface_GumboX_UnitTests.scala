...
import tc.TempControlSoftwareSystem.OperatorInterface_s_tcproc_operatorInterface_UnitTestConfiguration_Util._

// This file will not be overwritten so is safe to edit

class OperatorInterface_s_tcproc_operatorInterface_GumboX_UnitTests extends OperatorInterface_s_tcproc_operatorInterface_GumboX_TestHarness_ScalaTest {
