...
object TempSensor_s_tcproc_tempSensor_DSC_UnitTests extends App {
  def main(args: ISZ[String]): Z = {
    val instance = new TempSensor_s_tcproc_tempSensor_DSC_UnitTests()
    /*
    val c = instance.next()
...
class TempSensor_s_tcproc_tempSensor_DSC_UnitTests extends TempSensor_s_tcproc_tempSensor_GumboX_UnitTests
