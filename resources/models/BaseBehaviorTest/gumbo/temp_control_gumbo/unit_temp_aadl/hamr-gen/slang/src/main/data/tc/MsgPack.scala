...
object MsgPack {
  ...
  object Constants {
    ...
    val TempSensorTempSensor_s_tcproc_tempSensor_DSC_TestVector: Z = -9

    val TempControlSoftwareSystemOperatorInterface_s_tcproc_operatorInterface_DSC_TestVector: Z = -8
