...
object MsgPack {
  ...
  object Constants {
    ...
    val TempSensorTempSensor_s_tcproc_tempSensor_SlangCheckContainer: Z = -9

    val TempControlSoftwareSystemOperatorInterface_s_tcproc_operatorInterface_SlangCheckContainer: Z = -8
