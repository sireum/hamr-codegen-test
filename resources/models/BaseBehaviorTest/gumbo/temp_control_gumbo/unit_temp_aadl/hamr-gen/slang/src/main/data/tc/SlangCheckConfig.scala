...
@datatype class Config_TempControlSoftwareSystemOperatorInterface_s_tcproc_operatorInterface_DSC_TestVector(attempts: Z, filter: TempControlSoftwareSystem.OperatorInterface_s_tcproc_operatorInterface_DSC_TestVector => B) {}
...
@datatype class Config_TempSensorTempSensor_s_tcproc_tempSensor_DSC_TestVector(attempts: Z, filter: TempSensor.TempSensor_s_tcproc_tempSensor_DSC_TestVector => B) {}
...
@datatype class Config_TempSensorUnitType(attempts: Z, filter: TempSensor.Unit.Type => B) {}

@datatype class Config_TempSensorUnit_Payload(attempts: Z, filter: TempSensor.Unit_Payload => B) {}
