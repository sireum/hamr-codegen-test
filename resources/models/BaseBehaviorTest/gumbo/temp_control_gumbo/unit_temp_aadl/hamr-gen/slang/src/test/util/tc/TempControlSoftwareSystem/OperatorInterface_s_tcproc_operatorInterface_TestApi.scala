...
@msig trait OperatorInterface_s_tcproc_operatorInterface_TestApi {
  ...
  def put_tempChanged(): Unit = {
    Art.insertInInfrastructurePort(Arch.TempControlSoftwareSystem_s_Instance_tcproc_operatorInterface.operational_api.tempChanged_Id, art.Empty())
  }
  ...
  def get_setPoint_payload(): Option[TempControlSoftwareSystem.SetPoint_i_Payload] = {
    return Art.observeOutInfrastructurePort(Arch.TempControlSoftwareSystem_s_Instance_tcproc_operatorInterface.initialization_api.setPoint_Id).asInstanceOf[Option[TempControlSoftwareSystem.SetPoint_i_Payload]]
  }
