...
abstract class OperatorInterface_s_tcproc_operatorInterface_TestApi extends BridgeTestSuite[OperatorInterface_s_tcproc_operatorInterface_Bridge](Arch.TempControlSoftwareSystem_s_Instance_tcproc_operatorInterface) {
