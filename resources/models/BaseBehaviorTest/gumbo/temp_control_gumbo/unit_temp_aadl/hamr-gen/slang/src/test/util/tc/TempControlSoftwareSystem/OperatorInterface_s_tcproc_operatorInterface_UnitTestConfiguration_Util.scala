...
object OperatorInterface_s_tcproc_operatorInterface_UnitTestConfiguration_Util {
...
@record class OperatorInterface_s_tcproc_operatorInterface_Initialize_UnitTestConfiguration (
  var verbose: B,
  var name: String,
...
@record class OperatorInterface_s_tcproc_operatorInterface_Compute_UnitTestConfiguration (
  var verbose: B,
  var name: String,
  var description: String,
  var numTests: Z,
