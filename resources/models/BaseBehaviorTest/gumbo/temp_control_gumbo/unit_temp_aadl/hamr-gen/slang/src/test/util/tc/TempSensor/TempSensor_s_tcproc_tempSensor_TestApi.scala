...
@msig trait TempSensor_s_tcproc_tempSensor_TestApi {
  ...
  def get_currentTemp_payload(): Option[TempSensor.Temperature_i_Payload] = {
    return Art.observeOutInfrastructurePort(Arch.TempControlSoftwareSystem_s_Instance_tcproc_tempSensor.initialization_api.currentTemp_Id).asInstanceOf[Option[TempSensor.Temperature_i_Payload]]
  }
  ...
  def get_tempChanged_payload(): Option[art.Empty] = {
    return Art.observeOutInfrastructurePort(Arch.TempControlSoftwareSystem_s_Instance_tcproc_tempSensor.initialization_api.tempChanged_Id).asInstanceOf[Option[art.Empty]]
  }
