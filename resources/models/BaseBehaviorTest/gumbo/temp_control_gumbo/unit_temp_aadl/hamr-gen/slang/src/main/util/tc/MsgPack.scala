...
// This file is auto-generated from Unit.scala, Temperature_i.scala, FanCmd.scala, FanAck.scala, SetPoint_i.scala, Base_Types.scala, GUMBO__Library.scala, GUMBO__Library.scala, TempSensor_s_tcproc_tempSensor__Containers.scala, Fan_s_tcproc_fan__Containers.scala, TempControl_s_tcproc_tempControl__Containers.scala, OperatorInterface_s_tcproc_operatorInterface__Containers.scala, Container.scala, DataContent.scala, Aux_Types.scala
...
object MsgPack {
  ...
  object Constants {
    ...
    val TempSensorTempSensor_s_tcproc_tempSensor_PreState_Container_P: Z = -9

    val TempSensorTempSensor_s_tcproc_tempSensor_PreState_Container_PS: Z = -8

    val TempSensorTempSensor_s_tcproc_tempSensor_PostState_Container_P: Z = -7

    val TempSensorTempSensor_s_tcproc_tempSensor_PostState_Container_PS: Z = -6

    val CoolingFanFan_s_tcproc_fan_PreState_Container_P: Z = -5

    val CoolingFanFan_s_tcproc_fan_PreState_Container_PS: Z = -4

    val CoolingFanFan_s_tcproc_fan_PostState_Container_P: Z = -3

    val CoolingFanFan_s_tcproc_fan_PostState_Container_PS: Z = -2

    val TempControlSoftwareSystemTempControl_s_tcproc_tempControl_PreState_Container_P: Z = -1

    val TempControlSoftwareSystemTempControl_s_tcproc_tempControl_PreState_Container_PS: Z = 0

    val TempControlSoftwareSystemTempControl_s_tcproc_tempControl_PostState_Container_P: Z = 1

    val TempControlSoftwareSystemTempControl_s_tcproc_tempControl_PostState_Container_PS: Z = 2

    val TempControlSoftwareSystemOperatorInterface_s_tcproc_operatorInterface_PreState_Container_P: Z = 3

    val TempControlSoftwareSystemOperatorInterface_s_tcproc_operatorInterface_PreState_Container_PS: Z = 4

    val TempControlSoftwareSystemOperatorInterface_s_tcproc_operatorInterface_PostState_Container_P: Z = 5

    val TempControlSoftwareSystemOperatorInterface_s_tcproc_operatorInterface_PostState_Container_PS: Z = 6

    val utilEmptyContainer: Z = 7
