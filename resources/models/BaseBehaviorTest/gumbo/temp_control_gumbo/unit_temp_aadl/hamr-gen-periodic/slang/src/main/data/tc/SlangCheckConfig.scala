...
@datatype class Config_TempSensorUnitType(filter: TempSensor.Unit.Type => B) {}

@datatype class Config_TempSensorUnit_Payload(filter: TempSensor.Unit_Payload => B) {}

@datatype class Config_CoolingFanFanCmdType(filter: CoolingFan.FanCmd.Type => B) {}

@datatype class Config_CoolingFanFanAckType(filter: CoolingFan.FanAck.Type => B) {}

@datatype class Config_CoolingFanFanCmd_Payload(filter: CoolingFan.FanCmd_Payload => B) {}

@datatype class Config_CoolingFanFanAck_Payload(filter: CoolingFan.FanAck_Payload => B) {}

@datatype class Config_TempSensorTemperature_i(filter: TempSensor.Temperature_i => B) {}

@datatype class Config_TempSensorTemperature_i_Payload(filter: TempSensor.Temperature_i_Payload => B) {}

@datatype class Config_TempControlSoftwareSystemSetPoint_i(filter: TempControlSoftwareSystem.SetPoint_i => B) {}

@datatype class Config_TempControlSoftwareSystemSetPoint_i_Payload(filter: TempControlSoftwareSystem.SetPoint_i_Payload => B) {}
