...
object FanPeriodic_p_tcproc_fan_DSC_UnitTests extends App {
  def main(args: ISZ[String]): Z = {
    val instance = new FanPeriodic_p_tcproc_fan_DSC_UnitTests()
    /*
    val c = instance.next()
...
class FanPeriodic_p_tcproc_fan_DSC_UnitTests extends FanPeriodic_p_tcproc_fan_GumboX_UnitTests
