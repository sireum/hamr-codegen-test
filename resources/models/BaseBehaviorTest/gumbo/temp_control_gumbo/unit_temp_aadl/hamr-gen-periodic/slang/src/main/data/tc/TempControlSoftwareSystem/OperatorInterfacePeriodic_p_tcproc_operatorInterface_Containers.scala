...
@sig trait OperatorInterfacePeriodic_p_tcproc_operatorInterface_PreState_Container extends Container {
...
@sig trait OperatorInterfacePeriodic_p_tcproc_operatorInterface_PostState_Container extends Container {
