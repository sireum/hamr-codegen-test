...
abstract class OperatorInterfacePeriodic_p_tcproc_operatorInterface_GumboX_TestHarness_ScalaTest extends
  AnyFunSuite with OneInstancePerTest with BeforeAndAfterEach with
  OperatorInterfacePeriodic_p_tcproc_operatorInterface_GumboX_TestHarness {
