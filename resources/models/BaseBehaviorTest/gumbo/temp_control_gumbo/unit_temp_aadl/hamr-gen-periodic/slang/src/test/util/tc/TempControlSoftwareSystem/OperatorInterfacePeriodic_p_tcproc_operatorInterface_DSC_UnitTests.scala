...
object OperatorInterfacePeriodic_p_tcproc_operatorInterface_DSC_UnitTests extends App {
  def main(args: ISZ[String]): Z = {
    val instance = new OperatorInterfacePeriodic_p_tcproc_operatorInterface_DSC_UnitTests()
    /*
    val c = instance.next()
...
class OperatorInterfacePeriodic_p_tcproc_operatorInterface_DSC_UnitTests extends OperatorInterfacePeriodic_p_tcproc_operatorInterface_GumboX_UnitTests
