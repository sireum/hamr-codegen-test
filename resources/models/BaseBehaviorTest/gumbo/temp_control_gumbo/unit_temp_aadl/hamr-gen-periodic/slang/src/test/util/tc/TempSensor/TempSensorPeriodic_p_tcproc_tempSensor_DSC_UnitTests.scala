...
object TempSensorPeriodic_p_tcproc_tempSensor_DSC_UnitTests extends App {
  def main(args: ISZ[String]): Z = {
    val instance = new TempSensorPeriodic_p_tcproc_tempSensor_DSC_UnitTests()
    /*
    val c = instance.next()
...
class TempSensorPeriodic_p_tcproc_tempSensor_DSC_UnitTests extends TempSensorPeriodic_p_tcproc_tempSensor_GumboX_UnitTests
