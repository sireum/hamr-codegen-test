...
import tc.TempControlSoftwareSystem.OperatorInterfacePeriodic_p_tcproc_operatorInterface_UnitTestConfiguration_Util._

// This file will not be overwritten so is safe to edit

class OperatorInterfacePeriodic_p_tcproc_operatorInterface_GumboX_UnitTests extends OperatorInterfacePeriodic_p_tcproc_operatorInterface_GumboX_TestHarness_ScalaTest {
