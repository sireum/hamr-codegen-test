...
object MsgPack {
  ...
  object Constants {
    ...
    val TempSensorTempSensorPeriodic_p_tcproc_tempSensor_PreState_Container_P: Z = -9

    val TempSensorTempSensorPeriodic_p_tcproc_tempSensor_PreState_Container_PS: Z = -8

    val TempSensorTempSensorPeriodic_p_tcproc_tempSensor_PostState_Container_P: Z = -7

    val TempSensorTempSensorPeriodic_p_tcproc_tempSensor_PostState_Container_PS: Z = -6

    val CoolingFanFanPeriodic_p_tcproc_fan_PreState_Container_P: Z = -5

    val CoolingFanFanPeriodic_p_tcproc_fan_PreState_Container_PS: Z = -4

    val CoolingFanFanPeriodic_p_tcproc_fan_PostState_Container_P: Z = -3

    val CoolingFanFanPeriodic_p_tcproc_fan_PostState_Container_PS: Z = -2

    val TempControlSoftwareSystemTempControlPeriodic_p_tcproc_tempControl_PreState_Container_P: Z = -1

    val TempControlSoftwareSystemTempControlPeriodic_p_tcproc_tempControl_PreState_Container_PS: Z = 0

    val TempControlSoftwareSystemTempControlPeriodic_p_tcproc_tempControl_PostState_Container_P: Z = 1

    val TempControlSoftwareSystemTempControlPeriodic_p_tcproc_tempControl_PostState_Container_PS: Z = 2

    val TempControlSoftwareSystemOperatorInterfacePeriodic_p_tcproc_operatorInterface_PreState_Container_P: Z = 3

    val TempControlSoftwareSystemOperatorInterfacePeriodic_p_tcproc_operatorInterface_PreState_Container_PS: Z = 4

    val TempControlSoftwareSystemOperatorInterfacePeriodic_p_tcproc_operatorInterface_PostState_Container_P: Z = 5

    val TempControlSoftwareSystemOperatorInterfacePeriodic_p_tcproc_operatorInterface_PostState_Container_PS: Z = 6
