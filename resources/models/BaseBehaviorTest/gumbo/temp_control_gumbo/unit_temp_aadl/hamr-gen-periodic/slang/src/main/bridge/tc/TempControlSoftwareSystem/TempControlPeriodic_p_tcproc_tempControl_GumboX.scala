...
object TempControlPeriodic_p_tcproc_tempControl_GumboX {
  ...
  @strictpure def compute_CEP_T_Case (
      ...
      api_fanCmd: CoolingFan.FanCmd.Type): B =
    {
      val r0 = compute_case_currentTempLTSetPoint(latestFanCmd, api_currentTemp, api_setPoint, api_fanCmd)
      val r1 = compute_case_currentTempGTSetPoint(latestFanCmd, api_currentTemp, api_setPoint, api_fanCmd)
      val r2 = compute_case_currentTempInRange(In_latestFanCmd, latestFanCmd, api_currentTemp, api_setPoint, api_fanCmd)
