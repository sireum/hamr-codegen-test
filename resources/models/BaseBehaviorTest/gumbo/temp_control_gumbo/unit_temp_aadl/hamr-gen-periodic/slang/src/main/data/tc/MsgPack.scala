...
object MsgPack {
  ...
  object Constants {
    ...
    val TempSensorTempSensorPeriodic_p_tcproc_tempSensor_SlangCheckContainer: Z = -9

    val CoolingFanFanPeriodic_p_tcproc_fan_SlangCheckContainer: Z = -8

    val TempControlSoftwareSystemTempControlPeriodic_p_tcproc_tempControl_SlangCheckContainer: Z = -7

    val TempControlSoftwareSystemOperatorInterfacePeriodic_p_tcproc_operatorInterface_SlangCheckContainer: Z = -6
