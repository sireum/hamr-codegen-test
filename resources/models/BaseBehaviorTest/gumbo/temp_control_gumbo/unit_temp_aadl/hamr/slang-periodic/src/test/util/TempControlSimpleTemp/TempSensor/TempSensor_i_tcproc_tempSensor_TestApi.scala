...
abstract class TempSensor_i_tcproc_tempSensor_TestApi extends BridgeTestSuite[TempSensor_i_tcproc_tempSensor_Bridge](Arch.TempControlSoftwareSystem_p_Instance_tcproc_tempSensor) {
