...
object FanPeriodic_i_tcproc_fan {

  //=================================================
  //  I n i t i a l i z e    E n t r y    P o i n t
  //=================================================
  def initialise(api: FanPeriodic_i_Initialization_Api): Unit = {
  ...
  //=================================================
  def timeTriggered(api: FanPeriodic_i_Operational_Api): Unit = {
  ...
  def activate(api: FanPeriodic_i_Operational_Api): Unit = { }

  def deactivate(api: FanPeriodic_i_Operational_Api): Unit = { }

  def finalise(api: FanPeriodic_i_Operational_Api): Unit = { }

  def recover(api: FanPeriodic_i_Operational_Api): Unit = { }
}
