...
object Schedulers {
  ...
  val staticSchedule: DScheduleSpec = DScheduleSpec(0, 0, DSchedule(ISZ(
    Slot(Arch.s_i_Instance_p_producer.id, maxExecutionTime),
    Slot(Arch.s_i_Instance_p_filterp.id, maxExecutionTime),
    Slot(Arch.s_i_Instance_p_filters.id, maxExecutionTime),
    Slot(Arch.s_i_Instance_p_consumer.id, maxExecutionTime)
  )))
