...
// This file is auto-generated from ValueStatus.scala, TempWstatus_impl.scala, Regulator_Mode.scala, Temp_impl.scala, Status.scala, Failure_Flag_impl.scala, On_Off.scala, Monitor_Mode.scala, PhysicalTemp_impl.scala, Heat.scala, Base_Types.scala, Manage_Regulator_Interface_impl_thermostat_regulate_temperature_manage_regulator_interface_Containers.scala, Manage_Heat_Source_impl_thermostat_regulate_temperature_manage_heat_source_Containers.scala, Manage_Regulator_Mode_impl_thermostat_regulate_temperature_manage_regulator_mode_Containers.scala, Detect_Regulator_Failure_impl_thermostat_regulate_temperature_detect_regulator_failure_Containers.scala, Manage_Monitor_Interface_impl_thermostat_monitor_temperature_manage_monitor_interface_Containers.scala, Manage_Alarm_impl_thermostat_monitor_temperature_manage_alarm_Containers.scala, Manage_Monitor_Mode_impl_thermostat_monitor_temperature_manage_monitor_mode_Containers.scala, Detect_Monitor_Failure_impl_thermostat_monitor_temperature_detect_monitor_failure_Containers.scala, operator_interface_thread_impl_operator_interface_oip_oit_Containers.scala, Temperature_Sensor_impl_temperature_sensor_cpi_thermostat_Containers.scala, Heat_Source_impl_heat_source_cpi_heat_controller_Containers.scala, ObservationKind.scala, Container.scala, DataContent.scala, Aux_Types.scala
...
object MsgPack {
  ...
  object Constants {
    ...
    val Isolette_Data_ModelTempWstatus_impl: Z = -31

    val Isolette_Data_ModelTempWstatus_impl_Payload: Z = -30

    val Isolette_Data_ModelRegulator_Mode_Payload: Z = -29

    val Isolette_Data_ModelTemp_impl: Z = -28

    val Isolette_Data_ModelTemp_impl_Payload: Z = -27

    val Isolette_Data_ModelStatus_Payload: Z = -26

    val Isolette_Data_ModelFailure_Flag_impl: Z = -25

    val Isolette_Data_ModelFailure_Flag_impl_Payload: Z = -24

    val Isolette_Data_ModelOn_Off_Payload: Z = -23

    val Isolette_Data_ModelMonitor_Mode_Payload: Z = -22

    val Isolette_Data_ModelPhysicalTemp_impl: Z = -21

    val Isolette_Data_ModelPhysicalTemp_impl_Payload: Z = -20
    ...
    val RegulateManage_Regulator_Interface_impl_thermostat_regulate_temperature_manage_regulator_interface_PreState_Container_P: Z = -2

    val RegulateManage_Regulator_Interface_impl_thermostat_regulate_temperature_manage_regulator_interface_PreState_Container_PS: Z = -1

    val RegulateManage_Regulator_Interface_impl_thermostat_regulate_temperature_manage_regulator_interface_PostState_Container_P: Z = 0

    val RegulateManage_Regulator_Interface_impl_thermostat_regulate_temperature_manage_regulator_interface_PostState_Container_PS: Z = 1

    val RegulateManage_Heat_Source_impl_thermostat_regulate_temperature_manage_heat_source_PreState_Container_P: Z = 2

    val RegulateManage_Heat_Source_impl_thermostat_regulate_temperature_manage_heat_source_PreState_Container_PS: Z = 3

    val RegulateManage_Heat_Source_impl_thermostat_regulate_temperature_manage_heat_source_PostState_Container_P: Z = 4

    val RegulateManage_Heat_Source_impl_thermostat_regulate_temperature_manage_heat_source_PostState_Container_PS: Z = 5

    val RegulateManage_Regulator_Mode_impl_thermostat_regulate_temperature_manage_regulator_mode_PreState_Container_P: Z = 6

    val RegulateManage_Regulator_Mode_impl_thermostat_regulate_temperature_manage_regulator_mode_PreState_Container_PS: Z = 7

    val RegulateManage_Regulator_Mode_impl_thermostat_regulate_temperature_manage_regulator_mode_PostState_Container_P: Z = 8

    val RegulateManage_Regulator_Mode_impl_thermostat_regulate_temperature_manage_regulator_mode_PostState_Container_PS: Z = 9

    val RegulateDetect_Regulator_Failure_impl_thermostat_regulate_temperature_detect_regulator_failure_PreState_Container_P: Z = 10

    val RegulateDetect_Regulator_Failure_impl_thermostat_regulate_temperature_detect_regulator_failure_PreState_Container_PS: Z = 11

    val RegulateDetect_Regulator_Failure_impl_thermostat_regulate_temperature_detect_regulator_failure_PostState_Container_P: Z = 12

    val RegulateDetect_Regulator_Failure_impl_thermostat_regulate_temperature_detect_regulator_failure_PostState_Container_PS: Z = 13

    val MonitorManage_Monitor_Interface_impl_thermostat_monitor_temperature_manage_monitor_interface_PreState_Container_P: Z = 14

    val MonitorManage_Monitor_Interface_impl_thermostat_monitor_temperature_manage_monitor_interface_PreState_Container_PS: Z = 15

    val MonitorManage_Monitor_Interface_impl_thermostat_monitor_temperature_manage_monitor_interface_PostState_Container_P: Z = 16

    val MonitorManage_Monitor_Interface_impl_thermostat_monitor_temperature_manage_monitor_interface_PostState_Container_PS: Z = 17

    val MonitorManage_Alarm_impl_thermostat_monitor_temperature_manage_alarm_PreState_Container_P: Z = 18

    val MonitorManage_Alarm_impl_thermostat_monitor_temperature_manage_alarm_PreState_Container_PS: Z = 19

    val MonitorManage_Alarm_impl_thermostat_monitor_temperature_manage_alarm_PostState_Container_P: Z = 20

    val MonitorManage_Alarm_impl_thermostat_monitor_temperature_manage_alarm_PostState_Container_PS: Z = 21

    val MonitorManage_Monitor_Mode_impl_thermostat_monitor_temperature_manage_monitor_mode_PreState_Container_P: Z = 22

    val MonitorManage_Monitor_Mode_impl_thermostat_monitor_temperature_manage_monitor_mode_PreState_Container_PS: Z = 23

    val MonitorManage_Monitor_Mode_impl_thermostat_monitor_temperature_manage_monitor_mode_PostState_Container_P: Z = 24

    val MonitorManage_Monitor_Mode_impl_thermostat_monitor_temperature_manage_monitor_mode_PostState_Container_PS: Z = 25

    val MonitorDetect_Monitor_Failure_impl_thermostat_monitor_temperature_detect_monitor_failure_PreState_Container_P: Z = 26

    val MonitorDetect_Monitor_Failure_impl_thermostat_monitor_temperature_detect_monitor_failure_PreState_Container_PS: Z = 27

    val MonitorDetect_Monitor_Failure_impl_thermostat_monitor_temperature_detect_monitor_failure_PostState_Container_P: Z = 28

    val MonitorDetect_Monitor_Failure_impl_thermostat_monitor_temperature_detect_monitor_failure_PostState_Container_PS: Z = 29

    val Isoletteoperator_interface_thread_impl_operator_interface_oip_oit_PreState_Container_P: Z = 30

    val Isoletteoperator_interface_thread_impl_operator_interface_oip_oit_PreState_Container_PS: Z = 31

    val Isoletteoperator_interface_thread_impl_operator_interface_oip_oit_PostState_Container_P: Z = 32

    val Isoletteoperator_interface_thread_impl_operator_interface_oip_oit_PostState_Container_PS: Z = 33

    val DevicesTemperature_Sensor_impl_temperature_sensor_cpi_thermostat_PreState_Container_P: Z = 34

    val DevicesTemperature_Sensor_impl_temperature_sensor_cpi_thermostat_PreState_Container_PS: Z = 35

    val DevicesTemperature_Sensor_impl_temperature_sensor_cpi_thermostat_PostState_Container_P: Z = 36

    val DevicesTemperature_Sensor_impl_temperature_sensor_cpi_thermostat_PostState_Container_PS: Z = 37

    val DevicesHeat_Source_impl_heat_source_cpi_heat_controller_PreState_Container_P: Z = 38

    val DevicesHeat_Source_impl_heat_source_cpi_heat_controller_PreState_Container_PS: Z = 39

    val DevicesHeat_Source_impl_heat_source_cpi_heat_controller_PostState_Container_P: Z = 40

    val DevicesHeat_Source_impl_heat_source_cpi_heat_controller_PostState_Container_PS: Z = 41
