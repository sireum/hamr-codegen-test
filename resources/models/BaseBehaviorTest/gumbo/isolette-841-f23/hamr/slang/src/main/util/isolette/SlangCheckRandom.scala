...
@msig trait RandomLibI {
  ...
  def nextutilContainer(): util.Container = {
    ...
    var v: util.Container = c match {
      case utilContainer_DataTypeId.DevicesHeat_Source_impl_heat_source_cpi_heat_controller_PostState_Container_P_Id => (nextDevicesHeat_Source_impl_heat_source_cpi_heat_controller_PostState_Container_P _).apply()
      case utilContainer_DataTypeId.DevicesHeat_Source_impl_heat_source_cpi_heat_controller_PostState_Container_PS_Id => (nextDevicesHeat_Source_impl_heat_source_cpi_heat_controller_PostState_Container_PS _).apply()
      case utilContainer_DataTypeId.DevicesHeat_Source_impl_heat_source_cpi_heat_controller_PreState_Container_P_Id => (nextDevicesHeat_Source_impl_heat_source_cpi_heat_controller_PreState_Container_P _).apply()
      case utilContainer_DataTypeId.DevicesHeat_Source_impl_heat_source_cpi_heat_controller_PreState_Container_PS_Id => (nextDevicesHeat_Source_impl_heat_source_cpi_heat_controller_PreState_Container_PS _).apply()
      case utilContainer_DataTypeId.DevicesTemperature_Sensor_impl_temperature_sensor_cpi_thermostat_PostState_Container_P_Id => (nextDevicesTemperature_Sensor_impl_temperature_sensor_cpi_thermostat_PostState_Container_P _).apply()
      case utilContainer_DataTypeId.DevicesTemperature_Sensor_impl_temperature_sensor_cpi_thermostat_PostState_Container_PS_Id => (nextDevicesTemperature_Sensor_impl_temperature_sensor_cpi_thermostat_PostState_Container_PS _).apply()
      case utilContainer_DataTypeId.DevicesTemperature_Sensor_impl_temperature_sensor_cpi_thermostat_PreState_Container_P_Id => (nextDevicesTemperature_Sensor_impl_temperature_sensor_cpi_thermostat_PreState_Container_P _).apply()
      case utilContainer_DataTypeId.DevicesTemperature_Sensor_impl_temperature_sensor_cpi_thermostat_PreState_Container_PS_Id => (nextDevicesTemperature_Sensor_impl_temperature_sensor_cpi_thermostat_PreState_Container_PS _).apply()
      case utilContainer_DataTypeId.Isoletteoperator_interface_thread_impl_operator_interface_oip_oit_PostState_Container_P_Id => (nextIsoletteoperator_interface_thread_impl_operator_interface_oip_oit_PostState_Container_P _).apply()
      case utilContainer_DataTypeId.Isoletteoperator_interface_thread_impl_operator_interface_oip_oit_PostState_Container_PS_Id => (nextIsoletteoperator_interface_thread_impl_operator_interface_oip_oit_PostState_Container_PS _).apply()
      case utilContainer_DataTypeId.Isoletteoperator_interface_thread_impl_operator_interface_oip_oit_PreState_Container_P_Id => (nextIsoletteoperator_interface_thread_impl_operator_interface_oip_oit_PreState_Container_P _).apply()
      case utilContainer_DataTypeId.Isoletteoperator_interface_thread_impl_operator_interface_oip_oit_PreState_Container_PS_Id => (nextIsoletteoperator_interface_thread_impl_operator_interface_oip_oit_PreState_Container_PS _).apply()
      case utilContainer_DataTypeId.MonitorDetect_Monitor_Failure_impl_thermostat_monitor_temperature_detect_monitor_failure_PostState_Container_P_Id => (nextMonitorDetect_Monitor_Failure_impl_thermostat_monitor_temperature_detect_monitor_failure_PostState_Container_P _).apply()
      case utilContainer_DataTypeId.MonitorDetect_Monitor_Failure_impl_thermostat_monitor_temperature_detect_monitor_failure_PostState_Container_PS_Id => (nextMonitorDetect_Monitor_Failure_impl_thermostat_monitor_temperature_detect_monitor_failure_PostState_Container_PS _).apply()
      case utilContainer_DataTypeId.MonitorDetect_Monitor_Failure_impl_thermostat_monitor_temperature_detect_monitor_failure_PreState_Container_P_Id => (nextMonitorDetect_Monitor_Failure_impl_thermostat_monitor_temperature_detect_monitor_failure_PreState_Container_P _).apply()
      case utilContainer_DataTypeId.MonitorDetect_Monitor_Failure_impl_thermostat_monitor_temperature_detect_monitor_failure_PreState_Container_PS_Id => (nextMonitorDetect_Monitor_Failure_impl_thermostat_monitor_temperature_detect_monitor_failure_PreState_Container_PS _).apply()
      ...
      case utilContainer_DataTypeId.RegulateDetect_Regulator_Failure_impl_thermostat_regulate_temperature_detect_regulator_failure_PostState_Container_P_Id => (nextRegulateDetect_Regulator_Failure_impl_thermostat_regulate_temperature_detect_regulator_failure_PostState_Container_P _).apply()
      case utilContainer_DataTypeId.RegulateDetect_Regulator_Failure_impl_thermostat_regulate_temperature_detect_regulator_failure_PostState_Container_PS_Id => (nextRegulateDetect_Regulator_Failure_impl_thermostat_regulate_temperature_detect_regulator_failure_PostState_Container_PS _).apply()
      case utilContainer_DataTypeId.RegulateDetect_Regulator_Failure_impl_thermostat_regulate_temperature_detect_regulator_failure_PreState_Container_P_Id => (nextRegulateDetect_Regulator_Failure_impl_thermostat_regulate_temperature_detect_regulator_failure_PreState_Container_P _).apply()
      case utilContainer_DataTypeId.RegulateDetect_Regulator_Failure_impl_thermostat_regulate_temperature_detect_regulator_failure_PreState_Container_PS_Id => (nextRegulateDetect_Regulator_Failure_impl_thermostat_regulate_temperature_detect_regulator_failure_PreState_Container_PS _).apply()
