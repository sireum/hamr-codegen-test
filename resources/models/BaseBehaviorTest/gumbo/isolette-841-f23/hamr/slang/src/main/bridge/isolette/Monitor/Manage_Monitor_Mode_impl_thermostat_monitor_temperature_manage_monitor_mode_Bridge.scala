...
object Manage_Monitor_Mode_impl_thermostat_monitor_temperature_manage_monitor_mode_Bridge {
  ...
  @datatype class EntryPoints(
    ...
    def initialise(): Unit = {
      Manage_Monitor_Mode_impl_thermostat_monitor_temperature_manage_monitor_mode_EntryPoint_Companion.pre_initialise()

      // implement the following method in 'component':  def initialise(api: Manage_Monitor_Mode_impl_Initialization_Api): Unit = {}
      component.initialise(initialization_api)

      Manage_Monitor_Mode_impl_thermostat_monitor_temperature_manage_monitor_mode_EntryPoint_Companion.post_initialise()

      Art.sendOutput(eventOutPortIds, dataOutPortIds)
    }

    def compute(): Unit = {
      Manage_Monitor_Mode_impl_thermostat_monitor_temperature_manage_monitor_mode_Injection_Service.pre_receiveInput()

      Art.receiveInput(eventInPortIds, dataInPortIds)

      Manage_Monitor_Mode_impl_thermostat_monitor_temperature_manage_monitor_mode_EntryPoint_Companion.pre_compute()

      // implement the following in 'component':  def timeTriggered(api: Manage_Monitor_Mode_impl_Operational_Api): Unit = {}
      component.timeTriggered(operational_api)

      Manage_Monitor_Mode_impl_thermostat_monitor_temperature_manage_monitor_mode_EntryPoint_Companion.post_compute()
