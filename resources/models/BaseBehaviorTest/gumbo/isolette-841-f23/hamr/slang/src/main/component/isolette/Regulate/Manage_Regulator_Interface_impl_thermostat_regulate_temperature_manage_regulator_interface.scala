  ...
  def timeTriggered(api: Manage_Regulator_Interface_impl_Operational_Api): Unit = {
    Contract(
      ...
      Ensures(
        ...
        (api.regulator_mode == Isolette_Data_Model.Regulator_Mode.Normal_Regulator_Mode) ___>: (api.displayed_temp.value == Manage_Regulator_Interface_impl_thermostat_regulate_temperature_manage_regulator_interface.ROUND(api.current_tempWstatus.value)),
        // case REQ_MRI_5
        ...
        //   http://pub.santoslab.org/high-assurance/module-requirements/reading/FAA-DoT-Requirements-AR-08-32.pdf#page=108 
        (T) ___>: (!(api.interface_failure.value) __>:
