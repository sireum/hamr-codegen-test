...
import isolette.SystemTestSuiteSlang._
import isolette.runtimemonitor.{GumboXDispatcher, ObservationKind, RuntimeMonitor, RuntimeMonitorListener}
...
@msig trait SystemTestSuiteSlang extends RuntimeMonitorListener {
  ...
  override def init(modelInfo: isolette.runtimemonitor.ModelInfo): Unit = {
  }
  ...
  override def observeComputePreState(bridgeId: art.Art.BridgeId, observationKind: isolette.runtimemonitor.ObservationKind.Type, pre: Option[art.DataContent]): Unit = {
