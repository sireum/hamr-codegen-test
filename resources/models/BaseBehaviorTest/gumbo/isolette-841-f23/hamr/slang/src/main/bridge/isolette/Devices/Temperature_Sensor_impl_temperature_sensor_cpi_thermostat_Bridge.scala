...
object Temperature_Sensor_impl_temperature_sensor_cpi_thermostat_Bridge {
  ...
  @datatype class EntryPoints(
    ...
    def initialise(): Unit = {
      Temperature_Sensor_impl_temperature_sensor_cpi_thermostat_EntryPoint_Companion.pre_initialise()

      // implement the following method in 'component':  def initialise(api: Temperature_Sensor_impl_Initialization_Api): Unit = {}
      component.initialise(initialization_api)

      Temperature_Sensor_impl_temperature_sensor_cpi_thermostat_EntryPoint_Companion.post_initialise()

      Art.sendOutput(eventOutPortIds, dataOutPortIds)
    }

    def compute(): Unit = {
      Temperature_Sensor_impl_temperature_sensor_cpi_thermostat_Injection_Service.pre_receiveInput()

      Art.receiveInput(eventInPortIds, dataInPortIds)

      Temperature_Sensor_impl_temperature_sensor_cpi_thermostat_EntryPoint_Companion.pre_compute()

      // implement the following in 'component':  def timeTriggered(api: Temperature_Sensor_impl_Operational_Api): Unit = {}
      component.timeTriggered(operational_api)

      Temperature_Sensor_impl_temperature_sensor_cpi_thermostat_EntryPoint_Companion.post_compute()
