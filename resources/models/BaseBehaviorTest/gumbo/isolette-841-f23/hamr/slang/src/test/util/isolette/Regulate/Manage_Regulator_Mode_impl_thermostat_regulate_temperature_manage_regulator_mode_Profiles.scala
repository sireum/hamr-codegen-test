...
@msig trait Manage_Regulator_Mode_impl_thermostat_regulate_temperature_manage_regulator_mode_Profile_P_Trait extends Profile {
  ...
  def update_api_current_tempWstatus(v: RandomLib): Manage_Regulator_Mode_impl_thermostat_regulate_temperature_manage_regulator_mode_Profile_P_Trait
  def update_api_interface_failure(v: RandomLib): Manage_Regulator_Mode_impl_thermostat_regulate_temperature_manage_regulator_mode_Profile_P_Trait
  def update_api_internal_failure(v: RandomLib): Manage_Regulator_Mode_impl_thermostat_regulate_temperature_manage_regulator_mode_Profile_P_Trait
}
...
@record class Manage_Regulator_Mode_impl_thermostat_regulate_temperature_manage_regulator_mode_Profile_P(
  ...
  override def update_api_current_tempWstatus(v: RandomLib): Manage_Regulator_Mode_impl_thermostat_regulate_temperature_manage_regulator_mode_Profile_P_Trait = {
    return this(api_current_tempWstatus = v)
  }

  override def update_api_interface_failure(v: RandomLib): Manage_Regulator_Mode_impl_thermostat_regulate_temperature_manage_regulator_mode_Profile_P_Trait = {
    return this(api_interface_failure = v)
  }

  override def update_api_internal_failure(v: RandomLib): Manage_Regulator_Mode_impl_thermostat_regulate_temperature_manage_regulator_mode_Profile_P_Trait = {
...
@msig trait Manage_Regulator_Mode_impl_thermostat_regulate_temperature_manage_regulator_mode_Profile_PS_Trait extends Manage_Regulator_Mode_impl_thermostat_regulate_temperature_manage_regulator_mode_Profile_P_Trait {
  ...
  def update_In_lastRegulatorMode(v: RandomLib): Manage_Regulator_Mode_impl_thermostat_regulate_temperature_manage_regulator_mode_Profile_PS_Trait
  def update_api_current_tempWstatus(v: RandomLib): Manage_Regulator_Mode_impl_thermostat_regulate_temperature_manage_regulator_mode_Profile_PS_Trait
  def update_api_interface_failure(v: RandomLib): Manage_Regulator_Mode_impl_thermostat_regulate_temperature_manage_regulator_mode_Profile_PS_Trait
  def update_api_internal_failure(v: RandomLib): Manage_Regulator_Mode_impl_thermostat_regulate_temperature_manage_regulator_mode_Profile_PS_Trait
}
...
@record class Manage_Regulator_Mode_impl_thermostat_regulate_temperature_manage_regulator_mode_Profile_PS(
  ...
  override def update_In_lastRegulatorMode(v: RandomLib): Manage_Regulator_Mode_impl_thermostat_regulate_temperature_manage_regulator_mode_Profile_PS_Trait = {
    return this(In_lastRegulatorMode = v)
  }

  override def update_api_current_tempWstatus(v: RandomLib): Manage_Regulator_Mode_impl_thermostat_regulate_temperature_manage_regulator_mode_Profile_PS_Trait = {
    return this(api_current_tempWstatus = v)
  }

  override def update_api_interface_failure(v: RandomLib): Manage_Regulator_Mode_impl_thermostat_regulate_temperature_manage_regulator_mode_Profile_PS_Trait = {
    return this(api_interface_failure = v)
  }

  override def update_api_internal_failure(v: RandomLib): Manage_Regulator_Mode_impl_thermostat_regulate_temperature_manage_regulator_mode_Profile_PS_Trait = {
    return this(api_internal_failure = v)
  }
}
