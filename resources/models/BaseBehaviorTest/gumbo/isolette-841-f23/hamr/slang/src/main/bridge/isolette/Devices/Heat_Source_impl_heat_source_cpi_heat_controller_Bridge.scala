...
object Heat_Source_impl_heat_source_cpi_heat_controller_Bridge {
  ...
  @datatype class EntryPoints(
    ...
    def initialise(): Unit = {
      Heat_Source_impl_heat_source_cpi_heat_controller_EntryPoint_Companion.pre_initialise()

      // implement the following method in 'component':  def initialise(api: Heat_Source_impl_Initialization_Api): Unit = {}
      component.initialise(initialization_api)

      Heat_Source_impl_heat_source_cpi_heat_controller_EntryPoint_Companion.post_initialise()

      Art.sendOutput(eventOutPortIds, dataOutPortIds)
    }

    def compute(): Unit = {
      Heat_Source_impl_heat_source_cpi_heat_controller_Injection_Service.pre_receiveInput()

      Art.receiveInput(eventInPortIds, dataInPortIds)

      Heat_Source_impl_heat_source_cpi_heat_controller_EntryPoint_Companion.pre_compute()

      // implement the following in 'component':  def timeTriggered(api: Heat_Source_impl_Operational_Api): Unit = {}
      component.timeTriggered(operational_api)

      Heat_Source_impl_heat_source_cpi_heat_controller_EntryPoint_Companion.post_compute()
