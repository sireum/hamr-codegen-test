...
@sig trait Heat_Source_impl_heat_source_cpi_heat_controller_PreState_Container extends Container {
...
@sig trait Heat_Source_impl_heat_source_cpi_heat_controller_PostState_Container extends Container {
