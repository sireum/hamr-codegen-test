...
object Manage_Monitor_Interface_impl_thermostat_monitor_temperature_manage_monitor_interface_EntryPoint_Companion {

  var last_api_upper_alarm_temp: Option[Isolette_Data_Model.Temp_impl] = None()
  ...
  def get_api_upper_alarm_temp: Isolette_Data_Model.Temp_impl = {
    Art.observeOutPortVariable(Arch.isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_monitor_interface.operational_api.upper_alarm_temp_Id) match {
  ...
  var last_api_lower_alarm_temp: Option[Isolette_Data_Model.Temp_impl] = None()
  ...
  def get_api_lower_alarm_temp: Isolette_Data_Model.Temp_impl = {
    Art.observeOutPortVariable(Arch.isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_monitor_interface.operational_api.lower_alarm_temp_Id) match {
      case Some(Isolette_Data_Model.Temp_impl_Payload(value)) =>
  ...
  def get_api_monitor_status: Isolette_Data_Model.Status.Type = {
    Art.observeOutPortVariable(Arch.isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_monitor_interface.operational_api.monitor_status_Id) match {
  ...
  def get_api_interface_failure: Isolette_Data_Model.Failure_Flag_impl = {
    Art.observeOutPortVariable(Arch.isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_monitor_interface.operational_api.interface_failure_Id) match {
  ...
  var preStateContainer_wL: Option[Manage_Monitor_Interface_impl_thermostat_monitor_temperature_manage_monitor_interface_PreState_Container_PS] = None()
  ...
  def post_initialise(): Unit = {
    ...
    isolette.runtimemonitor.RuntimeMonitor.observeInitialisePostState(Arch.isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_monitor_interface.id, isolette.runtimemonitor.ObservationKind.isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_monitor_interface_postInit, postStateContainer_wL)
  }
  ...
  def pre_compute(): Unit = {
    ...
    preStateContainer_wL = Some(
      Manage_Monitor_Interface_impl_thermostat_monitor_temperature_manage_monitor_interface_PreState_Container_PS(
        ...
        api_upper_alarm_tempWstatus = Art.observeInPortVariable(Arch.isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_monitor_interface.operational_api.upper_alarm_tempWstatus_Id).get.asInstanceOf[Isolette_Data_Model.TempWstatus_impl_Payload].value))

    // the rest can now be performed via a different thread
    isolette.runtimemonitor.RuntimeMonitor.observeComputePreState(Arch.isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_monitor_interface.id, isolette.runtimemonitor.ObservationKind.isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_monitor_interface_preCompute, preStateContainer_wL.asInstanceOf[Option[art.DataContent]])
  }
  ...
  def post_compute(): Unit = {
    ...
    // the rest can now be performed via a different thread
    isolette.runtimemonitor.RuntimeMonitor.observeComputePrePostState(Arch.isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_monitor_interface.id, isolette.runtimemonitor.ObservationKind.isolette_single_sensor_Instance_thermostat_monitor_temperature_manage_monitor_interface_postCompute, preStateContainer_wL.asInstanceOf[Option[art.DataContent]], postStateContainer_wL)
  }
}