...
@msig trait Manage_Alarm_impl_thermostat_monitor_temperature_manage_alarm_Profile_P_Trait extends Profile {
  ...
  def update_api_current_tempWstatus(v: RandomLib): Manage_Alarm_impl_thermostat_monitor_temperature_manage_alarm_Profile_P_Trait
  def update_api_lower_alarm_temp(v: RandomLib): Manage_Alarm_impl_thermostat_monitor_temperature_manage_alarm_Profile_P_Trait
  def update_api_monitor_mode(v: RandomLib): Manage_Alarm_impl_thermostat_monitor_temperature_manage_alarm_Profile_P_Trait
  def update_api_upper_alarm_temp(v: RandomLib): Manage_Alarm_impl_thermostat_monitor_temperature_manage_alarm_Profile_P_Trait
}
...
@record class Manage_Alarm_impl_thermostat_monitor_temperature_manage_alarm_Profile_P(
  ...
  override def update_api_current_tempWstatus(v: RandomLib): Manage_Alarm_impl_thermostat_monitor_temperature_manage_alarm_Profile_P_Trait = {
    return this(api_current_tempWstatus = v)
  }

  override def update_api_lower_alarm_temp(v: RandomLib): Manage_Alarm_impl_thermostat_monitor_temperature_manage_alarm_Profile_P_Trait = {
    return this(api_lower_alarm_temp = v)
  }

  override def update_api_monitor_mode(v: RandomLib): Manage_Alarm_impl_thermostat_monitor_temperature_manage_alarm_Profile_P_Trait = {
    return this(api_monitor_mode = v)
  }

  override def update_api_upper_alarm_temp(v: RandomLib): Manage_Alarm_impl_thermostat_monitor_temperature_manage_alarm_Profile_P_Trait = {
...
@msig trait Manage_Alarm_impl_thermostat_monitor_temperature_manage_alarm_Profile_PS_Trait extends Manage_Alarm_impl_thermostat_monitor_temperature_manage_alarm_Profile_P_Trait {
  ...
  def update_In_lastCmd(v: RandomLib): Manage_Alarm_impl_thermostat_monitor_temperature_manage_alarm_Profile_PS_Trait
  def update_api_current_tempWstatus(v: RandomLib): Manage_Alarm_impl_thermostat_monitor_temperature_manage_alarm_Profile_PS_Trait
  def update_api_lower_alarm_temp(v: RandomLib): Manage_Alarm_impl_thermostat_monitor_temperature_manage_alarm_Profile_PS_Trait
  def update_api_monitor_mode(v: RandomLib): Manage_Alarm_impl_thermostat_monitor_temperature_manage_alarm_Profile_PS_Trait
  def update_api_upper_alarm_temp(v: RandomLib): Manage_Alarm_impl_thermostat_monitor_temperature_manage_alarm_Profile_PS_Trait
}
...
@record class Manage_Alarm_impl_thermostat_monitor_temperature_manage_alarm_Profile_PS(
  ...
  override def update_In_lastCmd(v: RandomLib): Manage_Alarm_impl_thermostat_monitor_temperature_manage_alarm_Profile_PS_Trait = {
    return this(In_lastCmd = v)
  }

  override def update_api_current_tempWstatus(v: RandomLib): Manage_Alarm_impl_thermostat_monitor_temperature_manage_alarm_Profile_PS_Trait = {
    return this(api_current_tempWstatus = v)
  }

  override def update_api_lower_alarm_temp(v: RandomLib): Manage_Alarm_impl_thermostat_monitor_temperature_manage_alarm_Profile_PS_Trait = {
    return this(api_lower_alarm_temp = v)
  }

  override def update_api_monitor_mode(v: RandomLib): Manage_Alarm_impl_thermostat_monitor_temperature_manage_alarm_Profile_PS_Trait = {
    return this(api_monitor_mode = v)
  }

  override def update_api_upper_alarm_temp(v: RandomLib): Manage_Alarm_impl_thermostat_monitor_temperature_manage_alarm_Profile_PS_Trait = {
    return this(api_upper_alarm_temp = v)
  }
}
