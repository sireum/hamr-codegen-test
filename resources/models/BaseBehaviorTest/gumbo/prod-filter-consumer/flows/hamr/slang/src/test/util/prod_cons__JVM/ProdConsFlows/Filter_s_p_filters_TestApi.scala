...
@msig trait Filter_s_p_filters_TestApi {
  ...
  def put_a_in(value : Base_Types.Float_32): Unit = {
    ArtNative.insertInInfrastructurePort(Arch.s_i_Instance_p_filters.operational_api.a_in_Id, Base_Types.Float_32_Payload(value))
  }

  // setter for in EventDataPort
  def put_b_in(value : Base_Types.Float_32): Unit = {
    ArtNative.insertInInfrastructurePort(Arch.s_i_Instance_p_filters.operational_api.b_in_Id, Base_Types.Float_32_Payload(value))
  }
  ...
  def get_a_out_payload(): Option[Base_Types.Float_32_Payload] = {
    return ArtNative.observeOutInfrastructurePort(Arch.s_i_Instance_p_filters.initialization_api.a_out_Id).asInstanceOf[Option[Base_Types.Float_32_Payload]]
  }
  ...
  def get_b_out_payload(): Option[Base_Types.Float_32_Payload] = {
    return ArtNative.observeOutInfrastructurePort(Arch.s_i_Instance_p_filters.initialization_api.b_out_Id).asInstanceOf[Option[Base_Types.Float_32_Payload]]
  }
