...
@datatype class Producer_p_producer_Bridge(
  ...
  a_data_out: Port[ProdConsFlows.Container_i],
  b_event_data_out: Port[ProdConsFlows.Container_i],
  c_event_data_out: Port[ProdConsFlows.Container_i],
  d_event_out: Port[art.Empty]
  ) extends Bridge {

  val ports : Bridge.Ports = Bridge.Ports(
    dataIns = ISZ[art.UPort](),

    dataOuts = ISZ[art.UPort](a_data_out),

    eventIns = ISZ[art.UPort](),

    eventOuts = ISZ[art.UPort](b_event_data_out,
                               c_event_data_out,
                               d_event_out)
  )
...
object Producer_p_producer_Bridge {
  ...
  @datatype class EntryPoints(
    ...
    a_data_out_Id : Art.PortId,
    b_event_data_out_Id : Art.PortId,
    c_event_data_out_Id : Art.PortId,
    d_event_out_Id : Art.PortId,
    ...
    val dataOutPortIds: ISZ[Art.PortId] = IS(a_data_out_Id)

    val eventOutPortIds: ISZ[Art.PortId] = IS(b_event_data_out_Id,
                                              c_event_data_out_Id,
                                              d_event_out_Id)
