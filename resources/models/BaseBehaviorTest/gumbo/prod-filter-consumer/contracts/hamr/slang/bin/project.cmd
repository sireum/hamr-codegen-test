...
//     sireum proyek run . prod_cons__JVM.Demo
//
//   To see the available CLI options:
//     sireum proyek run . prod_cons__JVM.Demo -h
//
//   To run the example unit tests from the command line:
//     sireum proyek test .
//
//   To build an executable jar:
//     sireum proyek assemble --uber --main prod_cons__JVM.Demo .
//
// Sireum IVE:
//
...
//     Right click src/main/architecture/prod_cons__JVM/Demo.scala and choose "Run 'Demo'"
//
