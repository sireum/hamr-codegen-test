...
@datatype class Config_ProdConsFlowsContainer_i(attempts: Z, filter: ProdConsFlows.Container_i => B) {}

@datatype class Config_ProdConsFlowsContainer_i_Payload(attempts: Z, filter: ProdConsFlows.Container_i_Payload => B) {}

@datatype class Config_ProdConsFlowsFilter_p_p_filterp_DSC_TestVector(attempts: Z, filter: ProdConsFlows.Filter_p_p_filterp_DSC_TestVector => B) {}

@datatype class Config_ProdConsFlowsProducer_p_producer_DSC_TestVector(attempts: Z, filter: ProdConsFlows.Producer_p_producer_DSC_TestVector => B) {}
