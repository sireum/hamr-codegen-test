...
class Producer_p_producer_GumboX_Tests extends Producer_p_producer_GumboX_TestHarness_ScalaTest {
  ...
  def getTestVector(): Option[Producer_p_producer_DSC_TestVector] = {
    try {
