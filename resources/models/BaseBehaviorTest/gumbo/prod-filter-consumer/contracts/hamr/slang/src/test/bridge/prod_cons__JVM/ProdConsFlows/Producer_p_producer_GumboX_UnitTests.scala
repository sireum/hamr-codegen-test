...
import prod_cons__JVM.ProdConsFlows.Producer_p_producer_UnitTestConfiguration_Util._

// This file will not be overwritten so is safe to edit

class Producer_p_producer_GumboX_UnitTests extends Producer_p_producer_GumboX_TestHarness_ScalaTest {
