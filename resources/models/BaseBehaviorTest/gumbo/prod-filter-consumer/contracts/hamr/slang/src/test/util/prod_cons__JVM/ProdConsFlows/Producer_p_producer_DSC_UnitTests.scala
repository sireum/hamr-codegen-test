...
object Producer_p_producer_DSC_UnitTests extends App {
  def main(args: ISZ[String]): Z = {
    val instance = new Producer_p_producer_DSC_UnitTests()
    /*
    val c = instance.next()
...
class Producer_p_producer_DSC_UnitTests extends Producer_p_producer_GumboX_UnitTests
