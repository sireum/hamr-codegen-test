...
@msig trait Filter_s_p_filters_TestApi {
  ...
  def put_a_data_in(value : ProdConsFlows.Container_i): Unit = {
    Art.insertInInfrastructurePort(Arch.s_i_Instance_p_filters.operational_api.a_data_in_Id, ProdConsFlows.Container_i_Payload(value))
  }

  // setter for in EventDataPort
  def put_b_event_data_in(value : ProdConsFlows.Container_i): Unit = {
    Art.insertInInfrastructurePort(Arch.s_i_Instance_p_filters.operational_api.b_event_data_in_Id, ProdConsFlows.Container_i_Payload(value))
  }

  // setter for in EventDataPort
  def put_c_event_data_in(value : ProdConsFlows.Container_i): Unit = {
    Art.insertInInfrastructurePort(Arch.s_i_Instance_p_filters.operational_api.c_event_data_in_Id, ProdConsFlows.Container_i_Payload(value))
  }

  // setter for in EventPort
  def put_d_event_in(): Unit = {
    Art.insertInInfrastructurePort(Arch.s_i_Instance_p_filters.operational_api.d_event_in_Id, art.Empty())
  }
  ...
  def get_e_data_out_payload(): Option[ProdConsFlows.Container_i_Payload] = {
    return Art.observeOutInfrastructurePort(Arch.s_i_Instance_p_filters.initialization_api.e_data_out_Id).asInstanceOf[Option[ProdConsFlows.Container_i_Payload]]
  }
  ...
  def get_f_event_data_out_payload(): Option[ProdConsFlows.Container_i_Payload] = {
    return Art.observeOutInfrastructurePort(Arch.s_i_Instance_p_filters.initialization_api.f_event_data_out_Id).asInstanceOf[Option[ProdConsFlows.Container_i_Payload]]
  }
  ...
  def get_g_event_data_out_payload(): Option[ProdConsFlows.Container_i_Payload] = {
    return Art.observeOutInfrastructurePort(Arch.s_i_Instance_p_filters.initialization_api.g_event_data_out_Id).asInstanceOf[Option[ProdConsFlows.Container_i_Payload]]
  }
  ...
  def get_h_event_out(): Option[art.Empty] = {
    val value: Option[art.Empty] = get_h_event_out_payload() match {
      ...
      case Some(v) => halt(s"Unexpected payload on port h_event_out.  Expecting 'art.Empty' but received ${v}")
  ...
  def get_h_event_out_payload(): Option[art.Empty] = {
    return Art.observeOutInfrastructurePort(Arch.s_i_Instance_p_filters.initialization_api.h_event_out_Id).asInstanceOf[Option[art.Empty]]
  }
