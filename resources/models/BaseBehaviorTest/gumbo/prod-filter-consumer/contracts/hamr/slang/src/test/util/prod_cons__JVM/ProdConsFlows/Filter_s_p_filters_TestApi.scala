...
@msig trait Filter_s_p_filters_TestApi {
  ...
  def put_a_data_in(value : ProdConsFlows.Container_i): Unit = {
    ArtNative.insertInPortValue(Arch.s_i_Instance_p_filters.operational_api.a_data_in_Id, ProdConsFlows.Container_i_Payload(value))
  }

  // setter for in EventDataPort
  def put_b_event_data_in(value : ProdConsFlows.Container_i): Unit = {
    ArtNative.insertInPortValue(Arch.s_i_Instance_p_filters.operational_api.b_event_data_in_Id, ProdConsFlows.Container_i_Payload(value))
  }

  // setter for in EventDataPort
  def put_c_event_data_in(value : ProdConsFlows.Container_i): Unit = {
    ArtNative.insertInPortValue(Arch.s_i_Instance_p_filters.operational_api.c_event_data_in_Id, ProdConsFlows.Container_i_Payload(value))
  }

  // setter for in EventPort
  def put_d_event_in(): Unit = {
    ArtNative.insertInPortValue(Arch.s_i_Instance_p_filters.operational_api.d_event_in_Id, Empty())
  }
  ...
  def get_e_data_out_payload(): Option[ProdConsFlows.Container_i_Payload] = {
    return ArtNative.observeOutPortValue(Arch.s_i_Instance_p_filters.initialization_api.e_data_out_Id).asInstanceOf[Option[ProdConsFlows.Container_i_Payload]]
  }
  ...
  def get_f_event_data_out_payload(): Option[ProdConsFlows.Container_i_Payload] = {
    return ArtNative.observeOutPortValue(Arch.s_i_Instance_p_filters.initialization_api.f_event_data_out_Id).asInstanceOf[Option[ProdConsFlows.Container_i_Payload]]
  }
  ...
  def get_g_event_data_out_payload(): Option[ProdConsFlows.Container_i_Payload] = {
    return ArtNative.observeOutPortValue(Arch.s_i_Instance_p_filters.initialization_api.g_event_data_out_Id).asInstanceOf[Option[ProdConsFlows.Container_i_Payload]]
  }
  ...
  def get_h_event_out_payload(): Option[Empty] = {
    return ArtNative.observeOutPortValue(Arch.s_i_Instance_p_filters.initialization_api.h_event_out_Id).asInstanceOf[Option[Empty]]
  }
