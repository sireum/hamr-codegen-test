...
@record class Filter_p_p_filterp_GumboX_DSC_TestRunner
  extends Random.Gen.TestRunner[Filter_p_p_filterp_PreState_Container_P]
  ...
  override def toCompactJson(o: Filter_p_p_filterp_PreState_Container_P): String = {
    return prod_cons__JVM.JSON.fromProdConsFlowsFilter_p_p_filterp_PreState_Container_P(o, T)
  }

  override def fromJson(json: String): Filter_p_p_filterp_PreState_Container_P = {
    prod_cons__JVM.JSON.toProdConsFlowsFilter_p_p_filterp_PreState_Container_P(json) match {
      case Either.Left(o) => return o
      case Either.Right(msg) => halt(msg.string)
    }
  }

  override def test(o: Filter_p_p_filterp_PreState_Container_P): B = {
    BeforeEntrypoint()
    val r: B = testComputeCBV(o) match {
      case GumboXResult.Pre_Condition_Unsat =>
        prod_cons__JVM.DSC_RecordUnsatPre.report(prod_cons__JVM.JSON.fromProdConsFlowsFilter_p_p_filterp_PreState_Container_P(o, T))
        T
