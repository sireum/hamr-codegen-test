...
object Filter_s_p_filters_DSC_UnitTests extends App {
  def main(args: ISZ[String]): Z = {
    val instance = new Filter_s_p_filters_DSC_UnitTests()
    /*
    val c = instance.next()
...
class Filter_s_p_filters_DSC_UnitTests extends Filter_s_p_filters_GumboX_UnitTests
