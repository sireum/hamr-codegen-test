...
proc"$sireum proyek slangcheck -p TempControlSimpleTemp -o ${Os.slashDir.up}/src/main/data/TempControlSimpleTemp ${Os.slashDir.up} $toolargs".at(Os.slashDir).console.runCheck()
