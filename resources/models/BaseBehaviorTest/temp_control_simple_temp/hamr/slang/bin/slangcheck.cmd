...
proc"$sireum tools slangcheck generator -p TempControlSimpleTemp -o ${Os.slashDir.up}/src/main/data/TempControlSimpleTemp $toolargs".at(Os.slashDir).console.runCheck()
