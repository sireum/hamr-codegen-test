...
@msig trait TempSensor_i_tcproc_tempSensor_GumboX_TestHarness extends TempSensor_i_tcproc_tempSensor_TestApi {
  ...
  def testComputeCBJ(json: String): GumboXResult.Type = {
    TempControlSimpleTemp.JSON.toTempSensorTempSensor_i_tcproc_tempSensor_PreState_Container(json) match {
      case Either.Left(o) => return testComputeCBV(o)
      case Either.Right(msg) => halt(msg.string)
    }
  }

  def testComputeCBV(o: TempSensor_i_tcproc_tempSensor_PreState_Container): GumboXResult.Type = {
