...
object TempSensor_i_tcproc_tempSensor_GumboX_TestHarness_ScalaTest_Generator {
  ...
  def serializeReport(dir: Os.Path): Unit = {
    val filename = dir / s"TempSensor_i_tcproc_tempSensor_GumboX_TestHarness_ScalaTest_Generator_${System.currentTimeMillis()}.json"
...
import TempSensor_i_tcproc_tempSensor_GumboX_TestHarness_ScalaTest_Generator._

trait TempSensor_i_tcproc_tempSensor_GumboX_TestHarness_ScalaTest_Generator extends TempSensor_i_tcproc_tempSensor_GumboX_TestHarness_ScalaTest
  ...
  def getInitialiseProfiles: MSZ[TempSensor_i_tcproc_tempSensor_Profile]

  def getDefaultInitialiseProfile: TempSensor_i_tcproc_tempSensor_Profile = {
    return TempSensor_i_tcproc_tempSensor_Profile (
      name = "Default Initialise Profile",
      numTests = 100)
  }

  def getProfiles_P: MSZ[TempSensor_i_tcproc_tempSensor_Profile_P]

  def getDefaultProfile_P: TempSensor_i_tcproc_tempSensor_Profile_P = {
    return TempSensor_i_tcproc_tempSensor_Profile_P (
      name = "Default Port Profile", 
      numTests = 100, 
      numTestVectorGenRetries = 100)
  }

  def next(profile: TempSensor_i_tcproc_tempSensor_Profile_P): Option[TempSensor_i_tcproc_tempSensor_PreState_Container_P] = {
    try {

      return Some(TempSensor_i_tcproc_tempSensor_PreState_Container_P())
    } catch {
  ...
  def testInitialiseCB_Profile(profile: TempSensor_i_tcproc_tempSensor_Profile): Unit = {
  ...
  def testComputeCB_Profile_P(profile: TempSensor_i_tcproc_tempSensor_Profile_P): Unit = {
    for (i <- 0 until profile.numTests) {
        ...
        while (j < profile.numTestVectorGenRetries && retry) {
          next(profile) match {
            case Some(o) =>
              ...
              val json = TempControlSimpleTemp.JSON.fromTempSensorTempSensor_i_tcproc_tempSensor_PreState_Container_P(o, T)
