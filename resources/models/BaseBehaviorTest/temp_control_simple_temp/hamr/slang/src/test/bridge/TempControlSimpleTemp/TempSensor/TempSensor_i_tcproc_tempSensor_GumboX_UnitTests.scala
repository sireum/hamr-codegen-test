...
import TempControlSimpleTemp.TempSensor.TempSensor_i_tcproc_tempSensor_UnitTestConfiguration_Util._

// This file will not be overwritten so is safe to edit

class TempSensor_i_tcproc_tempSensor_GumboX_UnitTests extends TempSensor_i_tcproc_tempSensor_GumboX_TestHarness_ScalaTest {
