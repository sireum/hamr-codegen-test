...
object TempControl_i_tcproc_tempControl_DSC_UnitTests extends App {
  def main(args: ISZ[String]): Z = {
    val instance = new TempControl_i_tcproc_tempControl_DSC_UnitTests()
    /*
    val c = instance.next()
...
class TempControl_i_tcproc_tempControl_DSC_UnitTests extends TempControl_i_tcproc_tempControl_GumboX_UnitTests
