...
abstract class TempControl_i_tcproc_tempControl_TestApi extends BridgeTestSuite[TempControl_i_tcproc_tempControl_Bridge](Arch.TempControlSoftwareSystem_i_Instance_tcproc_tempControl) {
