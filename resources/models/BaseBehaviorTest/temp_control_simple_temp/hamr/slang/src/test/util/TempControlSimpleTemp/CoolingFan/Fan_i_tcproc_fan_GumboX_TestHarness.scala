...
@msig trait Fan_i_tcproc_fan_GumboX_TestHarness extends Fan_i_tcproc_fan_TestApi {
  def verbose: B

  def testComputeCBJ(json: String): GumboXResult.Type = {
    TempControlSimpleTemp.JSON.toCoolingFanFan_i_tcproc_fan_PreState_Container(json) match {
      case Either.Left(o) => return testComputeCBV(o)
      case Either.Right(msg) => halt(msg.string)
    }
  }

  def testComputeCBV(o: Fan_i_tcproc_fan_PreState_Container): GumboXResult.Type = {
