...
abstract class OperatorInterface_i_tcproc_operatorInterface_GumboX_TestHarness_ScalaTest extends
  AnyFunSuite with OneInstancePerTest with BeforeAndAfterEach with
  OperatorInterface_i_tcproc_operatorInterface_GumboX_TestHarness {
