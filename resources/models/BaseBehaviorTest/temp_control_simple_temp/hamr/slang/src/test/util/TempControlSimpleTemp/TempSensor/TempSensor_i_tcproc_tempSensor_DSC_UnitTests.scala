...
object TempSensor_i_tcproc_tempSensor_DSC_UnitTests extends App {
  def main(args: ISZ[String]): Z = {
    val instance = new TempSensor_i_tcproc_tempSensor_DSC_UnitTests()
    /*
    val c = instance.next()
...
class TempSensor_i_tcproc_tempSensor_DSC_UnitTests extends TempSensor_i_tcproc_tempSensor_GumboX_UnitTests
