...
import TempControlSimpleTemp.util.UnitTestConfiguration

// Do not edit this file as it will be overwritten if HAMR codegen is rerun
// To prevent overwriting, add '//@  hamr:no-overwrite' to this file

object OperatorInterface_i_tcproc_operatorInterface_DSC_UnitTests extends App {
  def main(args: ISZ[String]): Z = {
    val instance = new OperatorInterface_i_tcproc_operatorInterface_DSC_UnitTests()
    /*
    val c = instance.next()
...
class OperatorInterface_i_tcproc_operatorInterface_DSC_UnitTests extends OperatorInterface_i_tcproc_operatorInterface_GumboX_UnitTests
  ...
  override def toCompactJson(o: Container): String = {
    return TempControlSimpleTemp.JSON.fromutilContainer(o, T)
  }

  override def fromJson(json: String): Container = {
    TempControlSimpleTemp.JSON.toutilContainer(json) match {
  ...
  override def test(o: Container): B = {
    ...
    val r: B = getConfig().test(o) match {
      case GumboXResult.Pre_Condition_Unsat =>
        TempControlSimpleTemp.DSC_RecordUnsatPre.report(toCompactJson(o))
        T
