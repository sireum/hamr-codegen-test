...
object Fan_i_tcproc_fan_DSC_UnitTests extends App {
  def main(args: ISZ[String]): Z = {
    val instance = new Fan_i_tcproc_fan_DSC_UnitTests()
    /*
    val c = instance.next()
...
class Fan_i_tcproc_fan_DSC_UnitTests extends Fan_i_tcproc_fan_GumboX_UnitTests
