...
import TempControlSimpleTemp.GumboXUtil
...
class OperatorInterface_i_tcproc_operatorInterface_GumboX_Tests extends OperatorInterface_i_tcproc_operatorInterface_GumboX_TestHarness_ScalaTest {
...

  {
    ...
    // getInputs - needed
    def getInputs(): Option[OperatorInterface_i_tcproc_operatorInterface_SlangCheckContainer] = {
      try {
        ...
        return Some(OperatorInterface_i_tcproc_operatorInterface_SlangCheckContainer(api_tempChanged,api_currentTemp))
      } catch {
