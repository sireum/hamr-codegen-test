...
class OperatorInterface_i_tcproc_operatorInterface_GumboX_Tests extends OperatorInterface_i_tcproc_operatorInterface_GumboX_TestHarness_ScalaTest_Generator {
  ...
  override def getInitialiseProfiles: MSZ[OperatorInterface_i_tcproc_operatorInterface_Profile] = {
    return MSZ(getDefaultInitialiseProfile)
  }

  // profiles that will be used to generate the incoming port values
  override def getProfiles_P: MSZ[OperatorInterface_i_tcproc_operatorInterface_Profile_P] = {
