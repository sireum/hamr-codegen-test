...
@msig trait OperatorInterface_i_tcproc_operatorInterface_TestApi {
  ...
  def put_currentTemp(value : TempSensor.Temperature_i): Unit = {
    Art.insertInInfrastructurePort(Arch.TempControlSoftwareSystem_i_Instance_tcproc_operatorInterface.operational_api.currentTemp_Id, TempSensor.Temperature_i_Payload(value))
  }

  // setter for in EventPort
  def put_tempChanged(): Unit = {
    Art.insertInInfrastructurePort(Arch.TempControlSoftwareSystem_i_Instance_tcproc_operatorInterface.operational_api.tempChanged_Id, art.Empty())
  }
  ...
  def get_setPoint_payload(): Option[TempControlSoftwareSystem.SetPoint_i_Payload] = {
    return Art.observeOutInfrastructurePort(Arch.TempControlSoftwareSystem_i_Instance_tcproc_operatorInterface.initialization_api.setPoint_Id).asInstanceOf[Option[TempControlSoftwareSystem.SetPoint_i_Payload]]
  }
