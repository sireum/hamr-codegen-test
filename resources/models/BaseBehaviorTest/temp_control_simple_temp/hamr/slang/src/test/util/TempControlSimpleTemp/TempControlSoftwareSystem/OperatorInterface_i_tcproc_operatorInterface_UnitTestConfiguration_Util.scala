...
object OperatorInterface_i_tcproc_operatorInterface_UnitTestConfiguration_Util {
  ...
  type DefaultInitializeProfile = OperatorInterface_i_tcproc_operatorInterface_Profile
  ...
  type DefaultComputeProfile = OperatorInterface_i_tcproc_operatorInterface_Profile_P
...
@record class OperatorInterface_i_tcproc_operatorInterface_Initialize_UnitTestConfiguration (
  ...
  var profile: OperatorInterface_i_tcproc_operatorInterface_Profile_Trait,
...
@record class OperatorInterface_i_tcproc_operatorInterface_Compute_UnitTestConfiguration (
  ...
  var numTestVectorGenRetries: Z,
  var failOnUnsatPreconditions: B,
  var profile: OperatorInterface_i_tcproc_operatorInterface_Profile_P_Trait,
  var genReplay: (Container, String, GumboXResult.Type) => Option[String])
  extends UnitTestConfigurationBatch with OperatorInterface_i_tcproc_operatorInterface_GumboX_TestHarness {

  override def test(c: Container): GumboXResult.Type = {
    return testComputeCBV(c.asInstanceOf[OperatorInterface_i_tcproc_operatorInterface_PreState_Container])
  }
}
