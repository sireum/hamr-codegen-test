...
@msig trait TempControl_i_tcproc_tempControl_Profile_Trait extends Profile

@record class TempControl_i_tcproc_tempControl_Profile (
  val name: String,
) extends TempControl_i_tcproc_tempControl_Profile_Trait {
...
@msig trait TempControl_i_tcproc_tempControl_Profile_P_Trait extends Profile {
...
@record class TempControl_i_tcproc_tempControl_Profile_P(
  ...
  ) extends TempControl_i_tcproc_tempControl_Profile_P_Trait {

  override def next: TempControl_i_tcproc_tempControl_PreState_Container_P = {
    return (TempControl_i_tcproc_tempControl_PreState_Container_P (
...
@msig trait TempControl_i_tcproc_tempControl_Profile_PS_Trait extends TempControl_i_tcproc_tempControl_Profile_P_Trait {
...
@record class TempControl_i_tcproc_tempControl_Profile_PS(
  ...
  var api_setPoint: RandomLib, // random lib for generating TempControlSoftwareSystem.SetPoint_i
  var api_currentTemp: RandomLib // random lib for generating TempSensor.Temperature_i
  ) extends TempControl_i_tcproc_tempControl_Profile_PS_Trait {

  override def next: TempControl_i_tcproc_tempControl_PreState_Container_PS = {
    return (TempControl_i_tcproc_tempControl_PreState_Container_PS (
