...
@msig trait TempSensor_i_tcproc_tempSensor_TestApi {
  ...
  def get_currentTemp_payload(): Option[TempSensor.Temperature_i_Payload] = {
    return ArtNative.observeOutInfrastructurePort(Arch.TempControlSoftwareSystem_i_Instance_tcproc_tempSensor.initialization_api.currentTemp_Id).asInstanceOf[Option[TempSensor.Temperature_i_Payload]]
  }
  ...
  def get_tempChanged_payload(): Option[Empty] = {
    return ArtNative.observeOutInfrastructurePort(Arch.TempControlSoftwareSystem_i_Instance_tcproc_tempSensor.initialization_api.tempChanged_Id).asInstanceOf[Option[Empty]]
  }
