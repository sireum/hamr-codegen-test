...
@msig trait Fan_i_tcproc_fan_TestApi {

  def BeforeEntrypoint(): Unit = {
    Art.initTest(Arch.TempControlSoftwareSystem_i_Instance_tcproc_fan)
  }

  def AfterEntrypoint(): Unit = {
    Art.finalizeTest(Arch.TempControlSoftwareSystem_i_Instance_tcproc_fan)
  }

  def testCompute(): Unit = {
    Art.manuallyClearOutput()
    Art.testCompute(Arch.TempControlSoftwareSystem_i_Instance_tcproc_fan)
  }

  def testInitialise(): Unit = {
    Art.manuallyClearOutput()
    Art.testInitialise(Arch.TempControlSoftwareSystem_i_Instance_tcproc_fan)
  }
  ...
  def put_fanCmd(value : CoolingFan.FanCmd.Type): Unit = {
    ArtNative.insertInPortValue(Arch.TempControlSoftwareSystem_i_Instance_tcproc_fan.operational_api.fanCmd_Id, CoolingFan.FanCmd_Payload(value))
  }
  ...
  def get_fanAck_payload(): Option[CoolingFan.FanAck_Payload] = {
    return ArtNative.observeOutPortValue(Arch.TempControlSoftwareSystem_i_Instance_tcproc_fan.initialization_api.fanAck_Id).asInstanceOf[Option[CoolingFan.FanAck_Payload]]
  }
