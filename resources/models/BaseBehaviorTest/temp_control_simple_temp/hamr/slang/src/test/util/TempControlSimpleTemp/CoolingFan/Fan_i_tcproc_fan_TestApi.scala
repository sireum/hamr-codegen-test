...
@msig trait Fan_i_tcproc_fan_TestApi {
  ...
  def put_fanCmd(value : CoolingFan.FanCmd.Type): Unit = {
    Art.insertInInfrastructurePort(Arch.TempControlSoftwareSystem_i_Instance_tcproc_fan.operational_api.fanCmd_Id, CoolingFan.FanCmd_Payload(value))
  }
  ...
  def get_fanAck_payload(): Option[CoolingFan.FanAck_Payload] = {
    return Art.observeOutInfrastructurePort(Arch.TempControlSoftwareSystem_i_Instance_tcproc_fan.initialization_api.fanAck_Id).asInstanceOf[Option[CoolingFan.FanAck_Payload]]
  }
