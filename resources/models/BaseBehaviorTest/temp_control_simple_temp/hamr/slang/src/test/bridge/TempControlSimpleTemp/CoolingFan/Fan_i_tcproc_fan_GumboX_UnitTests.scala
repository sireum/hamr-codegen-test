...
import TempControlSimpleTemp.CoolingFan.Fan_i_tcproc_fan_UnitTestConfiguration_Util._

// This file will not be overwritten so is safe to edit

class Fan_i_tcproc_fan_GumboX_UnitTests extends Fan_i_tcproc_fan_GumboX_TestHarness_ScalaTest {
    ...
    def next: Option[Container] = {
      try {
        c.profile.next match {
          case (cp: Fan_i_tcproc_fan_PreState_Container) =>
