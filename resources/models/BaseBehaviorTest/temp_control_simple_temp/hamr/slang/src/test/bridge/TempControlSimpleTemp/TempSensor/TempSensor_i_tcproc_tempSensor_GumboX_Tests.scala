...
class TempSensor_i_tcproc_tempSensor_GumboX_Tests extends TempSensor_i_tcproc_tempSensor_GumboX_TestHarness_ScalaTest_Generator {
  ...
  override def getInitialiseProfiles: MSZ[TempSensor_i_tcproc_tempSensor_Profile] = {
    return MSZ(getDefaultInitialiseProfile)
  }

  // profiles that will be used to generate the incoming port values
  override def getProfiles_P: MSZ[TempSensor_i_tcproc_tempSensor_Profile_P] = {
