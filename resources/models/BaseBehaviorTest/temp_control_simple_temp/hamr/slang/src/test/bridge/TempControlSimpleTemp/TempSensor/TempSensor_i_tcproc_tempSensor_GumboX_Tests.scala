...
class TempSensor_i_tcproc_tempSensor_GumboX_Tests extends TempSensor_i_tcproc_tempSensor_GumboX_TestHarness_ScalaTest {
...

  {
    ...
    // getInputs - needed
    def getInputs(): Option[TempSensor_i_tcproc_tempSensor_SlangCheckContainer] = {
      try {

        return Some(TempSensor_i_tcproc_tempSensor_SlangCheckContainer())
      } catch {
