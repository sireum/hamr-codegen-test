...
object OperatorInterface_i_tcproc_operatorInterface_GumboX_TestHarness_ScalaTest_Generator {
  ...
  def serializeReport(dir: Os.Path): Unit = {
    val filename = dir / s"OperatorInterface_i_tcproc_operatorInterface_GumboX_TestHarness_ScalaTest_Generator_${System.currentTimeMillis()}.json"
...
import OperatorInterface_i_tcproc_operatorInterface_GumboX_TestHarness_ScalaTest_Generator._

trait OperatorInterface_i_tcproc_operatorInterface_GumboX_TestHarness_ScalaTest_Generator extends OperatorInterface_i_tcproc_operatorInterface_GumboX_TestHarness_ScalaTest
  ...
  def getInitialiseProfiles: MSZ[OperatorInterface_i_tcproc_operatorInterface_Profile]

  def getDefaultInitialiseProfile: OperatorInterface_i_tcproc_operatorInterface_Profile = {
    return OperatorInterface_i_tcproc_operatorInterface_Profile (
      name = "Default Initialise Profile",
      numTests = 100)
  }

  def getProfiles_P: MSZ[OperatorInterface_i_tcproc_operatorInterface_Profile_P]

  def getDefaultProfile_P: OperatorInterface_i_tcproc_operatorInterface_Profile_P = {
    return OperatorInterface_i_tcproc_operatorInterface_Profile_P (
  ...
  def next(profile: OperatorInterface_i_tcproc_operatorInterface_Profile_P): Option[OperatorInterface_i_tcproc_operatorInterface_PreState_Container_P] = {
    try {
  ...
  def testInitialiseCB_Profile(profile: OperatorInterface_i_tcproc_operatorInterface_Profile): Unit = {
  ...
  def testComputeCB_Profile_P(profile: OperatorInterface_i_tcproc_operatorInterface_Profile_P): Unit = {
    for (i <- 0 until profile.numTests) {
        ...
        while (j < profile.numTestVectorGenRetries && retry) {
          next(profile) match {
            case Some(o) =>
              ...
              val json = TempControlSimpleTemp.JSON.fromTempControlSoftwareSystemOperatorInterface_i_tcproc_operatorInterface_PreState_Container_P(o, T)
