...
import TempControlSimpleTemp.util.{Container, UnitTestConfigurationBatch}
import TempControlSimpleTemp.TempControlSoftwareSystem.TempControl_i_tcproc_tempControl_UnitTestConfiguration_Util._

// This file will not be overwritten so is safe to edit

class TempControl_i_tcproc_tempControl_GumboX_UnitTests extends TempControl_i_tcproc_tempControl_GumboX_TestHarness_ScalaTest {
    ...
    def next: Option[Container] = {
      try {
        c.profile.next match {
          case (cp: TempControl_i_tcproc_tempControl_PreState_Container) =>
