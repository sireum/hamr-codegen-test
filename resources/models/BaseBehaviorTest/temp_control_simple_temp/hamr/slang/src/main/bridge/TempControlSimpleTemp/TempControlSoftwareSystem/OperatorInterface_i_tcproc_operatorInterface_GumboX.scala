...
object OperatorInterface_i_tcproc_operatorInterface_GumboX {
  ...
  /** IEP-Post: Initialize Entrypoint Post-Condition via container
    ...
    */
  @strictpure def inititialize_IEP_Post_Container (post: OperatorInterface_i_tcproc_operatorInterface_PostState_Container_PS): B =
  ...
  /** CEP-Pre: Compute Entrypoint Pre-Condition for operatorInterface via container
    ...
    */
  @strictpure def compute_CEP_Pre_Container(pre: OperatorInterface_i_tcproc_operatorInterface_PreState_Container_PS): B =
    compute_CEP_Pre(
  ...
  @strictpure def compute_CEP_Post (
      ...
      api_setPoint: Option[TempControlSoftwareSystem.SetPoint_i]): B =
    {
      ...
      val r1 = TempControlSoftwareSystem.SetPoint_i.D_Inv_Guard_SetPoint_i(api_setPoint)
  ...
  @strictpure def compute_CEP_Post_Container(
      pre: OperatorInterface_i_tcproc_operatorInterface_PreState_Container_PS,
      post: OperatorInterface_i_tcproc_operatorInterface_PostState_Container_PS): B =
    compute_CEP_Post(
      api_tempChanged = pre.api_tempChanged,
      api_currentTemp = pre.api_currentTemp,
      api_setPoint = post.api_setPoint)
