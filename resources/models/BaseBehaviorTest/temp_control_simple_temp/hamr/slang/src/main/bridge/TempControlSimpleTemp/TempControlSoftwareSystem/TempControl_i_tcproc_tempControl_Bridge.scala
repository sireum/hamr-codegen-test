...
import TempControlSimpleTemp.TempControlSoftwareSystem.{TempControl_i_tcproc_tempControl => component}

// This file was auto-generated.  Do not edit

@datatype class TempControl_i_tcproc_tempControl_Bridge(
  val id: Art.BridgeId,
  val name: String,
  ...
  val initialization_api : TempControl_i_Initialization_Api = {
    ...
    TempControl_i_tcproc_tempControl_Bridge.c_initialization_api = Some(api)
    api
  }
  ...
  val operational_api : TempControl_i_Operational_Api = {
    ...
    TempControl_i_tcproc_tempControl_Bridge.c_operational_api = Some(api)
    api
  }

  val entryPoints : Bridge.EntryPoints =
    TempControl_i_tcproc_tempControl_Bridge.EntryPoints(
      id,
...
object TempControl_i_tcproc_tempControl_Bridge {
  ...
  @datatype class EntryPoints(
    TempControl_i_tcproc_tempControl_BridgeId : Art.BridgeId,
    ...
    def compute(): Unit = {
      ...
      val EventTriggered(receivedEvents) = Art.dispatchStatus(TempControl_i_tcproc_tempControl_BridgeId)
      ...
      for(portId <- dispatchableEventPorts) {
        if(portId == fanAck_Id){
          ...
          // implement the following in 'component':  def handle_fanAck(api: TempControl_i_Operational_Api, value: CoolingFan.FanAck.Type): Unit = {}
          ...
          // implement the following in 'component':  def handle_setPoint(api: TempControl_i_Operational_Api, value: TempControlSoftwareSystem.SetPoint_i): Unit = {}
