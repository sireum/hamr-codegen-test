...
@sig trait TempControl_i_tcproc_tempControl_PreState_Container extends Container {
...
@datatype class TempControl_i_tcproc_tempControl_PreState_Container_P (
  ...
  val api_currentTemp: TempSensor.Temperature_i) extends TempControl_i_tcproc_tempControl_PreState_Container

// container for incoming ports and state variables
@datatype class TempControl_i_tcproc_tempControl_PreState_Container_PS (
...
@sig trait TempControl_i_tcproc_tempControl_PostState_Container extends Container {
  def api_fanCmd: Option[CoolingFan.FanCmd.Type]
}

// container for outgoing ports
@datatype class TempControl_i_tcproc_tempControl_PostState_Container_P (
  val api_fanCmd: Option[CoolingFan.FanCmd.Type]) extends TempControl_i_tcproc_tempControl_PostState_Container

// container for outgoing ports and state variables
@datatype class TempControl_i_tcproc_tempControl_PostState_Container_PS (
