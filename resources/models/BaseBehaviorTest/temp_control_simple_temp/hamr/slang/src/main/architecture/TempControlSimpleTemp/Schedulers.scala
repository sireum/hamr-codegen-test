...
object Schedulers {
  ...
  val threadNickNames: Map[String, Art.BridgeId] = Map(
    ISZ(
      Arch.TempControlSoftwareSystem_i_Instance_tcproc_tempSensor.name ~> Arch.TempControlSoftwareSystem_i_Instance_tcproc_tempSensor.id,
      Arch.TempControlSoftwareSystem_i_Instance_tcproc_fan.name ~> Arch.TempControlSoftwareSystem_i_Instance_tcproc_fan.id,
      Arch.TempControlSoftwareSystem_i_Instance_tcproc_tempControl.name ~> Arch.TempControlSoftwareSystem_i_Instance_tcproc_tempControl.id,
      Arch.TempControlSoftwareSystem_i_Instance_tcproc_operatorInterface.name ~> Arch.TempControlSoftwareSystem_i_Instance_tcproc_operatorInterface.id)
  )
  ...
  val defaultDomainToBridgeIdMap: ISZ[Art.BridgeId] = ISZ(
    /* domain 0 */ Arch.TempControlSoftwareSystem_i_Instance_tcproc_tempSensor.id,
    /* domain 1 */ Arch.TempControlSoftwareSystem_i_Instance_tcproc_fan.id,
    /* domain 2 */ Arch.TempControlSoftwareSystem_i_Instance_tcproc_tempControl.id,
    /* domain 3 */ Arch.TempControlSoftwareSystem_i_Instance_tcproc_operatorInterface.id
  )
