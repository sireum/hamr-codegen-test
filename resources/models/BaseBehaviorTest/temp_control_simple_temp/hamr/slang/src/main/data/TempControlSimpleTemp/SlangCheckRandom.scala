...
TempSensor_i_tcproc_tempSensor_DSC_TestVectors.scala

OperatorInterface_i_tcproc_operatorInterface_DSC_TestVectors.scala
...
@msig trait RandomLibI {
  ...
  // ============= TempControlSoftwareSystem.OperatorInterface_i_tcproc_operatorInterface_DSC_TestVector ===================

  def get_Config_TempControlSoftwareSystemOperatorInterface_i_tcproc_operatorInterface_DSC_TestVector: Config_TempControlSoftwareSystemOperatorInterface_i_tcproc_operatorInterface_DSC_TestVector
  def set_Config_TempControlSoftwareSystemOperatorInterface_i_tcproc_operatorInterface_DSC_TestVector(config: Config_TempControlSoftwareSystemOperatorInterface_i_tcproc_operatorInterface_DSC_TestVector): Unit

  def nextISZTempControlSoftwareSystemOperatorInterface_i_tcproc_operatorInterface_DSC_TestVector(): ISZ[TempControlSoftwareSystem.OperatorInterface_i_tcproc_operatorInterface_DSC_TestVector] = {
     val length: Z = gen.nextZBetween(0, 256)
     var temp: ISZ[TempControlSoftwareSystem.OperatorInterface_i_tcproc_operatorInterface_DSC_TestVector] = ISZ()
     for (r <- 0 until length) {
       temp = temp :+ nextTempControlSoftwareSystemOperatorInterface_i_tcproc_operatorInterface_DSC_TestVector()
     }

     return temp
  }

  def nextTempControlSoftwareSystemOperatorInterface_i_tcproc_operatorInterface_DSC_TestVector(): TempControlSoftwareSystem.OperatorInterface_i_tcproc_operatorInterface_DSC_TestVector = {
    ...
    var v: TempControlSoftwareSystem.OperatorInterface_i_tcproc_operatorInterface_DSC_TestVector = TempControlSoftwareSystem.OperatorInterface_i_tcproc_operatorInterface_DSC_TestVector(api_tempChanged, api_currentTemp)

    if(get_Config_TempControlSoftwareSystemOperatorInterface_i_tcproc_operatorInterface_DSC_TestVector.attempts >= 0) {
     for(i <- 0 to get_Config_TempControlSoftwareSystemOperatorInterface_i_tcproc_operatorInterface_DSC_TestVector.attempts) {
        if(get_Config_TempControlSoftwareSystemOperatorInterface_i_tcproc_operatorInterface_DSC_TestVector.filter(v)) {
          return v
        }
        println(s"Retrying for failing value: $v")
        api_tempChanged = nextOption_artEmpty()
        api_currentTemp = nextTempSensorTemperature_i()
        v = TempControlSoftwareSystem.OperatorInterface_i_tcproc_operatorInterface_DSC_TestVector(api_tempChanged, api_currentTemp)
     }
    } else {
     while(T) {
       if(get_Config_TempControlSoftwareSystemOperatorInterface_i_tcproc_operatorInterface_DSC_TestVector.filter(v)) {
  ...
  def nextOptionTempControlSoftwareSystemOperatorInterface_i_tcproc_operatorInterface_DSC_TestVector(): Option[TempControlSoftwareSystem.OperatorInterface_i_tcproc_operatorInterface_DSC_TestVector] = {
    val none: Z = gen.nextZBetween(0,1)

    if(none == 0) {
      return Some(nextTempControlSoftwareSystemOperatorInterface_i_tcproc_operatorInterface_DSC_TestVector())
    } else {
      return None()
    }
  }
  ...
  // ============= TempSensor.TempSensor_i_tcproc_tempSensor_DSC_TestVector ===================

  def get_Config_TempSensorTempSensor_i_tcproc_tempSensor_DSC_TestVector: Config_TempSensorTempSensor_i_tcproc_tempSensor_DSC_TestVector
  def set_Config_TempSensorTempSensor_i_tcproc_tempSensor_DSC_TestVector(config: Config_TempSensorTempSensor_i_tcproc_tempSensor_DSC_TestVector): Unit

  def nextISZTempSensorTempSensor_i_tcproc_tempSensor_DSC_TestVector(): ISZ[TempSensor.TempSensor_i_tcproc_tempSensor_DSC_TestVector] = {
     val length: Z = gen.nextZBetween(0, 256)
     var temp: ISZ[TempSensor.TempSensor_i_tcproc_tempSensor_DSC_TestVector] = ISZ()
     for (r <- 0 until length) {
       temp = temp :+ nextTempSensorTempSensor_i_tcproc_tempSensor_DSC_TestVector()
     }

     return temp
  }

  def nextTempSensorTempSensor_i_tcproc_tempSensor_DSC_TestVector(): TempSensor.TempSensor_i_tcproc_tempSensor_DSC_TestVector = {

    var v: TempSensor.TempSensor_i_tcproc_tempSensor_DSC_TestVector = TempSensor.TempSensor_i_tcproc_tempSensor_DSC_TestVector()

    if(get_Config_TempSensorTempSensor_i_tcproc_tempSensor_DSC_TestVector.attempts >= 0) {
     for(i <- 0 to get_Config_TempSensorTempSensor_i_tcproc_tempSensor_DSC_TestVector.attempts) {
        if(get_Config_TempSensorTempSensor_i_tcproc_tempSensor_DSC_TestVector.filter(v)) {
          return v
        }
        println(s"Retrying for failing value: $v")
        v = TempSensor.TempSensor_i_tcproc_tempSensor_DSC_TestVector()
     }
    } else {
     while(T) {
       if(get_Config_TempSensorTempSensor_i_tcproc_tempSensor_DSC_TestVector.filter(v)) {
  ...
  def nextOptionTempSensorTempSensor_i_tcproc_tempSensor_DSC_TestVector(): Option[TempSensor.TempSensor_i_tcproc_tempSensor_DSC_TestVector] = {
    val none: Z = gen.nextZBetween(0,1)

    if(none == 0) {
      return Some(nextTempSensorTempSensor_i_tcproc_tempSensor_DSC_TestVector())
    } else {
      return None()
    }
  }
...
@record class RandomLib(val gen: org.sireum.Random.Gen) extends RandomLibI {
  ...
  // ============= TempControlSoftwareSystem.OperatorInterface_i_tcproc_operatorInterface_DSC_TestVector ===================
  def alwaysTrue_TempControlSoftwareSystemOperatorInterface_i_tcproc_operatorInterface_DSC_TestVector(v: TempControlSoftwareSystem.OperatorInterface_i_tcproc_operatorInterface_DSC_TestVector): B = {return T}

  var config_TempControlSoftwareSystemOperatorInterface_i_tcproc_operatorInterface_DSC_TestVector: Config_TempControlSoftwareSystemOperatorInterface_i_tcproc_operatorInterface_DSC_TestVector = Config_TempControlSoftwareSystemOperatorInterface_i_tcproc_operatorInterface_DSC_TestVector(100, alwaysTrue_TempControlSoftwareSystemOperatorInterface_i_tcproc_operatorInterface_DSC_TestVector _)

  def get_Config_TempControlSoftwareSystemOperatorInterface_i_tcproc_operatorInterface_DSC_TestVector: Config_TempControlSoftwareSystemOperatorInterface_i_tcproc_operatorInterface_DSC_TestVector = {return config_TempControlSoftwareSystemOperatorInterface_i_tcproc_operatorInterface_DSC_TestVector}

  def set_Config_TempControlSoftwareSystemOperatorInterface_i_tcproc_operatorInterface_DSC_TestVector(config: Config_TempControlSoftwareSystemOperatorInterface_i_tcproc_operatorInterface_DSC_TestVector): Unit ={
    config_TempControlSoftwareSystemOperatorInterface_i_tcproc_operatorInterface_DSC_TestVector = config
  }
  ...
  // ============= TempSensor.TempSensor_i_tcproc_tempSensor_DSC_TestVector ===================
  def alwaysTrue_TempSensorTempSensor_i_tcproc_tempSensor_DSC_TestVector(v: TempSensor.TempSensor_i_tcproc_tempSensor_DSC_TestVector): B = {return T}

  var config_TempSensorTempSensor_i_tcproc_tempSensor_DSC_TestVector: Config_TempSensorTempSensor_i_tcproc_tempSensor_DSC_TestVector = Config_TempSensorTempSensor_i_tcproc_tempSensor_DSC_TestVector(100, alwaysTrue_TempSensorTempSensor_i_tcproc_tempSensor_DSC_TestVector _)

  def get_Config_TempSensorTempSensor_i_tcproc_tempSensor_DSC_TestVector: Config_TempSensorTempSensor_i_tcproc_tempSensor_DSC_TestVector = {return config_TempSensorTempSensor_i_tcproc_tempSensor_DSC_TestVector}

  def set_Config_TempSensorTempSensor_i_tcproc_tempSensor_DSC_TestVector(config: Config_TempSensorTempSensor_i_tcproc_tempSensor_DSC_TestVector): Unit ={
    config_TempSensorTempSensor_i_tcproc_tempSensor_DSC_TestVector = config
  }
