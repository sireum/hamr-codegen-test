...
@msig trait RandomLibI {
  ...
  def next_CoolingFanFanCmdType(): CoolingFan.FanCmd.Type = {
    ...
    var ordinal: Z = gen.nextZBetween(0, TempControlSimpleTemp.CoolingFan.FanCmd.numOfElements-1) //is genBetween inclusive
  ...
  def next_CoolingFanFanAckType(): CoolingFan.FanAck.Type = {
    ...
    var ordinal: Z = gen.nextZBetween(0, TempControlSimpleTemp.CoolingFan.FanAck.numOfElements-1) //is genBetween inclusive
